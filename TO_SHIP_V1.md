...
- [ ] Execute the assembled lane on RTX, qualify numerical/state recovery and two-lane independence, and compose the remaining request-cache/index/router owners. Wire the split TP4 dispatch/gather API into lane scheduling and qualify actual shared-FFN overlap.
