...
- [x] Implement compact BF16 rank returns with explicit wire-format agreement, reusable GPU/host buffers and ordered reduction. [Component qualification](docs/ds41-compact-return-component.md) passes GPU arithmetic/replay/alias checks on RTX and Spark plus transport tests; coordinated rollout and full-model quality/performance qualification remain open.
