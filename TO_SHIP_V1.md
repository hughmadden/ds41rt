...
- [ ] Select expert tiling around common speculative-decode sharing and active-expert counts, with large prefill as a guardrail. The [intermediate-split diagnostic](docs/ds41-expert-intermediate-split-probe.md) preserves exact FP32 routes and improves low-expert-count cases, but does not improve the mixed six-row FP8 case. [Exact N/K slice staging](docs/ds41-expert-slice-staging.md) for 64/128/192 passes on RTX and Spark; compute integration, tiling measurements and lower-traffic scheduling remain open.
