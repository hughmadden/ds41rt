...
- [ ] Select expert tiling around common speculative-decode sharing and active-expert counts, with large prefill as a guardrail. [Grouped fused 64/128/192 compute](docs/ds41-expert-grouped-slices.md) passes fixed-capacity graph/oracle checks on RTX and Spark. The Spark diagnostic favors 192 for mixed six-row routing and 64 for small low-expert-count cases; same-fixture deployed-path comparison, official weights, native route preparation/dispatch and asynchronous staging remain open.
