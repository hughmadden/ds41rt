...
- [ ] Select expert tiling around common speculative-decode sharing and active-expert counts, with large prefill as a guardrail. The [intermediate-split diagnostic](docs/ds41-expert-intermediate-split-probe.md) preserves exact FP32 routes and improves low-expert-count cases, but does not improve the mixed six-row FP8 case. [Fused 64/128/192 compute](docs/ds41-expert-fused-slices.md) now passes single-expert oracle/graph checks on RTX and Spark; multiple-expert integration, asynchronous staging, tiling measurements and serving qualification remain open.
