...
EXL3_SCHEMA = "ds41rt.exl3.expert-trellis"
...
ACTIVATION_CORPUS_SCHEMA = "ds41rt-flash-exl3-activation-corpus-v1"
ROUTED_ACTIVATION_CORPUS_SCHEMA = "ds41rt-flash-exl3-activation-corpus-v2"
...
EXL3_ROUTE_REPLAY_ARTIFACT_FILENAME = "ds41rt-exl3-route-replay.json"
...
def verify_retained_native_tensors(
    ...
    *,
    ...
    if not generated_complete and allow_incomplete:
        state_path = artifact / ".ds41rt-exl3-state.json"
...
class SafetensorsArtifactWriter:
    ...
    def __init__(
        ...
        *,
        ...
        self.state_path = self.output / ".ds41rt-exl3-state.json"
        self.partial_report_path = (
            self.output / "ds41rt-exl3-calibration.json.incomplete"
        )
    ...
    def finish(
        ...
        *,
        ...
        retained_path = self.output / "ds41rt-exl3-retained-native.json"
        ...
        (self.output / "ds41rt-exl3-calibration.json").write_text(
    ...
    *,
    ...
    def run_repeated_batches(devices: list[int], ratios: list[int] | None):
        shared_hessian = analytic_isotropic_hessian(
            features=128,
            equivalent_rows=512,
            key="ds41rt.multigpu_repeated_batch_qualification.w1",
            device=primary,
        )
        batches = []
    ...
    def run_production_projection(
        ...
        *,
        ...
        hessian = analytic_isotropic_hessian(
            features=shape[0],
            equivalent_rows=512,
            key=f"ds41rt.multigpu_production_shape_qualification.{shape_index}",
            device=primary,
        )
        args = {
