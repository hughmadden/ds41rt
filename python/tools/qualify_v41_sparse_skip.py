...
parser = argparse.ArgumentParser(
    description="Compare sparse attention masked-tile skipping against an unchanged native library"
)
...
for rows in [1, 2, 6, 16, 80]:
    ...
    for i in range(2):
        ...
        with torch.cuda.graph(g):
            launch(i)
        graphs.append(g)
    for pattern in ["none", "first5", "late5", "gaps", "full", "stale"]:
