...
def main():
    ...
    for experts in (128,384):
        ...
        variants.append(dict(experts=experts,input_width=5120,output_dtype='FP32',tile_m=64,tile_n=16,tile_k=64,
    ...
    manifest_path.write_text(json.dumps(dict(schema=1,sparkinfer=lock,variants=variants),indent=2)+'\n')
