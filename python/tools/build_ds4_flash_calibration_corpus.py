#!/usr/bin/env python3
"""Build source-disjoint Flash EXL3 calibration and held-out prompt corpora."""
...
def build(args: argparse.Namespace) -> dict[str, Any]:
    ...
    tokenizer_path = (
        args.tokenizer.expanduser().resolve(strict=True)
        if args.tokenizer is not None
        else default_flash_tokenizer_path().resolve(strict=True)
    )
