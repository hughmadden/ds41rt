...
_TARGET_ENV = "DS41RT_B12X_SPARK_CAPTURE_TARGET"
...
def _route_timing_enabled() -> bool:
    return os.environ.get("DS41RT_REAL_FULL_NVFP4_ROUTE_TIMING", "").strip() in {
        "1",
        "true",
        "TRUE",
        "yes",
        "YES",
    } or os.environ.get("DS41RT_REAL_FULL_PROTOCOL_V2_EXECUTOR_TIMING", "").strip() in {
        "1",
        "true",
        "TRUE",
        "yes",
