...
The [live transport rollout](ds41-fp8-transport-rollout.md) now completes coordinator encoding and matching worker deployment. Earlier component-only scope above describes the original probes; it is not the current deployment status.
