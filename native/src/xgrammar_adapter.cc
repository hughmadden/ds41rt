...
// Keep schema-constrained decoding permissive enough for pretty-printed JSON,
// but do not leave an unbounded whitespace loop available to greedy decoding.
// This is a per-boundary limit, not a limit on whitespace in JSON strings.
constexpr int kJsonMaxWhitespaceCount = 16;
