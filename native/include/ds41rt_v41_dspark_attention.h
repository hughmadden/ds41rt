...
// BF16 query/output [requests,5,64,512], ring [slots,128,512],
// draft [requests,5,512]; FP32 sink [64], descriptors [requests].
// KV is already normalized, rotated and FP8 quantized/dequantized to BF16.
...
int32_t ds41rt_v41_dspark_attention(const uint16_t* query, const uint16_t* ring,
