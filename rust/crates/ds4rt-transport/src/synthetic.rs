...
use ds4rt_core::{ExpertRequest, ExpertResponse, LayerWaveMode};
...
pub struct ProtocolV2RequestDevicePayload {
    pub hidden_payload: Ds4rtDeviceBuffer,
    pub response_slot: Option<Ds4rtDeviceBuffer>,
