...
use crate::{Ds4rtError, KvBlockDescriptor, LayerId, LayerWave, PositionId};
...
impl KvCacheBackingStore {
    ...
    fn validate_payload(
        ...
        if actual_bytes != expected_bytes {
            return Err(Ds4rtError::KvBackingPayloadSizeMismatch {
                expected_bytes,
                actual_bytes,
            });
        }
    ...
    fn validate_payload_count(
        ...
        if actual_blocks != expected_blocks {
            return Err(Ds4rtError::KvBackingPayloadCountMismatch {
                expected_blocks,
                actual_blocks,
            });
        }
