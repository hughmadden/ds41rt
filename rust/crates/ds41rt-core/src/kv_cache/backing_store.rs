...
use crate::{Ds41rtError, KvBlockDescriptor, LayerId, LayerWave, PositionId};
...
impl KvCacheBackingStore {
    ...
    fn validate_payload(
        ...
        if actual_bytes != expected_bytes {
            return Err(Ds41rtError::KvBackingPayloadSizeMismatch {
                expected_bytes,
                actual_bytes,
            });
        }
    ...
    fn validate_payload_count(
        ...
        if actual_blocks != expected_blocks {
            return Err(Ds41rtError::KvBackingPayloadCountMismatch {
                expected_blocks,
                actual_blocks,
            });
        }
