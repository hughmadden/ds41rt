...
#[tokio::test]
async fn real_ds4_slice_returns_loaded_tensor_summary() {
    let mut state = test_state(ApiBackend::RealDs4Slice, ApiTransport::Inproc);
    ...
    assert_eq!(output.metrics.backend_mode, "real-ds4-slice");
