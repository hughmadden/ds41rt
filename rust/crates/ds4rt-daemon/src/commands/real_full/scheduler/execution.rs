...
#[cfg(test)]
use ds4rt_core::ExpertOwnerLookup;
use ds4rt_core::{
...
#[cfg(test)]
use ds4rt_transport::TcpProtocolV2HostBatchTarget;
...
const SCHEDULER_EXECUTION_TIMING_ENV: &str = "DS4RT_REAL_FULL_SCHEDULER_TIMING";
const SCHEDULER_EXECUTION_SUMMARY_TIMING_ENV: &str = "DS4RT_REAL_FULL_SCHEDULER_SUMMARY_TIMING";
const SCHEDULER_TERMINAL_SAMPLE_VALIDATE_ENV: &str = "DS4RT_REAL_FULL_TERMINAL_SAMPLE_VALIDATE";
...
const ROLLING_SPARSE_MAX_ACTIVE_DISPATCHES_ENV: &str =
    "DS4RT_REAL_FULL_ROLLING_SPARSE_MAX_ACTIVE_DISPATCHES";
...
fn validate_live_native_scheduler_contract(
    ...
    anyhow::ensure!(
        kv_config.dtype == ds4rt_core::KvCacheDType::Bf16,
...
impl<'a> BatchedLiveSchedulerRun<'a> {
    ...
    fn record_sparse_cohort_member_dispatch(
        ...
        dispatch: &ds4rt_transport::TcpProtocolV2HostBatchSetBf16PayloadDispatch,
    ) -> Result<()> {
        self.with_buffer_bank(|run| {
            run.numeric_progression
