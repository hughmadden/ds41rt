...
use ds4rt_ffi::{
    Ds4rtB12xSparkW4a16MoeBuffers, Ds4rtDeviceBuffer, Ds4rtDs4FlashRoutePackBuffers,
    Ds4rtDs4FlashSparkExl3K2MoeBuffers, Ds4rtDs4FlashSparkExl3MixedMoeBuffers,
    Ds4rtDs4FlashSparkW4a16MoeBuffers, Ds4rtHostBuffer, Ds4rtNcclComm,
    Ds4rtNvfp4RouteBatchedMetadata, Ds4rtRouteShardReductionBuffers, NativeLibrary,
    DS4RT_DEVICE_BUFFER_FLAG_MANAGED, DS4RT_ROUTE_SHARD_LOCAL_BF16, DS4RT_ROUTE_SHARD_LOCAL_F32,
    DS4RT_ROUTE_SHARD_WIRE_BF16, DS4RT_ROUTE_SHARD_WIRE_FP8_E4M3_ROW_SCALED,
...
const REAL_FULL_CUDA_ROUTE_VALIDATE_ENV: &str = "DS4RT_REAL_FULL_CUDA_ROUTE_VALIDATE";
const REAL_FULL_NVFP4_ROUTE_CUDA_GRAPHS_ENV: &str = "DS4RT_REAL_FULL_NVFP4_ROUTE_CUDA_GRAPHS";
const REAL_FULL_NVFP4_ROUTE_GROUPED_MULTIROW_ENV: &str =
    "DS4RT_REAL_FULL_NVFP4_ROUTE_GROUPED_MULTIROW";
const REAL_FULL_NVFP4_ROUTE_TIMING_ENV: &str = "DS4RT_REAL_FULL_NVFP4_ROUTE_TIMING";
...
const REAL_FULL_B12X_SPARK_DIRECT_ROUTE_ENV: &str = "DS4RT_B12X_SPARK_DIRECT_ROUTE";
const REAL_FULL_B12X_SPARK_GROUPED_DECODE_ENV: &str = "DS4RT_B12X_SPARK_GROUPED_DECODE";
const REAL_FULL_B12X_SPARK_W4A16_SMALL_M_MODE_ENV: &str = "DS4RT_B12X_SPARK_W4A16_SMALL_M_MODE";
const REAL_FULL_B12X_SPARK_W4A16_DEVICE_WEIGHTS_ENV: &str = "DS4RT_B12X_SPARK_W4A16_DEVICE_WEIGHTS";
const REAL_FULL_B12X_SPARK_ROUTE_LANES_ENV: &str = "DS4RT_B12X_SPARK_ROUTE_LANES";
const REAL_FULL_NVFP4_ROUTE_PRELOAD_IO_WORKERS_ENV: &str =
    "DS4RT_REAL_FULL_NVFP4_ROUTE_PRELOAD_IO_WORKERS";
const REAL_FULL_NVFP4_ROUTE_PRELOAD_DIRECT_IO_ENV: &str =
    "DS4RT_REAL_FULL_NVFP4_ROUTE_PRELOAD_DIRECT_IO";
const REAL_FULL_NVFP4_ROUTE_PRELOAD_COOPERATIVE_ENV: &str =
    "DS4RT_REAL_FULL_NVFP4_ROUTE_PRELOAD_COOPERATIVE";
const EXPERT_FUSED_FP8_REDUCTION_ENV: &str = "DS4RT_EXPERT_FUSED_FP8_REDUCTION";
const EXPERT_NCCL_BF16_REDUCE_ENV: &str = "DS4RT_EXPERT_NCCL_BF16_REDUCE";
...
const SPARKINFER_EXL3_MODE_ENV: &str = "DS4RT_SPARKINFER_EXL3";
...
struct RouteCudaCache {
    ...
    weight_preload_communicator: Option<Ds4rtNcclComm>,
...
impl RouteCudaCache {
    ...
    fn new_with_tp_policy(
        ...
        let path = native_library_path().with_context(|| {
            format!(
                "{REAL_FULL_CUDA_REFERENCE_KERNELS_ENV}=1 requires DS4RT_NATIVE_LIB or native/build-cuda/libds4rt_native.so"
            )
        })?;
    ...
    unsafe fn launch_or_capture_packed_w4a16_decode_graph(
        ...
        route_metadata_payload: Ds4rtHostBuffer,
...
struct RouteCudaAccumulationWorkspaceBuffers {
    ...
    scatter_index: Ds4rtDeviceBuffer,
...
struct RouteCudaPinnedPayloadBuffers {
    hidden: Ds4rtHostBuffer,
    scatter_index: Ds4rtHostBuffer,
    route_weights: Ds4rtHostBuffer,
}
...
struct RouteCudaCompletionWorkspaceBuffers {
    ...
    f32_output: Ds4rtDeviceBuffer,
    output: Ds4rtDeviceBuffer,
    pinned_indices: Ds4rtHostBuffer,
    pinned_output: Ds4rtHostBuffer,
}
...
struct B12xSparkAotRouteWorkspaceBuffers {
    compact_hidden: Ds4rtDeviceBuffer,
    group_output: Ds4rtDeviceBuffer,
    w4a16_fc1_output: Ds4rtDeviceBuffer,
    w4a16_activated: Ds4rtDeviceBuffer,
    w4a16_packed_route_indices: Ds4rtDeviceBuffer,
    w4a16_block_expert_ids: Ds4rtDeviceBuffer,
    w4a16_packed_route_count: Ds4rtDeviceBuffer,
    w4a16_topk_weights: Ds4rtDeviceBuffer,
    w4a16_fc1_scratch: Ds4rtDeviceBuffer,
    w4a16_fc2_scratch: Ds4rtDeviceBuffer,
    w4a16_locks: Ds4rtDeviceBuffer,
}

#[derive(Clone, Copy)]
struct Ds4FlashSparkAotRouteWorkspaceBuffers {
    packed_hidden: Ds4rtDeviceBuffer,
    fc1_output: Ds4rtDeviceBuffer,
    activated: Ds4rtDeviceBuffer,
    routed_output: Ds4rtDeviceBuffer,
    rotation_gate: Ds4rtDeviceBuffer,
    rotation_up: Ds4rtDeviceBuffer,
    output_f32: Ds4rtDeviceBuffer,
    block_expert_ids: Ds4rtDeviceBuffer,
    packed_route_count: Ds4rtDeviceBuffer,
    expert_counts: Ds4rtDeviceBuffer,
    expert_offsets: Ds4rtDeviceBuffer,
    fc1_scratch: Ds4rtDeviceBuffer,
    fc2_scratch: Ds4rtDeviceBuffer,
    locks: Ds4rtDeviceBuffer,
}
...
pub(in crate::commands::real_full) struct Ds4FlashSparkDecodeM1DeviceBuffers {
    pub(in crate::commands::real_full) input: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) route_indices: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) route_weights: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) fc1: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) activated: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) rotation_gate: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) rotation_up: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) routed_output: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) output_f32: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) output: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) block_expert_ids: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) packed_route_count: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) expert_counts: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) expert_offsets: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) fc1_scratch: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) fc2_scratch: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) locks: Ds4rtDeviceBuffer,
}
...
pub(in crate::commands::real_full) struct Ds4FlashSparkPrefillRoutePackDeviceBuffers {
    pub(in crate::commands::real_full) topk_ids: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) packed_route_indices: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) block_expert_ids: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) packed_route_count: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) expert_counts: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) expert_offsets: Ds4rtDeviceBuffer,
...
pub(in crate::commands::real_full) struct Ds4FlashSparkPrefillDeviceBuffers {
    pub(in crate::commands::real_full) input: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) topk_ids: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) topk_weights: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) packed_route_indices: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) block_expert_ids: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) packed_route_count: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) expert_counts: Ds4rtDeviceBuffer,
...
impl CapturedRouteCudaGraph {
    fn new_with_node_requirements(
        library: Arc<NativeLibrary>,
        capture: ds4rt_ffi::Ds4rtCudaGraphCaptureInfo,
        require_memcpy: bool,
        label: &'static str,
    ) -> Result<Self> {
...
impl RouteCudaWorkspace {
    ...
    fn stage_route_metadata_payload(
        &mut self,
        library: Arc<NativeLibrary>,
        route_metadata: &[Ds4rtNvfp4RouteBatchedMetadata],
    ) -> Result<Ds4rtHostBuffer> {
        Self::stage_pinned_bytes(
            &mut self.pinned_route_metadata,
            library,
    ...
    fn quantize_bf16_projection_into_w4a16(
        ...
        library: Arc<NativeLibrary>,
        source_parts: &[&[u8]],
        destination_weight: Ds4rtDeviceBuffer,
        destination_scale: Ds4rtDeviceBuffer,
        rows: usize,
        cols: usize,
        row_rotation: usize,
        global_scale: f32,
...
impl RouteCudaDs4FlashLayerExpertSlab {
    ...
    fn aot_buffers(
        ...
        routed_output: Ds4rtDeviceBuffer,
        output: Ds4rtDeviceBuffer,
        packed_route_indices: Ds4rtDeviceBuffer,
        topk_weights: Ds4rtDeviceBuffer,
    ) -> Ds4rtDs4FlashSparkW4a16MoeBuffers {
        Ds4rtDs4FlashSparkW4a16MoeBuffers {
            input,
    ...
    fn decode_m1_aot_buffers(
        ...
        Ds4rtDs4FlashSparkW4a16MoeBuffers {
            ...
            routed_output: Ds4rtDeviceBuffer::default(),
...
impl RouteCudaDs4FlashExl3LayerExpertSlab {
    ...
    fn aot_buffers(
        ...
        topk_weights: Ds4rtDeviceBuffer,
        packed_route_indices: Ds4rtDeviceBuffer,
    ) -> Ds4rtDs4FlashSparkExl3K2MoeBuffers {
        Ds4rtDs4FlashSparkExl3K2MoeBuffers {
            input,
    ...
    fn decode_m1_aot_buffers(
        ...
        self.aot_buffers(
            Ds4FlashSparkAotRouteWorkspaceBuffers {
                packed_hidden: Ds4rtDeviceBuffer::default(),
                fc1_output: buffers.fc1,
                activated: buffers.activated,
                routed_output: buffers.routed_output,
...
impl RouteCudaDs4FlashExl3MixedLayerExpertSlab {
    ...
    fn aot_buffers(
        ...
        topk_weights: Ds4rtDeviceBuffer,
        packed_route_indices: Ds4rtDeviceBuffer,
    ) -> Ds4rtDs4FlashSparkExl3MixedMoeBuffers {
        Ds4rtDs4FlashSparkExl3MixedMoeBuffers {
            input,
...
struct B12xSparkW4a16LayerBuffers {
    w13_weight: Ds4rtDeviceBuffer,
    w2_weight: Ds4rtDeviceBuffer,
    w13_scale: Ds4rtDeviceBuffer,
    w2_scale: Ds4rtDeviceBuffer,
    w13_global_scale: Ds4rtDeviceBuffer,
    w2_global_scale: Ds4rtDeviceBuffer,
}
...
pub(in crate::commands::real_full) struct Ds4FlashRouteExecution {
    pub(in crate::commands::real_full) output_bf16: Vec<u8>,
    pub(in crate::commands::real_full) output_device: Option<Ds4rtDeviceBuffer>,
...
impl RouteHiddenBatch<'_> {
    ...
    fn device_buffer(&self) -> Option<Ds4rtDeviceBuffer> {
        match self {
...
pub(in crate::commands::real_full) fn ds4_flash_spark_prefill_pack_topk6_device_into(
    ...
    let native_buffers = Ds4rtDs4FlashRoutePackBuffers {
...
fn device_buffer_ptr_is_aligned(buffer: Ds4rtDeviceBuffer, alignment: usize) -> bool {
...
pub(in crate::commands::real_full) fn execute_native_flash_route_bf16_cached(
    ...
    rows: usize,
    hidden_bf16: &[u8],
    hidden_device: Option<Ds4rtDeviceBuffer>,
    topk_ids: &[u32],
    topk_weights: &[f32],
    spark_reduction: bool,
    retain_device_output: bool,
    output_device_target: Option<Ds4rtDeviceBuffer>,
    cache: &mut RouteTensorCache,
...
pub(in crate::commands::real_full) struct RouteNvfp4IngressStreamChunk {
    ...
    pub(in crate::commands::real_full) device_output: Option<Ds4rtDeviceBuffer>,
    pub(in crate::commands::real_full) reduction_follower: bool,
...
unsafe fn execute_rdma_row_sharded_reduction(
    ...
    packed_bf16: Option<Ds4rtDeviceBuffer>,
    rows: usize,
    row_width: usize,
    output_dtype: RouteStreamingOutputDtype,
    ...
    let wire_dtype = match reduction_dtype {
        RouteStreamingOutputDtype::Bf16 => DS4RT_ROUTE_SHARD_WIRE_BF16,
        RouteStreamingOutputDtype::Fp8E4m3RowScaled => DS4RT_ROUTE_SHARD_WIRE_FP8_E4M3_ROW_SCALED,
        RouteStreamingOutputDtype::Nvfp4E2m1Fp8E4m3 => DS4RT_ROUTE_SHARD_WIRE_NVFP4_E2M1_FP8_E4M3,
    };
...
pub(in crate::commands::real_full) fn reduce_mapped_route_shards_cached_host_output<'a>(
    local_bf16: Ds4rtDeviceBuffer,
    peer_payloads: &[Ds4rtDeviceBuffer],
    ...
    let mut peers = [Ds4rtDeviceBuffer::default(); 3];
    peers[..peer_payloads.len()].copy_from_slice(peer_payloads);
    let buffers = Ds4rtRouteShardReductionBuffers {
        local: local_bf16,
        peers,
...
pub(in crate::commands::real_full) fn execute_nvfp4_route_ingress_stream_chunk_cached(
    ...
    hidden_chunk: &[u8],
    hidden_chunk_device: Option<Ds4rtDeviceBuffer>,
    retain_device_output: bool,
    response_device_target: Option<Ds4rtDeviceBuffer>,
    row_offset: usize,
    final_frame: bool,
    cache: &mut RouteTensorCache,
    ...
    let (cuda_bytes, retained_route_device_output) = {
        ...
        for group in &route_groups {
            route_metadata.extend(std::iter::repeat_n(
                Ds4rtNvfp4RouteBatchedMetadata::default(),
                group.count,
            ));
        }
...
fn cuda_projection_preload_progress_interval() -> usize {
    env::var("DS4RT_REAL_FULL_NVFP4_ROUTE_PRELOAD_PROGRESS_INTERVAL")
        .ok()
        .and_then(|value| value.trim().parse::<usize>().ok())
        .unwrap_or(512)
}
...
impl OwnedDeviceAllocation {
    ...
    fn buffer(&self) -> Ds4rtDeviceBuffer {
        self.buffer
    }
    ...
    fn is_managed(&self) -> bool {
        (self.buffer.flags & DS4RT_DEVICE_BUFFER_FLAG_MANAGED) != 0
    }
...
impl OwnedPinnedHostAllocation {
    ...
    fn buffer(&self) -> Ds4rtHostBuffer {
        self.buffer
    }
...
fn native_library_path_candidates() -> Vec<PathBuf> {
    let manifest_path = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        ...
        .join("native");
    vec![
        manifest_path.join("build-cuda/libds4rt_native.so"),
        PathBuf::from("native/build-cuda/libds4rt_native.so"),
    ]
}
...
fn route_metadata_bytes(values: &[Ds4rtNvfp4RouteBatchedMetadata]) -> &[u8] {
    unsafe { slice::from_raw_parts(values.as_ptr().cast(), std::mem::size_of_val(values)) }
}
...
mod tests {
    ...
    use ds4rt_ffi::{Ds4rtDeviceBuffer, NativeLibrary};
    use ds4rt_loader::{
    ...
    fn native_flash_prefill_route_pack_is_device_resident_and_graph_safe() {
        ...
        let read_i32 = |buffer: Ds4rtDeviceBuffer, bytes: usize| {
