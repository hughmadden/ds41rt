...
pub(in crate::commands::real_full) struct MlaDecodeKvDsaProjectionWeights {
    pub(in crate::commands::real_full) wk: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) norm_weight: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) norm_bias: Ds4rtDeviceBuffer,
}
...
struct MlaDecodeKvCommitBuffers {
    ...
    normalized_hidden: Ds4rtDeviceBuffer,
    kv_a_weight: Ds4rtDeviceBuffer,
    kv_projected: Ds4rtDeviceBuffer,
    positions: Ds4rtDeviceBuffer,
    kv_norm_weight: Ds4rtDeviceBuffer,
    prepared: Ds4rtDeviceBuffer,
    packed: Option<Ds4rtDeviceBuffer>,
    dsa_weights: Option<MlaDecodeKvDsaProjectionWeights>,
    dsa_projected: Option<Ds4rtDeviceBuffer>,
    dsa_normalized: Option<Ds4rtDeviceBuffer>,
}
...
pub(in crate::commands::real_full) fn mla_decode_kv_commit_bf16_device_output(
    ...
    kv_norm_weight: Ds4rtDeviceBuffer,
    dsa_weights: Option<MlaDecodeKvDsaProjectionWeights>,
    cache_row: Ds4rtDeviceBuffer,
    dsa_cache_row: Option<Ds4rtDeviceBuffer>,
    attention_ready_row: Option<Ds4rtDeviceBuffer>,
...
struct MlaDecodeQueryProjectionBuffers {
    normalized_hidden: Ds4rtDeviceBuffer,
    q_a_weight: Option<Ds4rtDeviceBuffer>,
    q_a_w8a16: Option<CoordinatorW8a16ProjectionBuffers>,
    q_a_projected: Ds4rtDeviceBuffer,
    q_a_norm_weight: Ds4rtDeviceBuffer,
    q_a_normalized: Ds4rtDeviceBuffer,
    q_b_weight: Option<Ds4rtDeviceBuffer>,
    q_b_w4a16: Option<Ds4rtB12xCoordinatorW4a16Buffers>,
...
struct MlaDecodeQueryDsaProjectionBuffers {
    ...
    weights_proj_weight: Ds4rtDeviceBuffer,
    query_projected: Ds4rtDeviceBuffer,
    weights_projected: Ds4rtDeviceBuffer,
    query_dim: usize,
    heads: usize,
}
...
pub(in crate::commands::real_full) fn mla_decode_query_dsa_projection_bf16_device_outputs(
    ...
    q_b_weight_name: &str,
    q_b_weight: Option<Ds4rtDeviceBuffer>,
    dsa_wq_b_weight: Ds4rtDeviceBuffer,
    dsa_weights_proj_weight: Ds4rtDeviceBuffer,
    rows: usize,
    hidden_dim: usize,
    q_lora_rank: usize,
    q_output_dim: usize,
...
pub(in crate::commands::real_full) fn mla_decode_scalar_q_a_batched_q_b_projection_bf16_device_outputs(
    ...
    q_a_norm_weight: Ds4rtDeviceBuffer,
    q_b_weight_name: &str,
    dsa: Option<(Ds4rtDeviceBuffer, Ds4rtDeviceBuffer, usize, usize)>,
    rows: usize,
    hidden_dim: usize,
    q_lora_rank: usize,
    q_output_dim: usize,
...
pub(in crate::commands::real_full) fn capture_or_update_layer_dense_mlp_bf16_graph(
    ...
    gate_buffer: Ds4rtDeviceBuffer,
    up_buffer: Ds4rtDeviceBuffer,
    down_buffer: Ds4rtDeviceBuffer,
...
pub(in crate::commands::real_full) fn capture_or_update_layer_triton_dense_mlp_bf16_graph(
    ...
    up_buffer: Ds4rtDeviceBuffer,
    down_buffer: Ds4rtDeviceBuffer,
    gate_output_buffer: Ds4rtDeviceBuffer,
    up_output_buffer: Ds4rtDeviceBuffer,
    activation_buffer: Ds4rtDeviceBuffer,
    output_buffer: Ds4rtDeviceBuffer,
    rows: usize,
    hidden: usize,
    intermediate: usize,
...
pub(in crate::commands::real_full) fn capture_or_update_sparse_a_triton_router_topk_bf16_graph(
    ...
    score_scratch_buffer: Ds4rtDeviceBuffer,
