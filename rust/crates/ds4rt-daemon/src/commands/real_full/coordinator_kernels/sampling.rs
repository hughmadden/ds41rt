...
pub(in crate::commands::real_full) fn validate_logits_sample_topk_topp_inputs(
    ...
    if top_k == 0 || top_k > vocab || top_k > DS4RT_CUDA_SAMPLE_TOPK_MAX_K {
        anyhow::bail!(
            "real full logits top-k/top-p sampler invalid top_k={top_k} for vocab={vocab}; max supported top_k={DS4RT_CUDA_SAMPLE_TOPK_MAX_K}"
        );
    }
...
pub(in crate::commands::real_full) fn validate_lm_head_sampler_options(
    ...
    if top_k == 0 || top_k > vocab || top_k > DS4RT_CUDA_SAMPLE_TOPK_MAX_K {
        anyhow::bail!(
            "real full BF16 lm_head sampler invalid top_k={top_k} for vocab={vocab}; max supported top_k={DS4RT_CUDA_SAMPLE_TOPK_MAX_K}"
        );
    }
    if !temperature.is_finite() || temperature <= 0.0 {
...
pub(in crate::commands::real_full) fn capture_or_update_terminal_lm_head_argmax_bf16_graph(
    ...
    lm_head_buffer: Ds4rtDeviceBuffer,
...
pub(in crate::commands::real_full) fn capture_or_update_terminal_lm_head_sample_topk_topp_bf16_graph(
    ...
    hidden_buffer: Ds4rtDeviceBuffer,
    lm_head_buffer: Ds4rtDeviceBuffer,
    random_buffer: Ds4rtDeviceBuffer,
    index_buffer: Ds4rtDeviceBuffer,
    score_buffer: Ds4rtDeviceBuffer,
    rows: usize,
    hidden_dim: usize,
...
pub(in crate::commands::real_full) fn capture_or_update_terminal_triton_lm_head_sample_topk_topp_bf16_graph(
    ...
    lm_head_buffer: Ds4rtDeviceBuffer,
    random_buffer: Ds4rtDeviceBuffer,
    logits_buffer: Ds4rtDeviceBuffer,
    candidate_score_buffer: Ds4rtDeviceBuffer,
    candidate_index_buffer: Ds4rtDeviceBuffer,
    argmax_index_buffer: Ds4rtDeviceBuffer,
    argmax_score_buffer: Ds4rtDeviceBuffer,
    index_buffer: Ds4rtDeviceBuffer,
    score_buffer: Ds4rtDeviceBuffer,
    rows: usize,
    hidden_dim: usize,
...
fn capture_or_update_terminal_triton_constrained_lm_head_sample_topk_topp_bf16_graph(
    ...
    lm_head_buffer: Ds4rtDeviceBuffer,
    random_buffer: Ds4rtDeviceBuffer,
    token_bitmask_buffer: Ds4rtDeviceBuffer,
    logits_buffer: Ds4rtDeviceBuffer,
    candidate_score_buffer: Ds4rtDeviceBuffer,
    candidate_index_buffer: Ds4rtDeviceBuffer,
    argmax_index_buffer: Ds4rtDeviceBuffer,
