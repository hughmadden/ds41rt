...
const B12X_COORDINATOR_W4A16_DECODE_ENV: &str = "DS4RT_B12X_COORDINATOR_W4A16_DECODE";
const B12X_COORDINATOR_W4A16_Q_B_DECODE_ENV: &str = "DS4RT_B12X_COORDINATOR_W4A16_Q_B";
const B12X_COORDINATOR_W4A16_O_PROJ_DECODE_ENV: &str = "DS4RT_B12X_COORDINATOR_W4A16_O_PROJ";
const COORDINATOR_W8A16_Q_A_DECODE_ENV: &str = "DS4RT_COORDINATOR_W8A16_Q_A";
const COORDINATOR_W8A16_Q_B_DECODE_ENV: &str = "DS4RT_COORDINATOR_W8A16_Q_B";
const COORDINATOR_W8A16_O_PROJ_DECODE_ENV: &str = "DS4RT_COORDINATOR_W8A16_O_PROJ";
const COORDINATOR_W8A16_PACKED_O_ENV: &str = "DS4RT_COORDINATOR_W8A16_PACKED_O";
...
thread_local! {
    static PRELOADED_RESIDENT_WEIGHT_CACHE: RefCell<HashMap<String, (usize, Ds4rtDeviceBuffer)>> =
...
pub(in crate::commands::real_full) struct CoordinatorW4a16ProjectionBuffers {
    ...
    pub(in crate::commands::real_full) scale: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) global_scale: Ds4rtDeviceBuffer,
}

#[derive(Clone, Copy)]
pub(in crate::commands::real_full) struct CoordinatorW8a16ProjectionBuffers {
    pub(in crate::commands::real_full) weight: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) scales: Ds4rtDeviceBuffer,
    ...
    unsafe {
        ...
        while row_offset < rows {
            ...
            if chunk_rows == 1 {
                ...
                let buffers = Ds4rtB12xCoordinatorW4a16Buffers {
                    input: chunk_input,
...
) -> Result<Ds4rtB12xCoordinatorW4a16Buffers> {
...
pub(in crate::commands::real_full) fn coordinator_w8a16_packed_o_launch_buffers(
    ...
    Ok(Ds4rtB12xCoordinatorW4a16Buffers {
        input,
        weight: projection.weight,
        output,
        scale: projection.scales,
