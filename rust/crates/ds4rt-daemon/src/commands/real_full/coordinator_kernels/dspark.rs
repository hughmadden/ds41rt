...
use ds4rt_core::{DType, DeepseekV4KvCacheFormat, TensorCatalog, DS4_KV_NVFP4_BYTES_PER_ROW};
...
const DSPARK_BLOCK0_HC_ATTN_FN_LANE_SUM: &str =
    "ds4rt#deepseek-v4-dspark-block0-hc-attn-fn-lane-sum";
...
pub(in crate::commands::real_full) struct DeepseekV4DsparkEntryDeviceBuffers {
    pub(in crate::commands::real_full) projected_target_main: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) block_workspace: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) target_tap_concat: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) projection_scratch: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) prompt_positions: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) prompt_main_slots: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) prompt_cos_sin: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) kv_producer_scratch: Ds4rtDeviceBuffer,
}

#[derive(Clone, Copy, Debug)]
pub(in crate::commands::real_full) struct DeepseekV4DsparkProposalDeviceBuffers {
    pub(in crate::commands::real_full) draft_token_ids: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) residual_ping: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) residual_pong: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) collapsed_hidden: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) normalized_hidden: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) positions: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) main_slots: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) cos_sin: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) post_ping: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) comb_ping: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) post_pong: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) comb_pong: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) selected_indices: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) selected_lengths: Ds4rtDeviceBuffer,
}

#[derive(Clone, Copy, Debug)]
pub(in crate::commands::real_full) struct DeepseekV4DsparkTerminalDeviceBuffers {
    pub(in crate::commands::real_full) compact_normalized_hidden: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) shared_logits: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) markov_logits: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) markov_embeddings: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) confidence: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) active_slot_ids: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) anchor_token_ids: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) output_token_ids: Ds4rtDeviceBuffer,
}

#[derive(Clone, Copy, Debug)]
pub(in crate::commands::real_full) struct DeepseekV4DsparkBlockPreDispatchBuffers {
    pub(in crate::commands::real_full) dispatch_hidden: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) sparse: Ds4FlashSparseBlockPreDispatchDeviceBuffers,
    pub(in crate::commands::real_full) ffn_delta: Ds4rtDeviceBuffer,
}
...
pub(in crate::commands::real_full) struct DeepseekV4DsparkTp4DispatchInput {
    ...
    pub(in crate::commands::real_full) shared_delta: Ds4rtDeviceBuffer,
    pub(in crate::commands::real_full) ffn_delta: Ds4rtDeviceBuffer,
}
...
struct DeepseekV4DsparkBlockPostDispatchWeights {
    next_hc_fn: Ds4rtDeviceBuffer,
    next_hc_scale: Ds4rtDeviceBuffer,
    next_hc_base: Ds4rtDeviceBuffer,
    next_norm_weight: Ds4rtDeviceBuffer,
}
...
pub(in crate::commands::real_full) struct DeepseekV4DsparkDeviceStorage {
    ...
    persistent_kv: Ds4rtDeviceBuffer,
...
impl DeepseekV4DsparkDeviceStorage {
    ...
    pub(in crate::commands::real_full) fn arena(&self) -> Ds4rtDeviceBuffer {
        self.arena
    }

    pub(in crate::commands::real_full) fn persistent_kv(&self) -> Ds4rtDeviceBuffer {
        self.persistent_kv
    }
    ...
    pub(in crate::commands::real_full) fn proposal_request_buffers(
        ...
        let view = |buffer: Ds4rtDeviceBuffer, label: &'static str| -> Result<Ds4rtDeviceBuffer> {
            anyhow::ensure!(
    ...
    fn persistent_kv_block(&self, block_index: usize) -> Result<Ds4rtDeviceBuffer> {
        anyhow::ensure!(
    ...
    pub(in crate::commands::real_full) fn prepare_block_sparse_pre_dispatch(
        ...
        anyhow::ensure!(
            matches!(
                ...
                ("flash", ds4rt_core::ModelVariant::Flash) | ("pro", ds4rt_core::ModelVariant::Pro)
    ...
    pub(in crate::commands::real_full) fn joint_block_tp4_dispatch_buffers_for_range(
        &self,
        active_request_range: std::ops::Range<usize>,
    ) -> Result<(Ds4rtDeviceBuffer, Ds4rtDeviceBuffer)> {
...
fn dspark_entry_python_buffers(
    ...
    main_proj_weight: Ds4rtDeviceBuffer,
    main_proj_scale: Ds4rtDeviceBuffer,
...
fn dspark_prompt_python_buffers(
    entry: DeepseekV4DsparkEntryDeviceBuffers,
    main_kv_cache: Ds4rtDeviceBuffer,
    wkv_weight: Ds4rtDeviceBuffer,
    wkv_scale: Ds4rtDeviceBuffer,
    kv_norm_weight: Ds4rtDeviceBuffer,
...
fn dspark_proposal_entry_python_buffers(
    ...
    proposal_embedding: Ds4rtDeviceBuffer,
