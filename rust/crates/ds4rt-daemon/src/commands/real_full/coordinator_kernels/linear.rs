...
pub(in crate::commands::real_full) fn capture_or_update_layer_linear_bf16_graph(
    ...
    input_buffer: Ds4rtDeviceBuffer,
    weight_buffer: Ds4rtDeviceBuffer,
    bias_buffer: Option<Ds4rtDeviceBuffer>,
    output_buffer: Ds4rtDeviceBuffer,
    rows: usize,
    input_dim: usize,
    output_dim: usize,
...
pub(in crate::commands::real_full) fn capture_or_update_layer_linear_residual_add_bf16_graph(
    ...
    weight_buffer: Ds4rtDeviceBuffer,
    bias_buffer: Option<Ds4rtDeviceBuffer>,
    linear_output_buffer: Ds4rtDeviceBuffer,
    residual_buffer: Ds4rtDeviceBuffer,
    residual_output_buffer: Ds4rtDeviceBuffer,
    rows: usize,
    input_dim: usize,
    output_dim: usize,
    label: &'static str,
...
fn padded_linear_bf16_cublas_graph_rows(
    graph_rows: usize,
    padded_input_buffer: Ds4rtDeviceBuffer,
    output_buffer: Ds4rtDeviceBuffer,
    rows: usize,
    full_input_dim: usize,
    output_dim: usize,
