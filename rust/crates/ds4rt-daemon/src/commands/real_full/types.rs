...
pub(super) struct RealDs4FullPreflightReport {
...
pub(super) struct RealFullCoordinatorResidentPreloadPlan {
    ...
    pub(super) skipped_dspark_tensors: usize,
    pub(super) skipped_dspark_bytes: u64,
...
pub(super) struct RealFullKvPlan {
    ...
    pub(super) native_physical: Option<RealFullNativePhysicalKvPlan>,
}

#[derive(Debug, Serialize)]
pub(super) struct RealFullNativePhysicalKvPlan {
    pub(super) status: &'static str,
    pub(super) layout: &'static str,
    pub(super) active: bool,
    pub(super) source_page_tokens: usize,
    pub(super) source_page_count: usize,
    pub(super) layer_count: usize,
    pub(super) persistent_bytes: usize,
    pub(super) persistent_bytes_per_logical_token: f64,
    pub(super) compressor_state_bytes_per_sequence: usize,
    pub(super) boundary_copy_status: &'static str,
    pub(super) max_partial_boundary_copy_spans: usize,
    pub(super) max_partial_boundary_copy_bytes: usize,
    pub(super) compressor_state_replay: bool,
    pub(super) attention_adapter: &'static str,
    pub(super) attention_adapter_status: &'static str,
    pub(super) attention_adapter_startup_qualification: &'static str,
}
