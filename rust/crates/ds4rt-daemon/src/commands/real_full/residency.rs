...
use ds4rt_core::{DType, TensorCatalog, TensorInfo, TensorRole};
use ds4rt_ffi::{Ds4rtHostBuffer, NativeLibrary};
use ds4rt_loader::{read_tensor_bytes_into, LoadedTensorSummary};
...
mod tests {
    ...
    use ds4rt_core::{DType, ModelFacts, TensorCatalog, TensorInfo, TensorRole, DEFAULT_MODEL_ID};
    use ds4rt_loader::LoadedTensorSummary;
    use std::fs::File;
    use std::io::Write;
    ...
    fn coordinator_residency_selects_native_dspark_weights_and_scales_but_not_experts() {
        ...
        let catalog = TensorCatalog {
            ...
            snapshot_path: "/tmp/ds4rt-snapshot".to_owned(),
