...
use ds4rt_transport::{TcpTransportConfig, VerbsHostMappedRdmaRing, VerbsHostMappedRdmaRingConfig};
use std::{
    ffi::c_void,
    net::TcpListener,
...
const SPARK_RDMA_TIMING_ENV: &str = "DS4RT_REAL_FULL_NVFP4_ROUTE_TIMING";
...
pub(crate) struct SparkExpertRdmaExchangeSegment {
    ...
    pub(crate) row_count: usize,
    pub(crate) peer_payloads: [Ds4rtDeviceBuffer; 3],
}
...
impl SparkExpertRdmaExchange {
    pub(crate) fn segments(&self) -> Result<Vec<SparkExpertRdmaExchangeSegment>> {
        ...
        for rail_index in 0..rail_count {
            ...
            let mut peer_payloads = [Ds4rtDeviceBuffer::default(); 3];
            ...
            .map(|rank| SparkRdmaReceivedPeer {
                ...
                rails: vec![
                    SparkRdmaReceivedRail {
                        ...
                        row_count: 3,
                        sequence: 10,
                        payload: Ds4rtDeviceBuffer::default(),
                    },
                    SparkRdmaReceivedRail {
                        row_offset: 3,
                        row_count: 2,
