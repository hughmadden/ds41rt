...
pub(super) fn available_runtime_requirements(
    ...
    vec![
        ...
        RealFullRequirement {
            name: "deepseek_v4_model_facts_match",
            passed: facts_match,
            evidence: format!(
            ...
            blocker: (!facts_match)
                .then_some("catalog facts do not match a supported DeepSeek V4 runtime profile"),
        },
        RealFullRequirement {
            ...
            blocker: (!full_catalog_coverage)
                .then_some("catalog does not expose all tensors needed for full DeepSeek V4 execution"),
        },
        RealFullRequirement {
        ...
        RealFullRequirement {
            ...
            blocker: (!execution_plan_available).then_some(
                "runtime contract does not cover every DeepSeek V4 layer and sparse expert exchange",
            ),
        },
        ...
        RealFullRequirement {
            ...
            evidence: format!(
                "status={} layers={} rows={} hidden_dim={} residual_state_bytes={} attention_adds={} mlp_adds={} residual_adds={} dense_layers={} sparse_layers={} remote_sparse_layers={} terminal_stages={} layer_order_verified={}",
                residual_stream_dry_run.status,
                residual_stream_dry_run.layer_count,
                residual_stream_dry_run.row_count,
                residual_stream_dry_run.hidden_dim,
                residual_stream_dry_run.residual_state_bytes,
                residual_stream_dry_run.attention_residual_adds,
                residual_stream_dry_run.mlp_residual_adds,
                residual_stream_dry_run.total_residual_adds,
                residual_stream_dry_run.dense_layers,
                residual_stream_dry_run.sparse_layers,
                residual_stream_dry_run.remote_sparse_layers,
                residual_stream_dry_run.terminal_stages.join(","),
