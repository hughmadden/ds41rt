...
use ds4rt_ffi::{
    Ds4rtDeviceBuffer, Ds4rtRouteShardReductionBuffers, NativeLibrary, DS4RT_ROUTE_SHARD_LOCAL_F32,
...
fn run_fanout_phase(
    ...
    for iteration in 0..iterations {
        ...
        let mut peer_buffers = [Ds4rtDeviceBuffer::default(); 3];
...
fn load_native_library(path: Option<&Path>) -> Result<NativeLibrary> {
    let path = path
        ...
        .context("GPU echo requires --native-lib or DS4RT_NATIVE_LIB")?;
