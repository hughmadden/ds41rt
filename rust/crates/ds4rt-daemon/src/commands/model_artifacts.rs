...
use ds4rt_core::{owner_for_expert, PlacementPolicy, TensorCatalog, TensorRole, EXPERT_HOSTS};
use ds4rt_loader::{
...
pub(crate) use ds4rt_core::ExpertOwnerLookup;
#[cfg(test)]
...
const RUNTIME_CATALOG_CACHE_DIR_ENV: &str = "DS4RT_RUNTIME_CATALOG_CACHE_DIR";
const MODEL_REVISION_ENV: &str = "DS4RT_MODEL_REVISION";
const WIP_ALLOW_HISTORICAL_EXL3_CONTROL_ENV: &str = "DS4RT_WIP_ALLOW_HISTORICAL_EXL3_CONTROL";
const RUNTIME_CATALOG_CACHE_SCHEMA: u32 = 6;
const RUNTIME_CATALOG_SOURCE_IDENTITY_SCHEMA: &[u8] = b"ds4rt-runtime-catalog-v6";
...
pub(crate) fn default_load_tensor_names(catalog: &TensorCatalog) -> Vec<String> {
    let selectors: [Box<dyn Fn(&ds4rt_core::TensorInfo) -> bool>; 4] = [
...
mod runtime_catalog_cache_tests {
    use super::*;
    use ds4rt_core::{DType, ModelFacts, TensorInfo, SUPPORTED_MODEL_IDS};
    ...
    fn production_runtime_recipe_preserves_identity_and_rejects_historical_exl3() {
        ...
        for historical in [
            ds4rt_loader::DEEPSEEK_V4_EXL3_RECIPE_V2,
            ds4rt_loader::DEEPSEEK_V4_EXL3_RECIPE_V3,
        ] {
