...
pub type Ds4rtStatus = c_int;

pub const DS4RT_STATUS_OK: Ds4rtStatus = 0;
pub const DS4RT_STATUS_CUDA_UNAVAILABLE: Ds4rtStatus = 3;
pub const DS4RT_STATUS_RDMA_UNAVAILABLE: Ds4rtStatus = 7;
pub const DS4RT_STATUS_NCCL_UNAVAILABLE: Ds4rtStatus = 8;
pub const DS4RT_DEVICE_BUFFER_FLAG_HOST_FALLBACK: u64 = 1;
pub const DS4RT_DEVICE_BUFFER_FLAG_MANAGED: u64 = 2;
pub const DS4RT_DEVICE_BUFFER_FLAG_MAPPED_HOST: u64 = 4;
pub const DS4RT_HOST_BUFFER_FLAG_NONE: u64 = 0;
pub const DS4RT_HOST_BUFFER_FLAG_PINNED: u64 = 1;
pub const DS4RT_HOST_BUFFER_FLAG_HOST_FALLBACK: u64 = 2;
pub const DS4RT_HOST_BUFFER_FLAG_MAPPED: u64 = 4;
pub const DS4RT_ROUTE_SHARD_WIRE_BF16: u32 = 1;
pub const DS4RT_ROUTE_SHARD_WIRE_FP8_E4M3_ROW_SCALED: u32 = 2;
pub const DS4RT_ROUTE_SHARD_WIRE_NVFP4_E2M1_FP8_E4M3: u32 = 3;
pub const DS4RT_ROUTE_SHARD_LOCAL_F32: u32 = 1;
pub const DS4RT_ROUTE_SHARD_LOCAL_BF16: u32 = 2;
pub const DS4RT_CUDA_ROUTER_TOPK_MAX_K: usize = 64;
pub const DS4RT_CUDA_SAMPLE_TOPK_MAX_K: usize = 64;
pub const DS4RT_CUDA_MLA_FP8_DS_NOPE_VALUES: usize = 512;
pub const DS4RT_CUDA_MLA_FP8_DS_ROPE_VALUES: usize = 64;
pub const DS4RT_CUDA_MLA_FP8_DS_PROJECTED_VALUES: usize =
    DS4RT_CUDA_MLA_FP8_DS_NOPE_VALUES + DS4RT_CUDA_MLA_FP8_DS_ROPE_VALUES;
pub const DS4RT_CUDA_MLA_FP8_DS_SCALE_BYTES: usize = 16;
pub const DS4RT_CUDA_MLA_FP8_DS_PACKED_BYTES: usize = DS4RT_CUDA_MLA_FP8_DS_NOPE_VALUES
    + DS4RT_CUDA_MLA_FP8_DS_SCALE_BYTES
    + DS4RT_CUDA_MLA_FP8_DS_ROPE_VALUES * std::mem::size_of::<u16>();
/// Generic transactional-KV page width; DeepSeek target attention separately
/// owns a 256-token physical-page ABI.
pub const DS4RT_CUDA_GENERIC_KV_PAGE_SIZE: usize = 64;
pub const DS4RT_CUDA_MLA_MXFP4_DS_NOPE_VALUES: usize = 512;
pub const DS4RT_CUDA_MLA_MXFP4_DS_ROPE_VALUES: usize = 64;
pub const DS4RT_CUDA_MLA_MXFP4_DS_PROJECTED_VALUES: usize =
    DS4RT_CUDA_MLA_MXFP4_DS_NOPE_VALUES + DS4RT_CUDA_MLA_MXFP4_DS_ROPE_VALUES;
pub const DS4RT_CUDA_MLA_MXFP4_DS_BLOCK_SIZE: usize = 16;
pub const DS4RT_CUDA_MLA_MXFP4_DS_CODE_BYTES: usize = DS4RT_CUDA_MLA_MXFP4_DS_NOPE_VALUES / 2;
pub const DS4RT_CUDA_MLA_MXFP4_DS_SCALE_BYTES: usize =
    DS4RT_CUDA_MLA_MXFP4_DS_NOPE_VALUES / DS4RT_CUDA_MLA_MXFP4_DS_BLOCK_SIZE;
pub const DS4RT_CUDA_MLA_MXFP4_DS_PADDING_BYTES: usize = 16;
pub const DS4RT_CUDA_MLA_MXFP4_DS_PACKED_BYTES: usize = DS4RT_CUDA_MLA_MXFP4_DS_CODE_BYTES
    + DS4RT_CUDA_MLA_MXFP4_DS_SCALE_BYTES
    + DS4RT_CUDA_MLA_MXFP4_DS_PADDING_BYTES
    + DS4RT_CUDA_MLA_MXFP4_DS_ROPE_VALUES * std::mem::size_of::<u16>();

#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct Ds4rtCudaDeviceInfo {
    pub device_id: c_int,
...
impl Default for Ds4rtCudaDeviceInfo {
    fn default() -> Self {
        Self {
            device_id: 0,
            cuda_available: 0,
...
impl Default for Ds4rtDeviceBuffer {
    fn default() -> Self {
        Self {
...
pub struct Ds4rtRouteShardReductionBuffers {
    pub local: Ds4rtDeviceBuffer,
    pub peers: [Ds4rtDeviceBuffer; 3],
    pub output_f32: Ds4rtDeviceBuffer,
}

#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct Ds4rtHostBuffer {
    pub ptr: *mut c_void,
    pub bytes: usize,
    pub flags: u64,
}

impl Default for Ds4rtHostBuffer {
    fn default() -> Self {
        Self {
            ptr: std::ptr::null_mut(),
            bytes: 0,
            flags: DS4RT_HOST_BUFFER_FLAG_NONE,
        }
    }
}
...
#[repr(C)]
#[derive(Debug, Clone, Copy, Default)]
pub struct Ds4rtNvfp4RouteBatchedMetadata {
...
#[repr(C)]
#[derive(Debug, Clone, Copy, Default)]
pub struct Ds4rtB12xSparkW4a16MoeBuffers {
    pub input: Ds4rtDeviceBuffer,
    pub w13_weight: Ds4rtDeviceBuffer,
    pub w2_weight: Ds4rtDeviceBuffer,
    pub fc1_output: Ds4rtDeviceBuffer,
    pub activated: Ds4rtDeviceBuffer,
    pub output: Ds4rtDeviceBuffer,
    pub w13_scale: Ds4rtDeviceBuffer,
    pub w2_scale: Ds4rtDeviceBuffer,
    pub w13_global_scale: Ds4rtDeviceBuffer,
    pub w2_global_scale: Ds4rtDeviceBuffer,
    pub packed_route_indices: Ds4rtDeviceBuffer,
    pub block_expert_ids: Ds4rtDeviceBuffer,
    pub packed_route_count: Ds4rtDeviceBuffer,
    pub topk_weights: Ds4rtDeviceBuffer,
    pub fc1_scratch: Ds4rtDeviceBuffer,
    pub fc2_scratch: Ds4rtDeviceBuffer,
    pub locks: Ds4rtDeviceBuffer,
}

#[repr(C)]
#[derive(Debug, Clone, Copy, Default)]
pub struct Ds4rtDs4FlashSparkW4a16MoeBuffers {
    pub input: Ds4rtDeviceBuffer,
    pub w13_weight: Ds4rtDeviceBuffer,
    pub w2_weight: Ds4rtDeviceBuffer,
    pub fc1_output: Ds4rtDeviceBuffer,
    pub activated: Ds4rtDeviceBuffer,
    pub routed_output: Ds4rtDeviceBuffer,
    pub output: Ds4rtDeviceBuffer,
    pub w13_scale: Ds4rtDeviceBuffer,
    pub w2_scale: Ds4rtDeviceBuffer,
    pub w13_global_scale: Ds4rtDeviceBuffer,
...
#[repr(C)]
#[derive(Debug, Clone, Copy, Default)]
pub struct Ds4rtDs4FlashSparkExl3K2MoeBuffers {
    pub input: Ds4rtDeviceBuffer,
    pub w13_trellis: Ds4rtDeviceBuffer,
    pub w2_trellis: Ds4rtDeviceBuffer,
    pub gate_suh: Ds4rtDeviceBuffer,
    pub up_suh: Ds4rtDeviceBuffer,
    pub intermediate_rotations: Ds4rtDeviceBuffer,
    pub down_svh: Ds4rtDeviceBuffer,
    pub expert_map: Ds4rtDeviceBuffer,
    pub dummy_scale: Ds4rtDeviceBuffer,
    pub trellis_lut: Ds4rtDeviceBuffer,
    pub global_scale: Ds4rtDeviceBuffer,
    pub topk_ids: Ds4rtDeviceBuffer,
    pub topk_weights: Ds4rtDeviceBuffer,
    pub rotation_gate: Ds4rtDeviceBuffer,
    pub rotation_up: Ds4rtDeviceBuffer,
    pub fc1_output: Ds4rtDeviceBuffer,
    pub activated: Ds4rtDeviceBuffer,
    pub routed_output: Ds4rtDeviceBuffer,
    pub output_f32: Ds4rtDeviceBuffer,
    pub output_bf16: Ds4rtDeviceBuffer,
    pub packed_route_indices: Ds4rtDeviceBuffer,
    pub block_expert_ids: Ds4rtDeviceBuffer,
    pub packed_route_count: Ds4rtDeviceBuffer,
    pub expert_counts: Ds4rtDeviceBuffer,
    pub expert_offsets: Ds4rtDeviceBuffer,
    pub fc1_scratch: Ds4rtDeviceBuffer,
    pub fc2_scratch: Ds4rtDeviceBuffer,
    pub workspace: Ds4rtDeviceBuffer,
}
...
pub type Ds4rtDs4ProSparkExl3K2MoeBuffers = Ds4rtDs4FlashSparkExl3K2MoeBuffers;

#[repr(C)]
#[derive(Debug, Clone, Copy, Default)]
pub struct Ds4rtDs4FlashSparkExl3MixedMoeBuffers {
    pub input: Ds4rtDeviceBuffer,
    pub tier0_w13_trellis: Ds4rtDeviceBuffer,
    pub tier0_w2_trellis: Ds4rtDeviceBuffer,
    pub tier1_w13_trellis: Ds4rtDeviceBuffer,
    pub tier1_w2_trellis: Ds4rtDeviceBuffer,
    pub dummy_scale: Ds4rtDeviceBuffer,
    pub tier0_global_scale: Ds4rtDeviceBuffer,
    pub tier1_global_scale: Ds4rtDeviceBuffer,
    pub gate_suh: Ds4rtDeviceBuffer,
    pub up_suh: Ds4rtDeviceBuffer,
    pub intermediate_rotations: Ds4rtDeviceBuffer,
    pub down_svh: Ds4rtDeviceBuffer,
    ...
    pub topk_ids: Ds4rtDeviceBuffer,
    pub mapped_topk_ids: Ds4rtDeviceBuffer,
    pub topk_weights: Ds4rtDeviceBuffer,
    pub rotation_gate: Ds4rtDeviceBuffer,
    pub rotation_up: Ds4rtDeviceBuffer,
    pub fc1_output: Ds4rtDeviceBuffer,
...
#[repr(C)]
#[derive(Debug, Clone, Copy, Default)]
pub struct Ds4rtDs4FlashRoutePackBuffers {
    pub topk_ids: Ds4rtDeviceBuffer,
    pub packed_route_indices: Ds4rtDeviceBuffer,
    pub block_expert_ids: Ds4rtDeviceBuffer,
    pub packed_route_count: Ds4rtDeviceBuffer,
...
#[repr(C)]
#[derive(Debug, Clone, Copy, Default)]
pub struct Ds4rtDs4FlashSharedExpertFp8Buffers {
    pub input: Ds4rtDeviceBuffer,
    pub w1_weight: Ds4rtDeviceBuffer,
    pub w1_scale_mma: Ds4rtDeviceBuffer,
    pub w3_weight: Ds4rtDeviceBuffer,
    pub w3_scale_mma: Ds4rtDeviceBuffer,
    pub w2_weight: Ds4rtDeviceBuffer,
    pub w2_scale_mma: Ds4rtDeviceBuffer,
    pub gate: Ds4rtDeviceBuffer,
    pub up: Ds4rtDeviceBuffer,
    pub activated: Ds4rtDeviceBuffer,
    pub output: Ds4rtDeviceBuffer,
    pub alpha: Ds4rtDeviceBuffer,
}

#[repr(C)]
#[derive(Debug, Clone, Copy, Default)]
pub struct Ds4rtDs4ProSharedExpertFp8PrefillBuffers {
    pub base: Ds4rtDs4FlashSharedExpertFp8Buffers,
    pub input_q_values: Ds4rtDeviceBuffer,
    pub input_q_scale_rows: Ds4rtDeviceBuffer,
    pub input_q_scale_mma: Ds4rtDeviceBuffer,
    pub activated_q_values: Ds4rtDeviceBuffer,
    pub activated_q_scale_rows: Ds4rtDeviceBuffer,
    pub activated_q_scale_mma: Ds4rtDeviceBuffer,
}

#[repr(C)]
#[derive(Debug, Clone, Copy, Default)]
pub struct Ds4rtB12xCoordinatorW4a16Buffers {
    pub input: Ds4rtDeviceBuffer,
    pub weight: Ds4rtDeviceBuffer,
    pub output: Ds4rtDeviceBuffer,
    pub scale: Ds4rtDeviceBuffer,
    pub global_scale: Ds4rtDeviceBuffer,
    pub packed_route_indices: Ds4rtDeviceBuffer,
    pub block_expert_ids: Ds4rtDeviceBuffer,
    pub packed_route_count: Ds4rtDeviceBuffer,
    pub topk_weights: Ds4rtDeviceBuffer,
    pub c_tmp: Ds4rtDeviceBuffer,
    pub locks: Ds4rtDeviceBuffer,
}

#[repr(C)]
#[derive(Debug, Clone, Copy, Default)]
pub struct Ds4rtCudaGraphCaptureInfo {
...
#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct Ds4rtRdmaDeviceInfo {
...
impl Default for Ds4rtRdmaDeviceInfo {
    fn default() -> Self {
        Self {
            rdma_enabled: 0,
            device_count: 0,
...
#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct Ds4rtRdmaHostBufferPlan {
...
impl Default for Ds4rtRdmaHostBufferPlan {
    fn default() -> Self {
        Self {
            original_addr: 0,
            original_bytes: 0,
...
#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct Ds4rtRdmaRegisterProbe {
    pub bytes: usize,
...
impl Default for Ds4rtRdmaRegisterProbe {
    fn default() -> Self {
        Self {
            bytes: 0,
            registered: 0,
...
impl Default for Ds4rtRdmaRcQpProbe {
    fn default() -> Self {
        Self {
            rdma_enabled: 0,
            created: 0,
...
#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct Ds4rtRdmaRcSendRecvProbe {
    pub rdma_enabled: c_int,
    pub completed: c_int,
...
impl Default for Ds4rtRdmaRcSendRecvProbe {
    fn default() -> Self {
        Self {
            rdma_enabled: 0,
            completed: 0,
...
#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct Ds4rtRdmaRcProtocolV2LoopbackProbe {
    pub rdma_enabled: c_int,
    pub completed: c_int,
...
impl Default for Ds4rtRdmaRcProtocolV2LoopbackProbe {
    fn default() -> Self {
        Self {
            rdma_enabled: 0,
            completed: 0,
...
#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct Ds4rtRdmaRcEndpointInfo {
    pub rdma_enabled: c_int,
...
impl Default for Ds4rtRdmaRcEndpointInfo {
    fn default() -> Self {
        Self {
            rdma_enabled: 0,
...
#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct Ds4rtRdmaRcEndpointBufferView {
...
impl Default for Ds4rtRdmaRcEndpointBufferView {
    fn default() -> Self {
        Self {
            ...
            bytes: 0,
            device_id: -1,
            host_flags: DS4RT_HOST_BUFFER_FLAG_NONE,
        }
    }
}
...
#[repr(C)]
#[derive(Debug, Clone, Copy)]
pub struct Ds4rtRdmaRcCompletionStats {
...
impl Default for Ds4rtRdmaRcCompletionStats {
    fn default() -> Self {
        Self {
...
type VersionFn = unsafe extern "C" fn(out: *mut c_char, out_len: usize) -> Ds4rtStatus;
type DeviceInfoFn =
    unsafe extern "C" fn(device_id: c_int, out: *mut Ds4rtCudaDeviceInfo) -> Ds4rtStatus;
type AllocHostBufferFn =
    unsafe extern "C" fn(bytes: usize, out: *mut Ds4rtHostBuffer) -> Ds4rtStatus;
type CudaHostBufferDeviceAliasFn =
    unsafe extern "C" fn(host: Ds4rtHostBuffer, out: *mut Ds4rtDeviceBuffer) -> Ds4rtStatus;
type FreeHostBufferFn = unsafe extern "C" fn(buf: *mut Ds4rtHostBuffer) -> Ds4rtStatus;
type AllocDeviceBufferFn =
    unsafe extern "C" fn(bytes: usize, out: *mut Ds4rtDeviceBuffer) -> Ds4rtStatus;
type AllocManagedDeviceBufferFn =
    unsafe extern "C" fn(bytes: usize, out: *mut Ds4rtDeviceBuffer) -> Ds4rtStatus;
type FreeDeviceBufferFn = unsafe extern "C" fn(buf: *mut Ds4rtDeviceBuffer) -> Ds4rtStatus;
type CudaStreamCreateFn = unsafe extern "C" fn(out: *mut *mut c_void) -> Ds4rtStatus;
type CudaStreamDestroyFn = unsafe extern "C" fn(cuda_stream: *mut c_void) -> Ds4rtStatus;
type CudaStreamSynchronizeFn = unsafe extern "C" fn(cuda_stream: *mut c_void) -> Ds4rtStatus;
type CudaStreamWaitEventFn =
    unsafe extern "C" fn(cuda_stream: *mut c_void, cuda_event: *mut c_void) -> Ds4rtStatus;
type CudaEventCreateFn = unsafe extern "C" fn(out: *mut *mut c_void) -> Ds4rtStatus;
type CudaEventDestroyFn = unsafe extern "C" fn(cuda_event: *mut c_void) -> Ds4rtStatus;
type CudaEventRecordFn =
    unsafe extern "C" fn(cuda_event: *mut c_void, cuda_stream: *mut c_void) -> Ds4rtStatus;
type CudaEventSynchronizeFn = unsafe extern "C" fn(cuda_event: *mut c_void) -> Ds4rtStatus;
type CudaEventElapsedMsFn = unsafe extern "C" fn(
    start_event: *mut c_void,
    end_event: *mut c_void,
    out_ms: *mut f32,
) -> Ds4rtStatus;
type CudaGraphBeginCaptureFn = unsafe extern "C" fn(cuda_stream: *mut c_void) -> Ds4rtStatus;
...
type CudaGraphEndCaptureRetainedFn = unsafe extern "C" fn(
    cuda_stream: *mut c_void,
    out: *mut Ds4rtCudaGraphCaptureInfo,
) -> Ds4rtStatus;
type CudaGraphLaunchFn =
    unsafe extern "C" fn(cuda_graph_exec: *mut c_void, cuda_stream: *mut c_void) -> Ds4rtStatus;
type CudaGraphExecUpdateFn =
    unsafe extern "C" fn(cuda_graph_exec: *mut c_void, cuda_graph: *mut c_void) -> Ds4rtStatus;
type CudaGraphDestroyFn = unsafe extern "C" fn(cuda_graph: *mut c_void) -> Ds4rtStatus;
type CudaGraphExecDestroyFn = unsafe extern "C" fn(cuda_graph_exec: *mut c_void) -> Ds4rtStatus;
...
type CudaGraphUpdateEmbeddingLookupBf16NodeFn = unsafe extern "C" fn(
    ...
    cuda_graph_exec: *mut c_void,
    kernel_node_index: usize,
    embedding: Ds4rtDeviceBuffer,
    token_ids: Ds4rtDeviceBuffer,
    out: Ds4rtDeviceBuffer,
    rows: usize,
    vocab: usize,
    hidden: usize,
...
type CudaGraphUpdateLmHeadArgmaxBf16NodeFn = unsafe extern "C" fn(
    ...
    lm_head: Ds4rtDeviceBuffer,
    out_indices: Ds4rtDeviceBuffer,
    out_scores: Ds4rtDeviceBuffer,
    rows: usize,
    hidden_dim: usize,
    vocab: usize,
) -> Ds4rtStatus;
type CudaGraphUpdateLmHeadSampleTopKToppBf16NodeFn = unsafe extern "C" fn(
    ...
    hidden: Ds4rtDeviceBuffer,
    lm_head: Ds4rtDeviceBuffer,
    random_uniforms: Ds4rtDeviceBuffer,
    out_indices: Ds4rtDeviceBuffer,
    out_scores: Ds4rtDeviceBuffer,
    rows: usize,
    hidden_dim: usize,
...
type CudaGraphUpdateRouterTopKBf16NodeFn = unsafe extern "C" fn(
    ...
    correction_bias: Ds4rtDeviceBuffer,
    topk_indices: Ds4rtDeviceBuffer,
    topk_scores: Ds4rtDeviceBuffer,
    topk_weights: Ds4rtDeviceBuffer,
    rows: usize,
    hidden_dim: usize,
    experts: usize,
    top_k: usize,
...
type CudaGraphUpdateSiluGatedMlpRowsBf16DownStrideNodeFn = unsafe extern "C" fn(
    ...
    kernel_node_index: usize,
    x: Ds4rtDeviceBuffer,
    gate_weight: Ds4rtDeviceBuffer,
    up_weight: Ds4rtDeviceBuffer,
    down_weight: Ds4rtDeviceBuffer,
    out: Ds4rtDeviceBuffer,
    rows: usize,
    hidden: usize,
    intermediate: usize,
...
type CudaGraphUpdateResidualAddBf16NodeFn = unsafe extern "C" fn(
    ...
    cuda_graph_exec: *mut c_void,
    kernel_node_index: usize,
    residual: Ds4rtDeviceBuffer,
    delta: Ds4rtDeviceBuffer,
    out: Ds4rtDeviceBuffer,
    count: usize,
) -> Ds4rtStatus;
...
type CudaGraphUpdateResidualAddSharedF32DeltaBf16NodeFn = unsafe extern "C" fn(
    ...
    routed_delta_f32: Ds4rtDeviceBuffer,
    out: Ds4rtDeviceBuffer,
    count: usize,
) -> Ds4rtStatus;
...
type CudaGraphUpdateMlaKvCacheUnpackBf16NodeFn = unsafe extern "C" fn(
    ...
    kv_latent: Ds4rtDeviceBuffer,
    k_rope: Ds4rtDeviceBuffer,
    dsa_key: Ds4rtDeviceBuffer,
    rows: usize,
    kv_lora_rank: usize,
    rope_dim: usize,
    dsa_dim: usize,
...
type CudaGraphUpdateF32ToBf16NodeFn = unsafe extern "C" fn(
    ...
    cuda_graph_exec: *mut c_void,
    kernel_node_index: usize,
    src: Ds4rtDeviceBuffer,
    dst: Ds4rtDeviceBuffer,
    count: usize,
) -> Ds4rtStatus;
...
type CudaGraphUpdateKvCacheWriteBytesNodeFn = unsafe extern "C" fn(
    ...
    kernel_node_index: usize,
    src: Ds4rtDeviceBuffer,
    cache: Ds4rtDeviceBuffer,
    cache_offset_bytes: usize,
    bytes: usize,
) -> Ds4rtStatus;
type CopyH2DFn =
    unsafe extern "C" fn(dst: Ds4rtDeviceBuffer, src: *const c_void, bytes: usize) -> Ds4rtStatus;
type CopyD2HFn =
    unsafe extern "C" fn(dst: *mut c_void, src: Ds4rtDeviceBuffer, bytes: usize) -> Ds4rtStatus;
...
type LastErrorFn = unsafe extern "C" fn(out: *mut c_char, out_len: usize) -> Ds4rtStatus;
type NcclUniqueIdBytesFn = unsafe extern "C" fn(out_bytes: *mut usize) -> Ds4rtStatus;
type NcclGetUniqueIdFn = unsafe extern "C" fn(out: *mut c_void, out_bytes: usize) -> Ds4rtStatus;
...
type NcclGatherU8AsyncFn = unsafe extern "C" fn(
    handle: *mut c_void,
    send: Ds4rtDeviceBuffer,
    recv: Ds4rtDeviceBuffer,
    bytes: usize,
    root: c_int,
    cuda_stream: *mut c_void,
) -> Ds4rtStatus;
...
type NcclCommDestroyFn = unsafe extern "C" fn(handle: *mut c_void) -> Ds4rtStatus;
...
type CudaB12xSparkAotAvailableFn = unsafe extern "C" fn(out_available: *mut c_int) -> Ds4rtStatus;
type CudaB12xSparkAotInitFn = unsafe extern "C" fn() -> Ds4rtStatus;
type CudaDs4FlashSparkAotAvailableFn =
    unsafe extern "C" fn(out_available: *mut c_int) -> Ds4rtStatus;
type CudaDs4FlashSparkAotInitFn = unsafe extern "C" fn() -> Ds4rtStatus;
...
type CudaDs4FlashSharedExpertFp8Bf16AsyncFn = unsafe extern "C" fn(
    buffers: *const Ds4rtDs4FlashSharedExpertFp8Buffers,
    rows: usize,
    cuda_stream: *mut c_void,
) -> Ds4rtStatus;
...
type CudaDs4ProSharedExpertFp8PrefillBf16AsyncFn = unsafe extern "C" fn(
    buffers: *const Ds4rtDs4ProSharedExpertFp8PrefillBuffers,
    rows: usize,
    cuda_stream: *mut c_void,
) -> Ds4rtStatus;
type CudaDs4FlashSparkW4a16DecodeM1Bf16AsyncFn = unsafe extern "C" fn(
    buffers: *const Ds4rtDs4FlashSparkW4a16MoeBuffers,
    cuda_stream: *mut c_void,
) -> Ds4rtStatus;
...
type CudaDs4FlashSparkExl3K2DecodeM1AsyncFn = unsafe extern "C" fn(
    buffers: *const Ds4rtDs4FlashSparkExl3K2MoeBuffers,
    cuda_stream: *mut c_void,
) -> Ds4rtStatus;
...
type CudaDs4ProSparkExl3K2DecodeM1AsyncFn = unsafe extern "C" fn(
    buffers: *const Ds4rtDs4ProSparkExl3K2MoeBuffers,
    cuda_stream: *mut c_void,
) -> Ds4rtStatus;
...
type CudaDs4FlashPackTopk6RoutesAsyncFn = unsafe extern "C" fn(
    buffers: *const Ds4rtDs4FlashRoutePackBuffers,
    rows: usize,
    cuda_stream: *mut c_void,
) -> Ds4rtStatus;
type CudaQuantizeBf16WeightNvfp4AsyncFn = unsafe extern "C" fn(
    input: Ds4rtDeviceBuffer,
    packed: Ds4rtDeviceBuffer,
    scales: Ds4rtDeviceBuffer,
    rows: usize,
    cols: usize,
    global_scale: f32,
    cuda_stream: *mut c_void,
...
type CudaB12xSparkW4a16DecodeM1Nvfp4AsyncFn = unsafe extern "C" fn(
    buffers: *const Ds4rtB12xSparkW4a16MoeBuffers,
    input_payload: Ds4rtDeviceBuffer,
    input_payload_stride_bytes: usize,
    topk_ids: Ds4rtDeviceBuffer,
    cuda_stream: *mut c_void,
) -> Ds4rtStatus;
...
type CudaB12xCoordinatorAotAvailableFn =
    unsafe extern "C" fn(out_available: *mut c_int) -> Ds4rtStatus;
type CudaB12xCoordinatorAotInitFn = unsafe extern "C" fn() -> Ds4rtStatus;
type CudaB12xCoordinatorW4a16QuantizePackWeightAsyncFn = unsafe extern "C" fn(
    input_bf16: Ds4rtDeviceBuffer,
    payload_scratch: Ds4rtDeviceBuffer,
    packed_weight: Ds4rtDeviceBuffer,
    packed_scale: Ds4rtDeviceBuffer,
    global_scale: Ds4rtDeviceBuffer,
    size_k: usize,
    size_n: usize,
    cuda_stream: *mut c_void,
) -> Ds4rtStatus;
type CudaB12xCoordinatorW4a16BuffersAsyncFn = unsafe extern "C" fn(
    buffers: *const Ds4rtB12xCoordinatorW4a16Buffers,
    cuda_stream: *mut c_void,
) -> Ds4rtStatus;
...
type CudaNvfp4SiluGatedMlpRouteBf16BatchedStagedAccumulateF32Fn =
    unsafe extern "C" fn(
        ...
        row_indices: *const u32,
        route_weights: *const f32,
        route_metadata: *const Ds4rtNvfp4RouteBatchedMetadata,
        activation_workspace: *mut f32,
        accumulator: *mut f32,
        rows: usize,
        routes: usize,
...
type CudaSummarizeBf16Fn = unsafe extern "C" fn(
    input: *const u16,
    count: usize,
    out: *mut Ds4rtBf16Summary,
) -> Ds4rtStatus;
type CudaSummarizeBf16AsyncFn = unsafe extern "C" fn(
    input: *const u16,
    count: usize,
    out_device: *mut Ds4rtBf16Summary,
    cuda_stream: *mut c_void,
) -> Ds4rtStatus;
type CudaZeroF32Fn = unsafe extern "C" fn(dst: *mut f32, count: usize) -> Ds4rtStatus;
type CudaZeroF32AsyncFn =
    unsafe extern "C" fn(dst: *mut f32, count: usize, cuda_stream: *mut c_void) -> Ds4rtStatus;
type CudaAccumulateBf16ToF32Fn =
    unsafe extern "C" fn(src: *const u16, dst: *mut f32, count: usize) -> Ds4rtStatus;
...
type CudaZeroBytesFn = unsafe extern "C" fn(dst: *mut c_void, bytes: usize) -> Ds4rtStatus;
type CudaZeroBytesAsyncFn =
    unsafe extern "C" fn(dst: *mut c_void, bytes: usize, cuda_stream: *mut c_void) -> Ds4rtStatus;
type CudaF32ToBf16Fn =
    unsafe extern "C" fn(src: *const f32, dst: *mut u16, count: usize) -> Ds4rtStatus;
...
type CudaReduceRouteShardsToF32Fn = unsafe extern "C" fn(
    buffers: *const Ds4rtRouteShardReductionBuffers,
    rows: usize,
    row_width: usize,
    peer_row_stride_bytes: usize,
    local_dtype: u32,
...
type CudaPreloadW8a16Group256AotFn =
    unsafe extern "C" fn(input_dim: usize, output_dim: usize) -> Ds4rtStatus;
...
type CudaPackNibblesFn =
    unsafe extern "C" fn(codes: *const u8, packed: *mut u8, count: usize) -> Ds4rtStatus;
type CudaUnpackNibblesFn =
    unsafe extern "C" fn(packed: *const u8, codes: *mut u8, count: usize) -> Ds4rtStatus;
type RdmaDeviceInfoFn = unsafe extern "C" fn(out: *mut Ds4rtRdmaDeviceInfo) -> Ds4rtStatus;
type RdmaPlanHostBufferRegistrationFn = unsafe extern "C" fn(
    ptr: *const c_void,
    bytes: usize,
    alignment: usize,
    out: *mut Ds4rtRdmaHostBufferPlan,
) -> Ds4rtStatus;
type RdmaRegisterHostBufferProbeFn = unsafe extern "C" fn(
    ptr: *mut c_void,
    bytes: usize,
    out: *mut Ds4rtRdmaRegisterProbe,
) -> Ds4rtStatus;
type RdmaCreateRcQpProbeFn = unsafe extern "C" fn(
    ...
    recv_wr: u32,
    max_sge: u32,
    out: *mut Ds4rtRdmaRcQpProbe,
) -> Ds4rtStatus;
type RdmaRcSendRecvLoopbackProbeFn = unsafe extern "C" fn(
    port_num: u32,
    bytes: usize,
    out: *mut Ds4rtRdmaRcSendRecvProbe,
) -> Ds4rtStatus;
type RdmaRcProtocolV2LoopbackProbeFn = unsafe extern "C" fn(
    ...
    out: *mut Ds4rtRdmaRcProtocolV2LoopbackProbe,
) -> Ds4rtStatus;
type RdmaRcEndpointCreateFn = unsafe extern "C" fn(
    ...
    max_recv_wr: u32,
    max_sge: u32,
    out: *mut Ds4rtRdmaRcEndpointInfo,
) -> Ds4rtStatus;
...
type RdmaRcEndpointBufferViewFn = unsafe extern "C" fn(
    ...
    out: *mut Ds4rtRdmaRcEndpointBufferView,
) -> Ds4rtStatus;
...
type RdmaRcEndpointPostRecvFn =
    unsafe extern "C" fn(handle: *mut c_void, bytes: usize, wr_id: u64) -> Ds4rtStatus;
...
type RdmaRcEndpointPollFn = unsafe extern "C" fn(
    ...
    out: *mut Ds4rtRdmaRcCompletionStats,
) -> Ds4rtStatus;
...
type RdmaRcEndpointDestroyFn = unsafe extern "C" fn(handle: *mut c_void) -> Ds4rtStatus;
...
type XGrammarCompilerDestroyFn = unsafe extern "C" fn(compiler: *mut c_void) -> Ds4rtStatus;
...
type XGrammarGrammarDestroyFn = unsafe extern "C" fn(grammar: *mut c_void) -> Ds4rtStatus;
...
type XGrammarMatcherDestroyFn = unsafe extern "C" fn(matcher: *mut c_void) -> Ds4rtStatus;
...
pub const DS4RT_XGRAMMAR_JSON_OBJECT: c_int = 1;
pub const DS4RT_XGRAMMAR_JSON_SCHEMA: c_int = 2;
pub const DS4RT_XGRAMMAR_STRUCTURAL_TAG: c_int = 3;

pub struct Ds4rtXGrammarCompiler<'a> {
    handle: *mut c_void,
    library: &'a NativeLibrary,
}

pub struct Ds4rtXGrammarGrammar<'a> {
    handle: *mut c_void,
    library: &'a NativeLibrary,
}

pub struct Ds4rtXGrammarMatcher<'a> {
    handle: *mut c_void,
    library: &'a NativeLibrary,
}

unsafe impl Send for Ds4rtXGrammarCompiler<'_> {}
unsafe impl Sync for Ds4rtXGrammarCompiler<'_> {}
unsafe impl Send for Ds4rtXGrammarGrammar<'_> {}
unsafe impl Sync for Ds4rtXGrammarGrammar<'_> {}
unsafe impl Send for Ds4rtXGrammarMatcher<'_> {}
...
impl NativeLibrary {
    pub fn xgrammar_compiler<'a>(
        ...
        vocab_size: usize,
        stop_token_ids: &[i32],
    ) -> Result<Ds4rtXGrammarCompiler<'a>> {
        ...
        let create: Symbol<XGrammarCompilerCreateFn> =
            unsafe { self.lib.get(b"ds4rt_xgrammar_compiler_create")? };
        ...
        xgrammar_status("ds4rt_xgrammar_compiler_create", status, &error)?;
        anyhow::ensure!(!handle.is_null(), "native XGrammar compiler handle is null");
        Ok(Ds4rtXGrammarCompiler {
            handle,
            library: self,
        })
    }
...
impl<'a> Ds4rtXGrammarCompiler<'a> {
    pub fn compile(
        &self,
        kind: c_int,
        grammar_json: Option<&str>,
        strict: bool,
    ) -> Result<Ds4rtXGrammarGrammar<'a>> {
        ...
        let compile: Symbol<XGrammarCompileFn> =
            unsafe { self.library.lib.get(b"ds4rt_xgrammar_compile")? };
        let mut handle = std::ptr::null_mut();
        let mut error = [0 as c_char; XGRAMMAR_ERROR_BYTES];
        let status = unsafe {
            compile(
        ...
        xgrammar_status("ds4rt_xgrammar_compile", status, &error)?;
        anyhow::ensure!(!handle.is_null(), "native XGrammar grammar handle is null");
        Ok(Ds4rtXGrammarGrammar {
            handle,
...
impl<'a> Ds4rtXGrammarGrammar<'a> {
    pub fn matcher(&self) -> Result<Ds4rtXGrammarMatcher<'a>> {
        let create: Symbol<XGrammarMatcherCreateFn> =
            unsafe { self.library.lib.get(b"ds4rt_xgrammar_matcher_create")? };
        let mut handle = std::ptr::null_mut();
        let mut error = [0 as c_char; XGRAMMAR_ERROR_BYTES];
        let status = unsafe { create(self.handle, &mut handle, error.as_mut_ptr(), error.len()) };
        xgrammar_status("ds4rt_xgrammar_matcher_create", status, &error)?;
        anyhow::ensure!(!handle.is_null(), "native XGrammar matcher handle is null");
        Ok(Ds4rtXGrammarMatcher {
            handle,
            library: self.library,
        })
    }
...
impl<'a> Ds4rtXGrammarMatcher<'a> {
    pub fn fork(&self) -> Result<Self> {
        let fork: Symbol<XGrammarMatcherForkFn> =
            unsafe { self.library.lib.get(b"ds4rt_xgrammar_matcher_fork")? };
        let mut handle = std::ptr::null_mut();
        let mut error = [0 as c_char; XGRAMMAR_ERROR_BYTES];
        let status = unsafe { fork(self.handle, &mut handle, error.as_mut_ptr(), error.len()) };
        xgrammar_status("ds4rt_xgrammar_matcher_fork", status, &error)?;
    ...
    pub fn fill_bitmask(&mut self, bitmask: &mut [u32]) -> Result<bool> {
        ...
        let fill: Symbol<XGrammarMatcherFillBitmaskFn> = unsafe {
            self.library
                .lib
                .get(b"ds4rt_xgrammar_matcher_fill_bitmask")?
        };
        ...
        xgrammar_status("ds4rt_xgrammar_matcher_fill_bitmask", status, &error)?;
        Ok(needs_mask != 0)
    }
    ...
    pub fn accept_token(&mut self, token_id: u32) -> Result<bool> {
        let accept: Symbol<XGrammarMatcherAcceptTokenFn> = unsafe {
            self.library
                .lib
                .get(b"ds4rt_xgrammar_matcher_accept_token")?
        };
        let mut accepted = 0;
        let mut error = [0 as c_char; XGRAMMAR_ERROR_BYTES];
        let status = unsafe {
        ...
        xgrammar_status("ds4rt_xgrammar_matcher_accept_token", status, &error)?;
        Ok(accepted != 0)
    }
    ...
    pub fn is_completed(&self) -> Result<bool> {
        let completed: Symbol<XGrammarMatcherIsCompletedFn> = unsafe {
            self.library
                .lib
                .get(b"ds4rt_xgrammar_matcher_is_completed")?
        };
        ...
        xgrammar_status("ds4rt_xgrammar_matcher_is_completed", status, &error)?;
        Ok(is_completed != 0)
    }
}

impl Drop for Ds4rtXGrammarCompiler<'_> {
    fn drop(&mut self) {
        if let Ok(destroy) = unsafe {
            self.library
                .lib
                .get::<XGrammarCompilerDestroyFn>(b"ds4rt_xgrammar_compiler_destroy")
        } {
...
impl Drop for Ds4rtXGrammarGrammar<'_> {
    fn drop(&mut self) {
        if let Ok(destroy) = unsafe {
            self.library
                .lib
                .get::<XGrammarGrammarDestroyFn>(b"ds4rt_xgrammar_grammar_destroy")
        } {
            let _ = unsafe { destroy(self.handle) };
        }
        self.handle = std::ptr::null_mut();
...
impl Drop for Ds4rtXGrammarMatcher<'_> {
    fn drop(&mut self) {
        if let Ok(destroy) = unsafe {
            self.library
                .lib
                .get::<XGrammarMatcherDestroyFn>(b"ds4rt_xgrammar_matcher_destroy")
        } {
            let _ = unsafe { destroy(self.handle) };
        }
        self.handle = std::ptr::null_mut();
...
unsafe impl Send for Ds4rtNcclComm {}
...
impl Ds4rtNcclComm {
    ...
    pub unsafe fn gather_u8_async(
        ...
        let gather_fn: Symbol<NcclGatherU8AsyncFn> =
            unsafe { self.library.lib.get(b"ds4rt_nccl_gather_u8_async")? };
        let status =
            unsafe { gather_fn(self.handle, send, recv, bytes, root as c_int, cuda_stream) };
        self.library
            .status_to_result("ds4rt_nccl_gather_u8_async", status)
    }
    ...
    pub unsafe fn row_all_to_all_u8_async(
        ...
        let all_to_all_fn: Symbol<NcclRowAllToAllU8AsyncFn> = unsafe {
            self.library
                .lib
                .get(b"ds4rt_nccl_row_all_to_all_u8_async")?
        };
        let status =
            unsafe { all_to_all_fn(self.handle, send, recv, rows, row_stride_bytes, cuda_stream) };
        self.library
            .status_to_result("ds4rt_nccl_row_all_to_all_u8_async", status)
    }
    ...
    pub unsafe fn all_reduce_bf16_async(
        ...
        let all_reduce_fn: Symbol<NcclAllReduceBf16AsyncFn> =
            unsafe { self.library.lib.get(b"ds4rt_nccl_all_reduce_bf16_async")? };
        let status = unsafe { all_reduce_fn(self.handle, send, recv, values, cuda_stream) };
        self.library
            .status_to_result("ds4rt_nccl_all_reduce_bf16_async", status)
    }
    ...
    pub unsafe fn reduce_bf16_async(
        ...
        let reduce_fn: Symbol<NcclReduceBf16AsyncFn> =
            unsafe { self.library.lib.get(b"ds4rt_nccl_reduce_bf16_async")? };
        let status =
            unsafe { reduce_fn(self.handle, send, recv, values, root as c_int, cuda_stream) };
        self.library
            .status_to_result("ds4rt_nccl_reduce_bf16_async", status)
    }
}

impl Drop for Ds4rtNcclComm {
    fn drop(&mut self) {
        ...
        if let Ok(destroy_fn) = unsafe {
            self.library
                .lib
                .get::<NcclCommDestroyFn>(b"ds4rt_nccl_comm_destroy")
        } {
...
struct SyncH2DStagingBuffer {
    buffer: Ds4rtHostBuffer,
}

impl Default for SyncH2DStagingBuffer {
    fn default() -> Self {
        Self {
            buffer: Ds4rtHostBuffer::default(),
        }
    }
}
...
impl SyncH2DStagingBuffer {
    fn ensure(&mut self, library: &NativeLibrary, bytes: usize) -> Result<Ds4rtHostBuffer> {
        if self.buffer.ptr.is_null() || self.buffer.bytes < bytes {
            if !self.buffer.ptr.is_null() {
                ...
                self.buffer = Ds4rtHostBuffer::default();
            }
            self.buffer = library
    ...
    fn release_with_library(&mut self, lib: &Library) {
        ...
        if let Ok(free_fn) = unsafe { lib.get::<FreeHostBufferFn>(b"ds4rt_free_host_buffer") } {
...
impl NativeLibrary {
    pub unsafe fn load(path: impl AsRef<Path>) -> Result<Self> {
        ...
        let rdma_rc_endpoint_try_poll_fn =
            unsafe { *lib.get::<RdmaRcEndpointTryPollFn>(b"ds4rt_rdma_rc_endpoint_try_poll")? };
        Ok(Self {
            lib,
    ...
    pub fn version(&self) -> Result<String> {
        let version_fn: Symbol<VersionFn> = unsafe { self.lib.get(b"ds4rt_native_version")? };
        let mut buf = vec![0 as c_char; 128];
        let status = unsafe { version_fn(buf.as_mut_ptr(), buf.len()) };
        self.status_to_result("ds4rt_native_version", status)?;
        let cstr = unsafe { CStr::from_ptr(buf.as_ptr()) };
        Ok(cstr.to_string_lossy().into_owned())
    }

    pub fn cuda_device_info(&self, device_id: i32) -> Result<Ds4rtCudaDeviceInfo> {
        let info_fn: Symbol<DeviceInfoFn> = unsafe { self.lib.get(b"ds4rt_cuda_device_info")? };
        let mut info = Ds4rtCudaDeviceInfo::default();
        let status = unsafe { info_fn(device_id, &mut info) };
        self.status_to_result("ds4rt_cuda_device_info", status)?;
        Ok(info)
    }

    pub fn nccl_unique_id_bytes(&self) -> Result<usize> {
        let bytes_fn: Symbol<NcclUniqueIdBytesFn> =
            unsafe { self.lib.get(b"ds4rt_nccl_unique_id_bytes")? };
        let mut bytes = 0_usize;
        let status = unsafe { bytes_fn(&mut bytes) };
        self.status_to_result("ds4rt_nccl_unique_id_bytes", status)?;
    ...
    pub fn nccl_get_unique_id(&self) -> Result<Vec<u8>> {
        ...
        let get_fn: Symbol<NcclGetUniqueIdFn> =
            unsafe { self.lib.get(b"ds4rt_nccl_get_unique_id")? };
        let status = unsafe { get_fn(unique_id.as_mut_ptr().cast(), unique_id.len()) };
        self.status_to_result("ds4rt_nccl_get_unique_id", status)?;
        Ok(unique_id)
    }
    ...
    pub fn nccl_comm_init_rank(
        ...
        let init_fn: Symbol<NcclCommInitRankFn> =
            unsafe { self.lib.get(b"ds4rt_nccl_comm_init_rank")? };
        let mut handle = std::ptr::null_mut();
        let status = unsafe {
            init_fn(
        ...
        self.status_to_result("ds4rt_nccl_comm_init_rank", status)?;
    ...
    pub fn alloc_host_buffer(&self, bytes: usize) -> Result<Ds4rtHostBuffer> {
        let alloc_fn: Symbol<AllocHostBufferFn> =
            unsafe { self.lib.get(b"ds4rt_alloc_host_buffer")? };
        let mut buffer = Ds4rtHostBuffer::default();
        let status = unsafe { alloc_fn(bytes, &mut buffer) };
        self.status_to_result("ds4rt_alloc_host_buffer", status)?;
        Ok(buffer)
    }

    pub fn cuda_host_buffer_device_alias(
        &self,
        host: Ds4rtHostBuffer,
        ...
        let alias_fn: Symbol<CudaHostBufferDeviceAliasFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_host_buffer_device_alias")? };
        let mut alias = Ds4rtDeviceBuffer::default();
        let status = unsafe { alias_fn(host, &mut alias) };
        self.status_to_result("ds4rt_cuda_host_buffer_device_alias", status)?;
        Ok(alias)
    }

    pub fn free_host_buffer(&self, buffer: &mut Ds4rtHostBuffer) -> Result<()> {
        let free_fn: Symbol<FreeHostBufferFn> = unsafe { self.lib.get(b"ds4rt_free_host_buffer")? };
        let status = unsafe { free_fn(buffer) };
        self.status_to_result("ds4rt_free_host_buffer", status)
    }

    pub fn alloc_device_buffer(&self, bytes: usize) -> Result<Ds4rtDeviceBuffer> {
        let alloc_fn: Symbol<AllocDeviceBufferFn> =
            unsafe { self.lib.get(b"ds4rt_alloc_device_buffer")? };
        let mut buffer = Ds4rtDeviceBuffer::default();
        let status = unsafe { alloc_fn(bytes, &mut buffer) };
        self.status_to_result("ds4rt_alloc_device_buffer", status)?;
        Ok(buffer)
    }

    pub fn alloc_managed_device_buffer(&self, bytes: usize) -> Result<Ds4rtDeviceBuffer> {
        let alloc_fn: Symbol<AllocManagedDeviceBufferFn> =
            unsafe { self.lib.get(b"ds4rt_alloc_managed_device_buffer")? };
        let mut buffer = Ds4rtDeviceBuffer::default();
        let status = unsafe { alloc_fn(bytes, &mut buffer) };
        self.status_to_result("ds4rt_alloc_managed_device_buffer", status)?;
        Ok(buffer)
    }

    pub fn free_device_buffer(&self, buffer: &mut Ds4rtDeviceBuffer) -> Result<()> {
        let free_fn: Symbol<FreeDeviceBufferFn> =
            unsafe { self.lib.get(b"ds4rt_free_device_buffer")? };
        let status = unsafe { free_fn(buffer) };
        self.status_to_result("ds4rt_free_device_buffer", status)
    }

    pub fn cuda_stream_create(&self) -> Result<*mut c_void> {
        let create_fn: Symbol<CudaStreamCreateFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_stream_create")? };
        let mut cuda_stream = std::ptr::null_mut();
        let status = unsafe { create_fn(&mut cuda_stream) };
        self.status_to_result("ds4rt_cuda_stream_create", status)?;
        Ok(cuda_stream)
    }

    pub unsafe fn cuda_stream_destroy(&self, cuda_stream: *mut c_void) -> Result<()> {
        let destroy_fn: Symbol<CudaStreamDestroyFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_stream_destroy")? };
        let status = unsafe { destroy_fn(cuda_stream) };
        self.status_to_result("ds4rt_cuda_stream_destroy", status)
    }
    ...
    pub unsafe fn cuda_stream_synchronize(&self, cuda_stream: *mut c_void) -> Result<()> {
        let synchronize_fn: Symbol<CudaStreamSynchronizeFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_stream_synchronize")? };
        let status = unsafe { synchronize_fn(cuda_stream) };
        self.status_to_result("ds4rt_cuda_stream_synchronize", status)
    }
    ...
    pub unsafe fn cuda_event_elapsed_ms(
        ...
        let elapsed_fn: Symbol<CudaEventElapsedMsFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_event_elapsed_ms")? };
        let mut out_ms = 0.0_f32;
        let status = unsafe { elapsed_fn(start_event, end_event, &mut out_ms) };
        self.status_to_result("ds4rt_cuda_event_elapsed_ms", status)?;
        Ok(out_ms)
    }
    ...
    pub unsafe fn cuda_graph_begin_capture(&self, cuda_stream: *mut c_void) -> Result<()> {
        let begin_capture_fn: Symbol<CudaGraphBeginCaptureFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_graph_begin_capture")? };
        let status = unsafe { begin_capture_fn(cuda_stream) };
        self.status_to_result("ds4rt_cuda_graph_begin_capture", status)
    }
    ...
    pub unsafe fn cuda_graph_end_capture(&self, cuda_stream: *mut c_void) -> Result<*mut c_void> {
        let end_capture_fn: Symbol<CudaGraphEndCaptureFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_graph_end_capture")? };
        let mut cuda_graph_exec = std::ptr::null_mut();
        let status = unsafe { end_capture_fn(cuda_stream, &mut cuda_graph_exec) };
        self.status_to_result("ds4rt_cuda_graph_end_capture", status)?;
        Ok(cuda_graph_exec)
    }
    ...
    pub unsafe fn cuda_graph_end_capture_retained(
        &self,
        cuda_stream: *mut c_void,
    ) -> Result<Ds4rtCudaGraphCaptureInfo> {
        let end_capture_fn: Symbol<CudaGraphEndCaptureRetainedFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_graph_end_capture_retained")? };
        let mut capture = Ds4rtCudaGraphCaptureInfo::default();
        let status = unsafe { end_capture_fn(cuda_stream, &mut capture) };
        self.status_to_result("ds4rt_cuda_graph_end_capture_retained", status)?;
        Ok(capture)
    }
    ...
    pub unsafe fn cuda_graph_launch(
        ...
        let launch_fn: Symbol<CudaGraphLaunchFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_graph_launch")? };
        let status = unsafe { launch_fn(cuda_graph_exec, cuda_stream) };
        self.status_to_result("ds4rt_cuda_graph_launch", status)
    }
    ...
    pub unsafe fn cuda_graph_update_rmsnorm_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_rmsnorm_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_rmsnorm_bf16_node graph exec is null");
        }
        validate_f32_rows("ds4rt_cuda_graph_update_rmsnorm_bf16_node", rows, hidden)?;
        let row_values = checked_row_values(
            "ds4rt_cuda_graph_update_rmsnorm_bf16_node x",
            rows as usize,
            hidden as usize,
        )?;
        validate_u16_buffer_values("ds4rt_cuda_graph_update_rmsnorm_bf16_node x", x, row_values)?;
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_rmsnorm_bf16_node weight",
            weight,
            hidden as usize,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_rmsnorm_bf16_node out",
            out,
            row_values,
        )?;

        let update_fn: Symbol<CudaGraphUpdateRmsNormBf16NodeFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_graph_update_rmsnorm_bf16_node")? };
        let status = unsafe {
            update_fn(
                cuda_graph,
                cuda_graph_exec,
        ...
        self.status_to_result("ds4rt_cuda_graph_update_rmsnorm_bf16_node", status)
    }
    ...
    pub unsafe fn cuda_graph_update_layernorm_affine_f32_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_layernorm_affine_f32_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_layernorm_affine_f32_bf16_node graph exec is null"
            );
        }
        validate_f32_rows(
            "ds4rt_cuda_graph_update_layernorm_affine_f32_bf16_node",
            rows,
            hidden,
        )?;
        let row_values = checked_row_values(
            "ds4rt_cuda_graph_update_layernorm_affine_f32_bf16_node x",
            rows as usize,
            hidden as usize,
        )?;
        ...
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_layernorm_affine_f32_bf16_node weight",
            weight,
            hidden as usize,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_layernorm_affine_f32_bf16_node bias",
            bias,
            hidden as usize,
        )?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_graph_update_layernorm_affine_f32_bf16_node out",
            out,
            row_values * std::mem::size_of::<f32>(),
        )?;
        ...
        let update_fn: Symbol<CudaGraphUpdateLayerNormAffineF32Bf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_layernorm_affine_f32_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
    ...
    pub unsafe fn cuda_graph_update_layernorm_affine_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_layernorm_affine_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_layernorm_affine_bf16_node graph exec is null");
        }
        validate_f32_rows(
            "ds4rt_cuda_graph_update_layernorm_affine_bf16_node",
            rows,
            hidden,
        )?;
        let row_values = checked_row_values(
            "ds4rt_cuda_graph_update_layernorm_affine_bf16_node x",
            rows as usize,
            hidden as usize,
        )?;
        validate_u16_buffer_values(
        ...
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_layernorm_affine_bf16_node weight",
            weight,
            hidden as usize,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_layernorm_affine_bf16_node bias",
            bias,
            hidden as usize,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_layernorm_affine_bf16_node out",
            out,
            row_values,
        )?;
        ...
        let update_fn: Symbol<CudaGraphUpdateLayerNormAffineBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_layernorm_affine_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
        ...
        self.status_to_result("ds4rt_cuda_graph_update_layernorm_affine_bf16_node", status)
    }
    ...
    pub unsafe fn cuda_graph_update_linear_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_linear_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_linear_bf16_node graph exec is null");
        }
        validate_linear_bf16_buffers(
            "ds4rt_cuda_graph_update_linear_bf16_node",
            input,
            weight,
            bias,
            output,
        ...
        let update_fn: Symbol<CudaGraphUpdateLinearBf16NodeFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_graph_update_linear_bf16_node")? };
        let bias_storage = bias;
        let bias_ptr = bias_storage
            .as_ref()
            .map(|buffer| buffer as *const Ds4rtDeviceBuffer)
        ...
        self.status_to_result("ds4rt_cuda_graph_update_linear_bf16_node", status)
    }
    ...
    pub unsafe fn cuda_graph_update_embedding_lookup_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_embedding_lookup_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_embedding_lookup_bf16_node graph exec is null");
        }
        validate_embedding_lookup_bf16_buffers(
            "ds4rt_cuda_graph_update_embedding_lookup_bf16_node",
            embedding,
            token_ids,
            out,
            rows,
        ...
        let update_fn: Symbol<CudaGraphUpdateEmbeddingLookupBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_embedding_lookup_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
        ...
        self.status_to_result("ds4rt_cuda_graph_update_embedding_lookup_bf16_node", status)
    }
    ...
    pub unsafe fn cuda_graph_update_lm_head_argmax_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_lm_head_argmax_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_lm_head_argmax_bf16_node graph exec is null");
        }
        validate_lm_head_argmax_bf16_buffers(
            "ds4rt_cuda_graph_update_lm_head_argmax_bf16_node",
            hidden,
            lm_head,
            out_indices,
            out_scores,
        ...
        let update_fn: Symbol<CudaGraphUpdateLmHeadArgmaxBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_lm_head_argmax_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
        ...
        self.status_to_result("ds4rt_cuda_graph_update_lm_head_argmax_bf16_node", status)
    }
    ...
    pub unsafe fn cuda_graph_update_lm_head_sample_topk_topp_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_lm_head_sample_topk_topp_bf16_node graph is null"
            );
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_lm_head_sample_topk_topp_bf16_node graph exec is null"
            );
        }
        validate_lm_head_sample_topk_topp_bf16_buffers(
            "ds4rt_cuda_graph_update_lm_head_sample_topk_topp_bf16_node",
            hidden,
            lm_head,
            random_uniforms,
            out_indices,
        ...
        let update_fn: Symbol<CudaGraphUpdateLmHeadSampleTopKToppBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_lm_head_sample_topk_topp_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
    ...
    pub unsafe fn cuda_graph_update_router_topk_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_router_topk_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_router_topk_bf16_node graph exec is null");
        }
        validate_router_topk_bf16_buffers(
            "ds4rt_cuda_graph_update_router_topk_bf16_node",
            hidden,
            router_weight,
            correction_bias,
            topk_indices,
        ...
        let update_fn: Symbol<CudaGraphUpdateRouterTopKBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_router_topk_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
        ...
        self.status_to_result("ds4rt_cuda_graph_update_router_topk_bf16_node", status)
    }
    ...
    pub unsafe fn cuda_graph_update_silu_gated_mlp_rows_bf16_down_stride_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_silu_gated_mlp_rows_bf16_down_stride_node graph is null"
            );
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_silu_gated_mlp_rows_bf16_down_stride_node graph exec is null"
            );
        }
        validate_mlp_rows_bf16_down_stride_buffers(
            "ds4rt_cuda_graph_update_silu_gated_mlp_rows_bf16_down_stride_node",
            x,
            gate_weight,
            up_weight,
            down_weight,
        ...
        let update_fn: Symbol<CudaGraphUpdateSiluGatedMlpRowsBf16DownStrideNodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_silu_gated_mlp_rows_bf16_down_stride_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
    ...
    pub unsafe fn cuda_graph_update_residual_add_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_residual_add_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_residual_add_bf16_node graph exec is null");
        }
        if count == 0 {
            anyhow::bail!("ds4rt_cuda_graph_update_residual_add_bf16_node count must be positive");
        }
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_residual_add_bf16_node residual",
            residual,
            count,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_residual_add_bf16_node delta",
            delta,
            count,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_residual_add_bf16_node out",
            out,
            count,
        )?;
        ...
        let update_fn: Symbol<CudaGraphUpdateResidualAddBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_residual_add_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
        ...
        self.status_to_result("ds4rt_cuda_graph_update_residual_add_bf16_node", status)
    }
    ...
    pub unsafe fn cuda_graph_update_residual_add_f32_delta_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_residual_add_f32_delta_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_residual_add_f32_delta_bf16_node graph exec is null"
            );
        }
        if count == 0 {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_residual_add_f32_delta_bf16_node count must be positive"
            );
        }
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_residual_add_f32_delta_bf16_node residual",
            residual,
            count,
        )?;
        validate_f32_buffer_values(
            "ds4rt_cuda_graph_update_residual_add_f32_delta_bf16_node delta_f32",
            delta_f32,
            count,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_residual_add_f32_delta_bf16_node out",
            out,
            count,
        )?;
        ...
        let update_fn: Symbol<CudaGraphUpdateResidualAddF32DeltaBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_residual_add_f32_delta_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
        ...
        self.status_to_result(
            "ds4rt_cuda_graph_update_residual_add_f32_delta_bf16_node",
            status,
        )
    }
    ...
    pub unsafe fn cuda_graph_update_residual_add_shared_f32_delta_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_residual_add_shared_f32_delta_bf16_node graph is null"
            );
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_residual_add_shared_f32_delta_bf16_node graph exec is null"
            );
        }
        if count == 0 {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_residual_add_shared_f32_delta_bf16_node count must be positive"
            );
        }
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_residual_add_shared_f32_delta_bf16_node residual",
            residual,
            count,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_residual_add_shared_f32_delta_bf16_node shared_delta",
            shared_delta,
            count,
        )?;
        validate_f32_buffer_values(
            "ds4rt_cuda_graph_update_residual_add_shared_f32_delta_bf16_node routed_delta_f32",
            routed_delta_f32,
            count,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_graph_update_residual_add_shared_f32_delta_bf16_node out",
            out,
            count,
        )?;
        ...
        let update_fn: Symbol<CudaGraphUpdateResidualAddSharedF32DeltaBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_residual_add_shared_f32_delta_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
        ...
        self.status_to_result(
            "ds4rt_cuda_graph_update_residual_add_shared_f32_delta_bf16_node",
            status,
        )
    }
    ...
    pub unsafe fn cuda_graph_update_f32_to_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_f32_to_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_f32_to_bf16_node graph exec is null");
        }
        if count == 0 {
            anyhow::bail!("ds4rt_cuda_graph_update_f32_to_bf16_node count must be positive");
        }
        validate_f32_to_bf16_buffers("ds4rt_cuda_graph_update_f32_to_bf16_node", src, dst, count)?;

        let update_fn: Symbol<CudaGraphUpdateF32ToBf16NodeFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_graph_update_f32_to_bf16_node")? };
        let status = unsafe {
            update_fn(
                cuda_graph,
                cuda_graph_exec,
        ...
        self.status_to_result("ds4rt_cuda_graph_update_f32_to_bf16_node", status)
    }
    ...
    pub unsafe fn cuda_graph_update_scatter_add_rows_bf16_to_f32_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_scatter_add_rows_bf16_to_f32_node graph is null"
            );
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_scatter_add_rows_bf16_to_f32_node graph exec is null"
            );
        }
        validate_row_scatter_bf16_to_f32_buffers(
            "ds4rt_cuda_graph_update_scatter_add_rows_bf16_to_f32_node",
            src,
            row_indices,
            dst,
            dst_rows,
        ...
        let update_fn: Symbol<CudaGraphUpdateScatterAddRowsBf16ToF32NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_scatter_add_rows_bf16_to_f32_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
    ...
    pub unsafe fn cuda_graph_update_kv_cache_write_bytes_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_kv_cache_write_bytes_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_kv_cache_write_bytes_node graph exec is null");
        }
        if bytes == 0 {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_kv_cache_write_bytes_node bytes must be positive"
            );
        }
        validate_kv_cache_write_buffers(
            "ds4rt_cuda_graph_update_kv_cache_write_bytes_node",
            src,
            cache,
            cache_offset_bytes,
            bytes,
        ...
        let update_fn: Symbol<CudaGraphUpdateKvCacheWriteBytesNodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_kv_cache_write_bytes_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
        ...
        self.status_to_result("ds4rt_cuda_graph_update_kv_cache_write_bytes_node", status)
    }
    ...
    pub unsafe fn cuda_graph_update_causal_attention_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_causal_attention_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_causal_attention_bf16_node graph exec is null");
        }
        validate_causal_attention_bf16_buffers(
            "ds4rt_cuda_graph_update_causal_attention_bf16_node",
            q,
            k,
            v,
            out,
        ...
        let update_fn: Symbol<CudaGraphUpdateCausalAttentionBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_causal_attention_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
        ...
        self.status_to_result("ds4rt_cuda_graph_update_causal_attention_bf16_node", status)
    }
    ...
    pub unsafe fn cuda_graph_update_rope_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_rope_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_rope_bf16_node graph exec is null");
        }
        validate_rope_bf16_buffers(
            "ds4rt_cuda_graph_update_rope_bf16_node",
            input,
            positions,
            out,
            rows,
        ...
        let update_fn: Symbol<CudaGraphUpdateRopeBf16NodeFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_graph_update_rope_bf16_node")? };
        let status = unsafe {
            update_fn(
                cuda_graph,
                cuda_graph_exec,
        ...
        self.status_to_result("ds4rt_cuda_graph_update_rope_bf16_node", status)
    }
    ...
    pub unsafe fn cuda_graph_update_mla_rope_attention_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_mla_rope_attention_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_mla_rope_attention_bf16_node graph exec is null"
            );
        }
        validate_mla_rope_attention_bf16_buffers(
            "ds4rt_cuda_graph_update_mla_rope_attention_bf16_node",
            q_nope,
            q_rope,
            k_nope,
            k_rope,
        ...
        let update_fn: Symbol<CudaGraphUpdateMlaRopeAttentionBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_mla_rope_attention_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
    ...
    pub unsafe fn cuda_graph_update_mla_rope_attention_bf16_suffix_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_mla_rope_attention_bf16_suffix_node graph is null"
            );
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_mla_rope_attention_bf16_suffix_node graph exec is null"
            );
        }
        validate_mla_rope_attention_bf16_suffix_buffers(
            "ds4rt_cuda_graph_update_mla_rope_attention_bf16_suffix_node",
            q_nope,
            q_rope,
            k_nope,
            k_rope,
        ...
        let update_fn: Symbol<CudaGraphUpdateMlaRopeAttentionBf16SuffixNodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_mla_rope_attention_bf16_suffix_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
    ...
    pub unsafe fn cuda_graph_update_mla_kv_cache_unpack_bf16_node(
        ...
        kv_latent: Ds4rtDeviceBuffer,
        k_rope: Ds4rtDeviceBuffer,
        dsa_key: Option<Ds4rtDeviceBuffer>,
        rows: usize,
        kv_lora_rank: usize,
        rope_dim: usize,
        dsa_dim: usize,
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_mla_kv_cache_unpack_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_mla_kv_cache_unpack_bf16_node graph exec is null"
            );
        }
        validate_mla_kv_cache_unpack_bf16_buffers(
            "ds4rt_cuda_graph_update_mla_kv_cache_unpack_bf16_node",
            payload,
            kv_latent,
            k_rope,
            dsa_key,
        ...
        let update_fn: Symbol<CudaGraphUpdateMlaKvCacheUnpackBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_mla_kv_cache_unpack_bf16_node")?
        };
    ...
    pub unsafe fn cuda_graph_update_mla_kv_projected_split_bf16_node(
        ...
        if cuda_graph.is_null() {
            anyhow::bail!("ds4rt_cuda_graph_update_mla_kv_projected_split_bf16_node graph is null");
        }
        if cuda_graph_exec.is_null() {
            anyhow::bail!(
                "ds4rt_cuda_graph_update_mla_kv_projected_split_bf16_node graph exec is null"
            );
        }
        validate_mla_kv_projected_split_bf16_buffers(
            "ds4rt_cuda_graph_update_mla_kv_projected_split_bf16_node",
            projected,
            k_nope,
            v,
            rows,
        ...
        let update_fn: Symbol<CudaGraphUpdateMlaKvProjectedSplitBf16NodeFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_graph_update_mla_kv_projected_split_bf16_node")?
        };
        let status = unsafe {
            update_fn(
                cuda_graph,
    ...
    pub fn copy_h2d(&self, dst: Ds4rtDeviceBuffer, src: &[u8]) -> Result<()> {
        if src.is_empty() {
            return Ok(());
        }
        if src.len() > dst.bytes {
            anyhow::bail!(
                "ds4rt_copy_h2d staged source byte count {} exceeds destination device buffer bytes {}",
                src.len(),
                dst.bytes
            );
        }
    ...
    pub fn copy_host_buffer_h2d(
        ...
        if src.ptr.is_null() {
            anyhow::bail!("ds4rt_copy_h2d pinned source host buffer is null");
        }
        if dst.ptr.is_null() {
            anyhow::bail!("ds4rt_copy_h2d destination device buffer is null");
        }
        if bytes > src.bytes {
            anyhow::bail!(
                "ds4rt_copy_h2d pinned source byte count {bytes} exceeds host buffer bytes {}",
                src.bytes
            );
        }
        if bytes > dst.bytes {
            anyhow::bail!(
                "ds4rt_copy_h2d pinned source byte count {bytes} exceeds destination device buffer bytes {}",
                dst.bytes
            );
        }
    ...
    unsafe fn copy_h2d_raw_ptr(
        ...
        let copy_fn: Symbol<CopyH2DFn> = unsafe { self.lib.get(b"ds4rt_copy_h2d")? };
        let status = unsafe { copy_fn(dst, src, bytes) };
        self.status_to_result("ds4rt_copy_h2d", status)
    }
    ...
    pub unsafe fn copy_host_buffer_h2d_async(
        ...
        if src.ptr.is_null() {
            anyhow::bail!("ds4rt_copy_h2d_async pinned source host buffer is null");
        }
        if bytes > src.bytes {
            anyhow::bail!(
                "ds4rt_copy_h2d_async pinned source byte count {bytes} exceeds host buffer bytes {}",
                src.bytes
            );
        }
        let copy_fn: Symbol<CopyH2DAsyncFn> = unsafe { self.lib.get(b"ds4rt_copy_h2d_async")? };
        let status = unsafe { copy_fn(dst, src.ptr as *const c_void, bytes, cuda_stream) };
        self.status_to_result("ds4rt_copy_h2d_async", status)
    }

    pub unsafe fn copy_host_buffers_h2d_batch_async(
        &self,
        dsts: &[Ds4rtDeviceBuffer],
        srcs: &[Ds4rtHostBuffer],
        bytes: &[usize],
        cuda_stream: *mut c_void,
    ) -> Result<()> {
        let context = "ds4rt_copy_h2d_batch_async";
        if dsts.is_empty() {
            return Ok(());
        }
        ...
        let copy_fn: Symbol<CopyH2DBatchAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_copy_h2d_batch_async")? };
        let status = unsafe {
            copy_fn(
                dsts.as_ptr(),
                source_ptrs.as_ptr(),
    ...
    pub unsafe fn copy_host_buffer_h2d_2d_async(
        ...
        let context = "ds4rt_copy_h2d_2d_async";
        ...
        let copy_fn: Symbol<CopyH2D2DAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_copy_h2d_2d_async")? };
        let status = unsafe {
            copy_fn(
                dst,
                dst_pitch_bytes,
    ...
    pub fn copy_d2h(&self, dst: &mut [u8], src: Ds4rtDeviceBuffer) -> Result<()> {
        let copy_fn: Symbol<CopyD2HFn> = unsafe { self.lib.get(b"ds4rt_copy_d2h")? };
        let status = unsafe { copy_fn(dst.as_mut_ptr().cast(), src, dst.len()) };
        self.status_to_result("ds4rt_copy_d2h", status)
    }
    ...
    pub fn copy_d2d(
        ...
        if dst.ptr.is_null() {
            anyhow::bail!("ds4rt_copy_d2d destination device buffer is null");
        }
        if src.ptr.is_null() {
            anyhow::bail!("ds4rt_copy_d2d source device buffer is null");
        }
        if bytes > dst.bytes {
            anyhow::bail!(
                "ds4rt_copy_d2d byte count {bytes} exceeds destination device buffer bytes {}",
                dst.bytes
            );
        }
        if bytes > src.bytes {
            anyhow::bail!(
                "ds4rt_copy_d2d byte count {bytes} exceeds source device buffer bytes {}",
                src.bytes
            );
        }
        let copy_fn: Symbol<CopyD2DFn> = unsafe { self.lib.get(b"ds4rt_copy_d2d")? };
        let status = unsafe { copy_fn(dst, src, bytes) };
        self.status_to_result("ds4rt_copy_d2d", status)
    }
    ...
    pub unsafe fn copy_d2h_async(
        ...
        let copy_fn: Symbol<CopyD2HAsyncFn> = unsafe { self.lib.get(b"ds4rt_copy_d2h_async")? };
        let status = unsafe { copy_fn(dst.as_mut_ptr().cast(), src, dst.len(), cuda_stream) };
        self.status_to_result("ds4rt_copy_d2h_async", status)
    }
    ...
    pub unsafe fn copy_d2h_host_buffer_async(
        ...
        if dst.ptr.is_null() {
            anyhow::bail!("ds4rt_copy_d2h_async pinned destination host buffer is null");
        }
        if bytes > dst.bytes {
            anyhow::bail!(
                "ds4rt_copy_d2h_async pinned destination byte count {bytes} exceeds host buffer bytes {}",
                dst.bytes
            );
        }
        let copy_fn: Symbol<CopyD2HAsyncFn> = unsafe { self.lib.get(b"ds4rt_copy_d2h_async")? };
    ...
    pub unsafe fn copy_d2d_async(
        ...
        if dst.ptr.is_null() {
            anyhow::bail!("ds4rt_copy_d2d_async destination device buffer is null");
        }
        if src.ptr.is_null() {
            anyhow::bail!("ds4rt_copy_d2d_async source device buffer is null");
        }
        if bytes > dst.bytes {
            anyhow::bail!(
                "ds4rt_copy_d2d_async byte count {bytes} exceeds destination device buffer bytes {}",
                dst.bytes
            );
        }
        if bytes > src.bytes {
            anyhow::bail!(
                "ds4rt_copy_d2d_async byte count {bytes} exceeds source device buffer bytes {}",
                src.bytes
            );
        }
        let copy_fn: Symbol<CopyD2DAsyncFn> = unsafe { self.lib.get(b"ds4rt_copy_d2d_async")? };
        let status = unsafe { copy_fn(dst, src, bytes, cuda_stream) };
        self.status_to_result("ds4rt_copy_d2d_async", status)
    }
    ...
    pub unsafe fn copy_d2d_2d_async(
        ...
        let context = "ds4rt_copy_d2d_2d_async";
        if width_bytes == 0 || rows == 0 {
            return Ok(());
        }
        if dst_pitch_bytes < width_bytes || src_pitch_bytes < width_bytes {
        ...
        let copy_fn: Symbol<CopyD2D2DAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_copy_d2d_2d_async")? };
        let status = unsafe {
            copy_fn(
                dst,
                dst_pitch_bytes,
    ...
    pub fn cuda_rmsnorm_f32(
        ...
        validate_f32_rows("ds4rt_cuda_rmsnorm_f32", rows, hidden)?;
        let row_values = rows as usize * hidden as usize;
        validate_device_buffer_bytes("ds4rt_cuda_rmsnorm_f32 x", x, row_values * 4)?;
        validate_device_buffer_bytes("ds4rt_cuda_rmsnorm_f32 weight", weight, hidden as usize * 4)?;
        validate_device_buffer_bytes("ds4rt_cuda_rmsnorm_f32 out", out, row_values * 4)?;

        let kernel_fn: Symbol<CudaRmsNormF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_rmsnorm_f32")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_rmsnorm_f32", status)
    }
    ...
    pub unsafe fn cuda_rmsnorm_f32_async(
        ...
        validate_f32_rows("ds4rt_cuda_rmsnorm_f32_async", rows, hidden)?;
        let row_values = rows as usize * hidden as usize;
        validate_device_buffer_bytes("ds4rt_cuda_rmsnorm_f32_async x", x, row_values * 4)?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_rmsnorm_f32_async weight",
            weight,
            hidden as usize * 4,
        )?;
        validate_device_buffer_bytes("ds4rt_cuda_rmsnorm_f32_async out", out, row_values * 4)?;

        let kernel_fn: Symbol<CudaRmsNormF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_rmsnorm_f32_async")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<f32>() as *const f32,
                weight.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_rmsnorm_f32_async", status)
    }
    ...
    pub fn cuda_rmsnorm_bf16(
        ...
        validate_f32_rows("ds4rt_cuda_rmsnorm_bf16", rows, hidden)?;
        let row_values =
            checked_row_values("ds4rt_cuda_rmsnorm_bf16 x", rows as usize, hidden as usize)?;
        validate_u16_buffer_values("ds4rt_cuda_rmsnorm_bf16 x", x, row_values)?;
        validate_u16_buffer_values("ds4rt_cuda_rmsnorm_bf16 weight", weight, hidden as usize)?;
        validate_u16_buffer_values("ds4rt_cuda_rmsnorm_bf16 out", out, row_values)?;

        let kernel_fn: Symbol<CudaRmsNormBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_rmsnorm_bf16")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_rmsnorm_bf16", status)
    }
    ...
    pub unsafe fn cuda_rmsnorm_bf16_async(
        ...
        validate_f32_rows("ds4rt_cuda_rmsnorm_bf16_async", rows, hidden)?;
        let row_values = checked_row_values(
            "ds4rt_cuda_rmsnorm_bf16_async x",
            rows as usize,
            hidden as usize,
        )?;
        validate_u16_buffer_values("ds4rt_cuda_rmsnorm_bf16_async x", x, row_values)?;
        validate_u16_buffer_values(
            "ds4rt_cuda_rmsnorm_bf16_async weight",
            weight,
            hidden as usize,
        )?;
        validate_u16_buffer_values("ds4rt_cuda_rmsnorm_bf16_async out", out, row_values)?;

        let kernel_fn: Symbol<CudaRmsNormBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_rmsnorm_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<u16>() as *const u16,
                weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_rmsnorm_bf16_async", status)
    }
    ...
    pub unsafe fn cuda_ds4_flash_rmsnorm_bf16_async(
        ...
        validate_f32_rows("ds4rt_cuda_ds4_flash_rmsnorm_bf16_async", rows, hidden)?;
        let row_values = checked_row_values(
            "ds4rt_cuda_ds4_flash_rmsnorm_bf16_async x",
            rows as usize,
            hidden as usize,
        )?;
        validate_u16_buffer_values("ds4rt_cuda_ds4_flash_rmsnorm_bf16_async x", x, row_values)?;
        validate_u16_buffer_values(
            "ds4rt_cuda_ds4_flash_rmsnorm_bf16_async weight",
            weight,
            hidden as usize,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_ds4_flash_rmsnorm_bf16_async out",
            out,
            row_values,
        )?;

        let kernel_fn: Symbol<CudaDs4FlashRmsNormBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_ds4_flash_rmsnorm_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<u16>() as *const u16,
                weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_ds4_flash_rmsnorm_bf16_async", status)
    }
    ...
    pub unsafe fn cuda_ds4_rmsnorm_bf16_rne_async(
        ...
        validate_f32_rows("ds4rt_cuda_ds4_rmsnorm_bf16_rne_async", rows, hidden)?;
        let row_values = checked_row_values(
            "ds4rt_cuda_ds4_rmsnorm_bf16_rne_async x",
            rows as usize,
            hidden as usize,
        )?;
        validate_u16_buffer_values("ds4rt_cuda_ds4_rmsnorm_bf16_rne_async x", x, row_values)?;
        validate_u16_buffer_values(
            "ds4rt_cuda_ds4_rmsnorm_bf16_rne_async weight",
            weight,
            hidden as usize,
        )?;
        validate_u16_buffer_values("ds4rt_cuda_ds4_rmsnorm_bf16_rne_async out", out, row_values)?;

        let kernel_fn: Symbol<CudaDs4RmsNormBf16RneAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_ds4_rmsnorm_bf16_rne_async")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<u16>() as *const u16,
                weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_ds4_rmsnorm_bf16_rne_async", status)
    }
    ...
    pub fn cuda_layernorm_affine_f32_bf16(
        ...
        validate_f32_rows("ds4rt_cuda_layernorm_affine_f32_bf16", rows, hidden)?;
        let row_values = checked_row_values(
            "ds4rt_cuda_layernorm_affine_f32_bf16 x",
            rows as usize,
            hidden as usize,
        )?;
        validate_device_buffer_bytes(
        ...
        validate_u16_buffer_values(
            "ds4rt_cuda_layernorm_affine_f32_bf16 weight",
            weight,
            hidden as usize,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_layernorm_affine_f32_bf16 bias",
            bias,
            hidden as usize,
        )?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_layernorm_affine_f32_bf16 out",
            out,
            row_values * std::mem::size_of::<f32>(),
        )?;

        let kernel_fn: Symbol<CudaLayerNormAffineF32Bf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_layernorm_affine_f32_bf16")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<f32>() as *const f32,
                weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_layernorm_affine_f32_bf16", status)
    }
    ...
    pub unsafe fn cuda_layernorm_affine_f32_bf16_async(
        ...
        validate_f32_rows("ds4rt_cuda_layernorm_affine_f32_bf16_async", rows, hidden)?;
        let row_values = checked_row_values(
            "ds4rt_cuda_layernorm_affine_f32_bf16_async x",
            rows as usize,
            hidden as usize,
        )?;
        validate_device_buffer_bytes(
        ...
        validate_u16_buffer_values(
            "ds4rt_cuda_layernorm_affine_f32_bf16_async weight",
            weight,
            hidden as usize,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_layernorm_affine_f32_bf16_async bias",
            bias,
            hidden as usize,
        )?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_layernorm_affine_f32_bf16_async out",
            out,
            row_values * std::mem::size_of::<f32>(),
        )?;
        ...
        let kernel_fn: Symbol<CudaLayerNormAffineF32Bf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_layernorm_affine_f32_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_layernorm_affine_f32_bf16_async", status)
    }
    ...
    pub fn cuda_layernorm_affine_bf16(
        ...
        validate_f32_rows("ds4rt_cuda_layernorm_affine_bf16", rows, hidden)?;
        let row_values = checked_row_values(
            "ds4rt_cuda_layernorm_affine_bf16 x",
            rows as usize,
            hidden as usize,
        )?;
        validate_u16_buffer_values("ds4rt_cuda_layernorm_affine_bf16 x", x, row_values)?;
        validate_u16_buffer_values(
            "ds4rt_cuda_layernorm_affine_bf16 weight",
            weight,
            hidden as usize,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_layernorm_affine_bf16 bias",
            bias,
            hidden as usize,
        )?;
        validate_u16_buffer_values("ds4rt_cuda_layernorm_affine_bf16 out", out, row_values)?;

        let kernel_fn: Symbol<CudaLayerNormAffineBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_layernorm_affine_bf16")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<u16>() as *const u16,
                weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_layernorm_affine_bf16", status)
    }
    ...
    pub unsafe fn cuda_layernorm_affine_bf16_async(
        ...
        validate_f32_rows("ds4rt_cuda_layernorm_affine_bf16_async", rows, hidden)?;
        let row_values = checked_row_values(
            "ds4rt_cuda_layernorm_affine_bf16_async x",
            rows as usize,
            hidden as usize,
        )?;
        validate_u16_buffer_values("ds4rt_cuda_layernorm_affine_bf16_async x", x, row_values)?;
        validate_u16_buffer_values(
            "ds4rt_cuda_layernorm_affine_bf16_async weight",
            weight,
            hidden as usize,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_layernorm_affine_bf16_async bias",
            bias,
            hidden as usize,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_layernorm_affine_bf16_async out",
            out,
            row_values,
        )?;

        let kernel_fn: Symbol<CudaLayerNormAffineBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_layernorm_affine_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<u16>() as *const u16,
                weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_layernorm_affine_bf16_async", status)
    }
    ...
    pub fn cuda_silu_gated_mlp_f32(
        ...
        validate_positive_dim("ds4rt_cuda_silu_gated_mlp_f32 hidden", hidden)?;
        validate_positive_dim("ds4rt_cuda_silu_gated_mlp_f32 intermediate", intermediate)?;
        let hidden = hidden as usize;
        let intermediate = intermediate as usize;
        validate_device_buffer_bytes("ds4rt_cuda_silu_gated_mlp_f32 x", x, hidden * 4)?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_silu_gated_mlp_f32 gate_weight",
            gate_weight,
            intermediate * hidden * 4,
        )?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_silu_gated_mlp_f32 up_weight",
            up_weight,
            intermediate * hidden * 4,
        )?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_silu_gated_mlp_f32 down_weight",
            down_weight,
            hidden * intermediate * 4,
        )?;
        validate_device_buffer_bytes("ds4rt_cuda_silu_gated_mlp_f32 out", out, hidden * 4)?;

        let kernel_fn: Symbol<CudaSiluGatedMlpF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_silu_gated_mlp_f32")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_silu_gated_mlp_f32", status)
    }
    ...
    pub fn cuda_silu_gated_mlp_rows_f32(
        ...
        let kernel_fn: Symbol<CudaSiluGatedMlpRowsF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_silu_gated_mlp_rows_f32")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<f32>() as *const f32,
                gate_weight.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_silu_gated_mlp_rows_f32", status)
    }
    ...
    pub unsafe fn cuda_silu_gated_mlp_rows_f32_async(
        ...
        validate_mlp_rows_buffers(
            "ds4rt_cuda_silu_gated_mlp_rows_f32_async",
            x,
            gate_weight,
            up_weight,
            down_weight,
        ...
        let kernel_fn: Symbol<CudaSiluGatedMlpRowsF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_silu_gated_mlp_rows_f32_async")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<f32>() as *const f32,
                gate_weight.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_silu_gated_mlp_rows_f32_async", status)
    }
    ...
    pub fn cuda_silu_gated_mlp_rows_bf16(
        ...
        validate_mlp_rows_bf16_buffers(
            "ds4rt_cuda_silu_gated_mlp_rows_bf16",
            x,
            gate_weight,
            up_weight,
            down_weight,
        ...
        let kernel_fn: Symbol<CudaSiluGatedMlpRowsBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_silu_gated_mlp_rows_bf16")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_silu_gated_mlp_rows_bf16", status)
    }
    ...
    pub unsafe fn cuda_silu_gated_mlp_rows_bf16_async(
        ...
        validate_mlp_rows_bf16_buffers(
            "ds4rt_cuda_silu_gated_mlp_rows_bf16_async",
            x,
            gate_weight,
            up_weight,
            down_weight,
        ...
        let kernel_fn: Symbol<CudaSiluGatedMlpRowsBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_silu_gated_mlp_rows_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<u16>() as *const u16,
                gate_weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_silu_gated_mlp_rows_bf16_async", status)
    }

    pub unsafe fn cuda_silu_mul_bf16_async(
        &self,
        gate_up: Ds4rtDeviceBuffer,
        out: Ds4rtDeviceBuffer,
        rows: usize,
        intermediate: usize,
        cuda_stream: *mut c_void,
        ...
        let kernel_fn: Symbol<CudaSiluMulBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_silu_mul_bf16_async")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_silu_mul_bf16_async", status)
    }
    ...
    pub fn cuda_silu_gated_mlp_rows_bf16_down_stride(
        ...
        validate_mlp_rows_bf16_down_stride_buffers(
            "ds4rt_cuda_silu_gated_mlp_rows_bf16_down_stride",
            x,
            gate_weight,
            up_weight,
            down_weight,
        ...
        let kernel_fn: Symbol<CudaSiluGatedMlpRowsBf16DownStrideFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_silu_gated_mlp_rows_bf16_down_stride")?
        };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_silu_gated_mlp_rows_bf16_down_stride", status)
    }
    ...
    pub unsafe fn cuda_silu_gated_mlp_rows_bf16_down_stride_async(
        ...
        validate_mlp_rows_bf16_down_stride_buffers(
            "ds4rt_cuda_silu_gated_mlp_rows_bf16_down_stride_async",
            x,
            gate_weight,
            up_weight,
            down_weight,
        ...
        let kernel_fn: Symbol<CudaSiluGatedMlpRowsBf16DownStrideAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_silu_gated_mlp_rows_bf16_down_stride_async")?
        };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<u16>() as *const u16,
    ...
    pub fn cuda_silu_gated_mlp_rows_bf16_down_stride_staged(
        ...
        up_weight: Ds4rtDeviceBuffer,
        down_weight: Ds4rtDeviceBuffer,
        activation_workspace: Ds4rtDeviceBuffer,
        out: Ds4rtDeviceBuffer,
        rows: usize,
        hidden: usize,
        intermediate: usize,
        ...
        validate_mlp_rows_bf16_down_stride_staged_buffers(
            "ds4rt_cuda_silu_gated_mlp_rows_bf16_down_stride_staged",
            x,
            gate_weight,
            up_weight,
            down_weight,
        ...
        let kernel_fn: Symbol<CudaSiluGatedMlpRowsBf16DownStrideStagedFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_silu_gated_mlp_rows_bf16_down_stride_staged")?
        };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<u16>() as *const u16,
    ...
    pub unsafe fn cuda_silu_gated_mlp_rows_bf16_down_stride_staged_async(
        ...
        validate_mlp_rows_bf16_down_stride_staged_buffers(
            "ds4rt_cuda_silu_gated_mlp_rows_bf16_down_stride_staged_async",
            x,
            gate_weight,
            up_weight,
            down_weight,
        ...
        let kernel_fn: Symbol<CudaSiluGatedMlpRowsBf16DownStrideStagedAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_silu_gated_mlp_rows_bf16_down_stride_staged_async")?
        };
        let status = unsafe {
            kernel_fn(
                x.ptr.cast::<u16>() as *const u16,
    ...
    pub fn cuda_b12x_spark_aot_available(&self) -> Result<bool> {
        let available_fn: Symbol<CudaB12xSparkAotAvailableFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_b12x_spark_aot_available")? };
        let mut available = 0;
        let status = unsafe { available_fn(&mut available) };
        self.status_to_result("ds4rt_cuda_b12x_spark_aot_available", status)?;
        Ok(available != 0)
    }

    pub fn cuda_b12x_spark_aot_init(&self) -> Result<()> {
        let init_fn: Symbol<CudaB12xSparkAotInitFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_b12x_spark_aot_init")? };
        let status = unsafe { init_fn() };
        self.status_to_result("ds4rt_cuda_b12x_spark_aot_init", status)
    }

    pub fn cuda_ds4_flash_spark_aot_available(&self) -> Result<bool> {
        let available_fn: Symbol<CudaDs4FlashSparkAotAvailableFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_ds4_flash_spark_aot_available")? };
        let mut available = 0;
        let status = unsafe { available_fn(&mut available) };
        self.status_to_result("ds4rt_cuda_ds4_flash_spark_aot_available", status)?;
        Ok(available != 0)
    }

    pub fn cuda_ds4_flash_spark_aot_init(&self) -> Result<()> {
        let init_fn: Symbol<CudaDs4FlashSparkAotInitFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_ds4_flash_spark_aot_init")? };
        let status = unsafe { init_fn() };
        self.status_to_result("ds4rt_cuda_ds4_flash_spark_aot_init", status)
    }

    pub fn cuda_ds4_pro_spark_aot_available(&self) -> Result<bool> {
        let available_fn: Symbol<CudaDs4ProSparkAotAvailableFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_ds4_pro_spark_aot_available")? };
        let mut available = 0;
        let status = unsafe { available_fn(&mut available) };
        self.status_to_result("ds4rt_cuda_ds4_pro_spark_aot_available", status)?;
        Ok(available != 0)
    }

    pub fn cuda_ds4_pro_spark_aot_init(&self) -> Result<()> {
        let init_fn: Symbol<CudaDs4ProSparkAotInitFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_ds4_pro_spark_aot_init")? };
        let status = unsafe { init_fn() };
        self.status_to_result("ds4rt_cuda_ds4_pro_spark_aot_init", status)
    }
    ...
    pub unsafe fn cuda_ds4_flash_w4a16_pack_weight_async(
        ...
        let kernel_fn: Symbol<CudaDs4FlashW4a16PackWeightAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_w4a16_pack_weight_async")?
        };
        let status = unsafe {
            kernel_fn(
                source,
        ...
        self.status_to_result("ds4rt_cuda_ds4_flash_w4a16_pack_weight_async", status)
    }
    ...
    pub unsafe fn cuda_ds4_flash_w4a16_pack_weight_strided_async(
        ...
        let kernel_fn: Symbol<CudaDs4FlashW4a16PackWeightStridedAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_w4a16_pack_weight_strided_async")?
        };
        let status = unsafe {
            kernel_fn(
                source,
    ...
    pub unsafe fn cuda_ds4_flash_w4a16_pack_e8m0_scale_async(
        ...
        let kernel_fn: Symbol<CudaDs4FlashW4a16PackE8m0ScaleAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_w4a16_pack_e8m0_scale_async")?
        };
        let status = unsafe {
            kernel_fn(
                source,
        ...
        self.status_to_result("ds4rt_cuda_ds4_flash_w4a16_pack_e8m0_scale_async", status)
    }
    ...
    pub unsafe fn cuda_ds4_flash_w4a16_pack_e8m0_scale_strided_async(
        ...
        let kernel_fn: Symbol<CudaDs4FlashW4a16PackE8m0ScaleStridedAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_w4a16_pack_e8m0_scale_strided_async")?
        };
        let status = unsafe {
            kernel_fn(
                source,
    ...
    pub unsafe fn cuda_ds4_flash_fp8_pack_block_scale_mma_async(
        ...
        let kernel_fn: Symbol<CudaDs4FlashFp8PackBlockScaleMmaAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_fp8_pack_block_scale_mma_async")?
        };
    ...
    pub unsafe fn cuda_ds4_flash_shared_expert_fp8_bf16_async(
        &self,
        buffers: &Ds4rtDs4FlashSharedExpertFp8Buffers,
        rows: usize,
        cuda_stream: *mut c_void,
    ) -> Result<()> {
        let kernel_fn: Symbol<CudaDs4FlashSharedExpertFp8Bf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_shared_expert_fp8_bf16_async")?
        };
        let status = unsafe { kernel_fn(buffers, rows, cuda_stream) };
        self.status_to_result("ds4rt_cuda_ds4_flash_shared_expert_fp8_bf16_async", status)
    }
    ...
    pub unsafe fn cuda_ds4_pro_shared_expert_fp8_bf16_async(
        ...
        let kernel_fn: Symbol<CudaDs4ProSharedExpertFp8Bf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_pro_shared_expert_fp8_bf16_async")?
        };
        let status = unsafe { kernel_fn(buffers, rows, cuda_stream) };
        self.status_to_result("ds4rt_cuda_ds4_pro_shared_expert_fp8_bf16_async", status)
    }

    pub unsafe fn cuda_ds4_pro_shared_expert_fp8_prefill_bf16_async(
        &self,
        buffers: &Ds4rtDs4ProSharedExpertFp8PrefillBuffers,
        rows: usize,
        cuda_stream: *mut c_void,
    ) -> Result<()> {
        let kernel_fn: Symbol<CudaDs4ProSharedExpertFp8PrefillBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_pro_shared_expert_fp8_prefill_bf16_async")?
        };
        let status = unsafe { kernel_fn(buffers, rows, cuda_stream) };
        self.status_to_result(
    ...
    pub unsafe fn cuda_ds4_flash_spark_w4a16_decode_m1_bf16_async(
        &self,
        buffers: &Ds4rtDs4FlashSparkW4a16MoeBuffers,
        cuda_stream: *mut c_void,
    ) -> Result<()> {
        let kernel_fn: Symbol<CudaDs4FlashSparkW4a16DecodeM1Bf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_spark_w4a16_decode_m1_bf16_async")?
        };
        let status = unsafe { kernel_fn(buffers, cuda_stream) };
        self.status_to_result(
            "ds4rt_cuda_ds4_flash_spark_w4a16_decode_m1_bf16_async",
            status,
        )
    }
    ...
    pub unsafe fn cuda_ds4_flash_spark_w4a16_prefill_topk6_bf16_async(
        ...
        let kernel_fn: Symbol<CudaDs4FlashSparkW4a16PrefillTopk6Bf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_spark_w4a16_prefill_topk6_bf16_async")?
        };
        let status = unsafe { kernel_fn(buffers, rows, cuda_stream) };
        self.status_to_result(
    ...
    pub unsafe fn cuda_ds4_flash_spark_exl3_k2_decode_m1_async(
        &self,
        buffers: &Ds4rtDs4FlashSparkExl3K2MoeBuffers,
        cuda_stream: *mut c_void,
    ) -> Result<()> {
        let kernel_fn: Symbol<CudaDs4FlashSparkExl3K2DecodeM1AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_spark_exl3_k2_decode_m1_async")?
        };
        let status = unsafe { kernel_fn(buffers, cuda_stream) };
        self.status_to_result("ds4rt_cuda_ds4_flash_spark_exl3_k2_decode_m1_async", status)
    }
    ...
    pub unsafe fn cuda_ds4_flash_spark_exl3_k2_prefill_topk6_async(
        ...
        let kernel_fn: Symbol<CudaDs4FlashSparkExl3K2PrefillTopk6AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_spark_exl3_k2_prefill_topk6_async")?
        };
        let status = unsafe { kernel_fn(buffers, rows, cuda_stream) };
        self.status_to_result(
    ...
    pub unsafe fn cuda_ds4_flash_spark_exl3_k3_decode_m1_async(
        ...
        let kernel_fn: Symbol<CudaDs4FlashSparkExl3K3DecodeM1AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_spark_exl3_k3_decode_m1_async")?
        };
        let status = unsafe { kernel_fn(buffers, cuda_stream) };
        self.status_to_result("ds4rt_cuda_ds4_flash_spark_exl3_k3_decode_m1_async", status)
    }
    ...
    pub unsafe fn cuda_ds4_flash_spark_exl3_k3_prefill_topk6_async(
        ...
        let kernel_fn: Symbol<CudaDs4FlashSparkExl3K3PrefillTopk6AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_spark_exl3_k3_prefill_topk6_async")?
        };
        let status = unsafe { kernel_fn(buffers, rows, cuda_stream) };
        self.status_to_result(
    ...
    pub unsafe fn cuda_ds4_pro_spark_exl3_k2_decode_m1_async(
        &self,
        buffers: &Ds4rtDs4ProSparkExl3K2MoeBuffers,
        cuda_stream: *mut c_void,
    ) -> Result<()> {
        let kernel_fn: Symbol<CudaDs4ProSparkExl3K2DecodeM1AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_pro_spark_exl3_k2_decode_m1_async")?
        };
        let status = unsafe { kernel_fn(buffers, cuda_stream) };
        self.status_to_result("ds4rt_cuda_ds4_pro_spark_exl3_k2_decode_m1_async", status)
    }
    ...
    pub unsafe fn cuda_ds4_pro_spark_exl3_k2_prefill_topk6_async(
        ...
        let kernel_fn: Symbol<CudaDs4ProSparkExl3K2PrefillTopk6AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_pro_spark_exl3_k2_prefill_topk6_async")?
        };
        let status = unsafe { kernel_fn(buffers, rows, cuda_stream) };
        self.status_to_result(
            "ds4rt_cuda_ds4_pro_spark_exl3_k2_prefill_topk6_async",
            status,
        )
    }
    ...
    pub unsafe fn cuda_ds4_flash_pack_topk6_routes_async(
        &self,
        buffers: &Ds4rtDs4FlashRoutePackBuffers,
        rows: usize,
        cuda_stream: *mut c_void,
    ) -> Result<()> {
        let kernel_fn: Symbol<CudaDs4FlashPackTopk6RoutesAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_pack_topk6_routes_async")?
        };
        let status = unsafe { kernel_fn(buffers, rows, cuda_stream) };
        self.status_to_result("ds4rt_cuda_ds4_flash_pack_topk6_routes_async", status)
    }
    ...
    pub unsafe fn cuda_b12x_quantize_bf16_nvfp4_row_payload_async(
        ...
        let kernel_fn: Symbol<CudaB12xQuantizeBf16Nvfp4RowPayloadAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_quantize_bf16_nvfp4_row_payload_async")?
        };
        let status = unsafe { kernel_fn(input, payload, rows, hidden_dim, cuda_stream) };
        self.status_to_result(
            "ds4rt_cuda_b12x_quantize_bf16_nvfp4_row_payload_async",
            status,
        )
    }
    ...
    pub unsafe fn cuda_b12x_w4a16_pack_weight_async(
        ...
        let kernel_fn: Symbol<CudaB12xW4a16PackWeightAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_b12x_w4a16_pack_weight_async")? };
        let status = unsafe {
            kernel_fn(
                source,
                destination,
        ...
        self.status_to_result("ds4rt_cuda_b12x_w4a16_pack_weight_async", status)
    }
    ...
    pub unsafe fn cuda_b12x_w4a16_pack_weight_strided_async(
        ...
        let kernel_fn: Symbol<CudaB12xW4a16PackWeightStridedAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_w4a16_pack_weight_strided_async")?
        };
        let status = unsafe {
            kernel_fn(
                source,
        ...
        self.status_to_result("ds4rt_cuda_b12x_w4a16_pack_weight_strided_async", status)
    }
    ...
    pub unsafe fn cuda_b12x_w4a16_pack_scale_async(
        ...
        let kernel_fn: Symbol<CudaB12xW4a16PackScaleAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_b12x_w4a16_pack_scale_async")? };
        let status = unsafe {
            kernel_fn(
                source,
                destination,
        ...
        self.status_to_result("ds4rt_cuda_b12x_w4a16_pack_scale_async", status)
    }
    ...
    pub unsafe fn cuda_b12x_w4a16_pack_scale_strided_async(
        ...
        let kernel_fn: Symbol<CudaB12xW4a16PackScaleStridedAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_w4a16_pack_scale_strided_async")?
        };
        let status = unsafe {
            kernel_fn(
                source,
        ...
        self.status_to_result("ds4rt_cuda_b12x_w4a16_pack_scale_strided_async", status)
    }
    ...
    pub unsafe fn cuda_quantize_bf16_weight_nvfp4_async(
        ...
        let kernel_fn: Symbol<CudaQuantizeBf16WeightNvfp4AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_quantize_bf16_weight_nvfp4_async")?
        };
        let status =
            unsafe { kernel_fn(input, packed, scales, rows, cols, global_scale, cuda_stream) };
        self.status_to_result("ds4rt_cuda_quantize_bf16_weight_nvfp4_async", status)
    }
    ...
    pub unsafe fn cuda_b12x_gather_nvfp4_rows_bf16_async(
        ...
        let kernel_fn: Symbol<CudaB12xGatherNvfp4RowsBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_gather_nvfp4_rows_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                payload,
        ...
        self.status_to_result("ds4rt_cuda_b12x_gather_nvfp4_rows_bf16_async", status)
    }
    ...
    pub unsafe fn cuda_b12x_dequantize_nvfp4_rows_bf16_async(
        ...
        let kernel_fn: Symbol<CudaB12xDequantizeNvfp4RowsBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_dequantize_nvfp4_rows_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                payload,
        ...
        self.status_to_result("ds4rt_cuda_b12x_dequantize_nvfp4_rows_bf16_async", status)
    }

    pub unsafe fn cuda_b12x_spark_w4a16_decode_m1_nvfp4_async(
        &self,
        buffers: &Ds4rtB12xSparkW4a16MoeBuffers,
        input_payload: Ds4rtDeviceBuffer,
        input_payload_stride_bytes: usize,
        topk_ids: Ds4rtDeviceBuffer,
        cuda_stream: *mut c_void,
        ...
        let kernel_fn: Symbol<CudaB12xSparkW4a16DecodeM1Nvfp4AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_spark_w4a16_decode_m1_nvfp4_async")?
        };
        let status = unsafe {
            kernel_fn(
                buffers,
        ...
        self.status_to_result("ds4rt_cuda_b12x_spark_w4a16_decode_m1_nvfp4_async", status)
    }
    ...
    pub unsafe fn cuda_b12x_spark_w4a16_decode_m1_fused_sum_nvfp4_async(
        ...
        let kernel_fn: Symbol<CudaB12xSparkW4a16DecodeM1Nvfp4AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_spark_w4a16_decode_m1_fused_sum_nvfp4_async")?
        };
        let status = unsafe {
            kernel_fn(
                buffers,
    ...
    pub unsafe fn cuda_b12x_spark_w4a16_m1_parity_m2_8_nvfp4_async(
        ...
        let kernel_fn: Symbol<CudaB12xSparkW4a16M1ParityM2To8Nvfp4AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_spark_w4a16_m1_parity_m2_8_nvfp4_async")?
        };
        let status = unsafe {
            kernel_fn(
                buffers,
    ...
    pub unsafe fn cuda_b12x_spark_w4a16_m1_parity_grouped_m2_8_nvfp4_async(
        ...
        let kernel_fn: Symbol<CudaB12xSparkW4a16M1ParityGroupedM2To8Nvfp4AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_spark_w4a16_m1_parity_grouped_m2_8_nvfp4_async")?
        };
        let status = unsafe {
            kernel_fn(
                buffers,
    ...
    pub unsafe fn cuda_b12x_spark_w4a16_m1_parity_grouped_wide_m2_8_nvfp4_async(
        ...
        let kernel_fn: Symbol<CudaB12xSparkW4a16M1ParityGroupedM2To8Nvfp4AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_spark_w4a16_m1_parity_grouped_wide_m2_8_nvfp4_async")?
        };
        let status = unsafe {
            kernel_fn(
                buffers,
    ...
    pub unsafe fn cuda_b12x_spark_w4a16_prefill_topk8_nvfp4_async(
        ...
        let kernel_fn: Symbol<CudaB12xSparkW4a16PrefillTopk8Nvfp4AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_spark_w4a16_prefill_topk8_nvfp4_async")?
        };
        let status = unsafe {
            kernel_fn(
                buffers,
        ...
        self.status_to_result(
            "ds4rt_cuda_b12x_spark_w4a16_prefill_topk8_nvfp4_async",
            status,
        )
    }
    ...
    pub unsafe fn cuda_b12x_spark_w4a16_prefill_topk8_nvfp4_fp8_async(
        ...
        let kernel_fn: Symbol<CudaB12xSparkW4a16PrefillTopk8Nvfp4Fp8AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_spark_w4a16_prefill_topk8_nvfp4_fp8_async")?
        };
        let status = unsafe {
            kernel_fn(
                buffers,
    ...
    pub unsafe fn cuda_b12x_spark_w4a16_top1_async(
        ...
        let kernel_fn: Symbol<CudaB12xSparkW4a16Top1AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_b12x_spark_w4a16_top1_async")? };
        let status = unsafe { kernel_fn(buffers, rows, capacity_rows, expert_id, cuda_stream) };
        self.status_to_result("ds4rt_cuda_b12x_spark_w4a16_top1_async", status)
    }

    pub fn cuda_b12x_coordinator_aot_available(&self) -> Result<bool> {
        let available_fn: Symbol<CudaB12xCoordinatorAotAvailableFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_b12x_coordinator_aot_available")? };
        let mut available = 0;
        let status = unsafe { available_fn(&mut available) };
        self.status_to_result("ds4rt_cuda_b12x_coordinator_aot_available", status)?;
        Ok(available != 0)
    }

    pub fn cuda_b12x_coordinator_aot_init(&self) -> Result<()> {
        let init_fn: Symbol<CudaB12xCoordinatorAotInitFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_b12x_coordinator_aot_init")? };
        let status = unsafe { init_fn() };
        self.status_to_result("ds4rt_cuda_b12x_coordinator_aot_init", status)
    }
    ...
    pub unsafe fn cuda_b12x_coordinator_w4a16_quantize_pack_weight_async(
        ...
        let kernel_fn: Symbol<CudaB12xCoordinatorW4a16QuantizePackWeightAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_coordinator_w4a16_quantize_pack_weight_async")?
        };
        let status = unsafe {
            kernel_fn(
                input_bf16,
    ...
    pub unsafe fn cuda_b12x_coordinator_w4a16_initialize_launch_buffers_async(
        &self,
        buffers: &Ds4rtB12xCoordinatorW4a16Buffers,
        cuda_stream: *mut c_void,
    ) -> Result<()> {
        let kernel_fn: Symbol<CudaB12xCoordinatorW4a16BuffersAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_coordinator_w4a16_initialize_launch_buffers_async")?
        };
        let status = unsafe { kernel_fn(buffers, cuda_stream) };
        self.status_to_result(
    ...
    pub unsafe fn cuda_b12x_coordinator_w4a16_q_b_m1_async(
        ...
        let kernel_fn: Symbol<CudaB12xCoordinatorW4a16BuffersAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_coordinator_w4a16_q_b_m1_async")?
        };
        let status = unsafe { kernel_fn(buffers, cuda_stream) };
        self.status_to_result("ds4rt_cuda_b12x_coordinator_w4a16_q_b_m1_async", status)
    }
    ...
    pub unsafe fn cuda_b12x_coordinator_w4a16_q_b_m8_async(
        ...
        let kernel_fn: Symbol<CudaB12xCoordinatorW4a16BuffersRowsAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_coordinator_w4a16_q_b_m8_async")?
        };
        let status = unsafe { kernel_fn(buffers, active_rows, cuda_stream) };
        self.status_to_result("ds4rt_cuda_b12x_coordinator_w4a16_q_b_m8_async", status)
    }
    ...
    pub unsafe fn cuda_b12x_coordinator_w4a16_o_proj_m1_async(
        ...
        let kernel_fn: Symbol<CudaB12xCoordinatorW4a16BuffersAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_coordinator_w4a16_o_proj_m1_async")?
        };
        let status = unsafe { kernel_fn(buffers, cuda_stream) };
        self.status_to_result("ds4rt_cuda_b12x_coordinator_w4a16_o_proj_m1_async", status)
    }
    ...
    pub unsafe fn cuda_b12x_coordinator_w4a16_o_proj_m1_tn64_async(
        ...
        let kernel_fn: Symbol<CudaB12xCoordinatorW4a16BuffersAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_b12x_coordinator_w4a16_o_proj_m1_tn64_candidate_async")?
        };
        let status = unsafe { kernel_fn(buffers, cuda_stream) };
        self.status_to_result(
    ...
    pub fn cuda_nvfp4_silu_gated_mlp_route_bf16_grouped_staged_accumulate_f32(
        ...
        hidden: Ds4rtDeviceBuffer,
        row_indices: Ds4rtDeviceBuffer,
        route_weights: Ds4rtDeviceBuffer,
        gate_weight: Ds4rtDeviceBuffer,
        gate_scale: Ds4rtDeviceBuffer,
        up_weight: Ds4rtDeviceBuffer,
        up_scale: Ds4rtDeviceBuffer,
        down_weight: Ds4rtDeviceBuffer,
        down_scale: Ds4rtDeviceBuffer,
        activation_workspace: Ds4rtDeviceBuffer,
        ...
        let kernel_fn: Symbol<CudaNvfp4SiluGatedMlpRouteBf16GroupedStagedAccumulateF32Fn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_nvfp4_silu_gated_mlp_route_bf16_grouped_staged_accumulate_f32")?
        };
        let status = unsafe {
            kernel_fn(
    ...
    pub unsafe fn cuda_nvfp4_silu_gated_mlp_route_bf16_grouped_staged_accumulate_f32_async(
        ...
        let kernel_fn: Symbol<CudaNvfp4SiluGatedMlpRouteBf16GroupedStagedAccumulateF32AsyncFn> = unsafe {
            self.lib.get(
                b"ds4rt_cuda_nvfp4_silu_gated_mlp_route_bf16_grouped_staged_accumulate_f32_async",
            )?
        };
        let status = unsafe {
            kernel_fn(
    ...
    pub fn cuda_nvfp4_silu_gated_mlp_route_bf16_batched_staged_accumulate_f32(
        ...
        row_indices: Ds4rtDeviceBuffer,
        route_weights: Ds4rtDeviceBuffer,
        route_metadata: Ds4rtDeviceBuffer,
        activation_workspace: Ds4rtDeviceBuffer,
        accumulator: Ds4rtDeviceBuffer,
        rows: usize,
        routes: usize,
        ...
        let kernel_fn: Symbol<CudaNvfp4SiluGatedMlpRouteBf16BatchedStagedAccumulateF32Fn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_nvfp4_silu_gated_mlp_route_bf16_batched_staged_accumulate_f32")?
        };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
                row_indices.ptr.cast::<u32>() as *const u32,
                route_weights.ptr.cast::<f32>() as *const f32,
                route_metadata.ptr.cast::<Ds4rtNvfp4RouteBatchedMetadata>()
                    as *const Ds4rtNvfp4RouteBatchedMetadata,
                activation_workspace.ptr.cast::<f32>(),
                accumulator.ptr.cast::<f32>(),
                rows,
                routes,
    ...
    pub unsafe fn cuda_nvfp4_silu_gated_mlp_route_bf16_batched_staged_accumulate_f32_async(
        ...
        let kernel_fn: Symbol<CudaNvfp4SiluGatedMlpRouteBf16BatchedStagedAccumulateF32AsyncFn> = unsafe {
            self.lib.get(
                b"ds4rt_cuda_nvfp4_silu_gated_mlp_route_bf16_batched_staged_accumulate_f32_async",
            )?
        };
        let status = unsafe {
            kernel_fn(
    ...
    pub fn cuda_nvfp4_silu_gated_mlp_route_bf16_batched_staged_single_row_bf16(
        ...
        let kernel_fn: Symbol<CudaNvfp4SiluGatedMlpRouteBf16BatchedStagedSingleRowBf16Fn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_nvfp4_silu_gated_mlp_route_bf16_batched_staged_single_row_bf16")?
        };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
    ...
    pub unsafe fn cuda_nvfp4_silu_gated_mlp_route_bf16_batched_staged_single_row_bf16_async(
        ...
        let kernel_fn: Symbol<CudaNvfp4SiluGatedMlpRouteBf16BatchedStagedSingleRowBf16AsyncFn> = unsafe {
            self.lib.get(
                b"ds4rt_cuda_nvfp4_silu_gated_mlp_route_bf16_batched_staged_single_row_bf16_async",
            )?
        };
        let status = unsafe {
            kernel_fn(
    ...
    pub fn cuda_residual_add_f32(
        ...
        validate_f32_buffer_values("ds4rt_cuda_residual_add_f32 residual", residual, count)?;
        validate_f32_buffer_values("ds4rt_cuda_residual_add_f32 delta", delta, count)?;
        validate_f32_buffer_values("ds4rt_cuda_residual_add_f32 out", out, count)?;

        let kernel_fn: Symbol<CudaResidualAddF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_residual_add_f32")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_residual_add_f32", status)
    }
    ...
    pub unsafe fn cuda_residual_add_f32_async(
        ...
        validate_f32_buffer_values(
            "ds4rt_cuda_residual_add_f32_async residual",
            residual,
            count,
        )?;
        validate_f32_buffer_values("ds4rt_cuda_residual_add_f32_async delta", delta, count)?;
        validate_f32_buffer_values("ds4rt_cuda_residual_add_f32_async out", out, count)?;

        let kernel_fn: Symbol<CudaResidualAddF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_residual_add_f32_async")? };
        let status = unsafe {
            kernel_fn(
                residual.ptr.cast::<f32>() as *const f32,
                delta.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_residual_add_f32_async", status)
    }
    ...
    pub fn cuda_residual_add_bf16(
        ...
        validate_u16_buffer_values("ds4rt_cuda_residual_add_bf16 residual", residual, count)?;
        validate_u16_buffer_values("ds4rt_cuda_residual_add_bf16 delta", delta, count)?;
        validate_u16_buffer_values("ds4rt_cuda_residual_add_bf16 out", out, count)?;

        let kernel_fn: Symbol<CudaResidualAddBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_residual_add_bf16")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_residual_add_bf16", status)
    }
    ...
    pub unsafe fn cuda_residual_add_bf16_async(
        ...
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_bf16_async residual",
            residual,
            count,
        )?;
        validate_u16_buffer_values("ds4rt_cuda_residual_add_bf16_async delta", delta, count)?;
        validate_u16_buffer_values("ds4rt_cuda_residual_add_bf16_async out", out, count)?;

        let kernel_fn: Symbol<CudaResidualAddBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_residual_add_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                residual.ptr.cast::<u16>() as *const u16,
                delta.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_residual_add_bf16_async", status)
    }
    ...
    pub fn cuda_residual_add_f32_delta_bf16(
        ...
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_f32_delta_bf16 residual",
            residual,
            count,
        )?;
        validate_f32_buffer_values(
            "ds4rt_cuda_residual_add_f32_delta_bf16 delta_f32",
            delta_f32,
            count,
        )?;
        validate_u16_buffer_values("ds4rt_cuda_residual_add_f32_delta_bf16 out", out, count)?;

        let kernel_fn: Symbol<CudaResidualAddF32DeltaBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_residual_add_f32_delta_bf16")? };
        let status = unsafe {
            kernel_fn(
                residual.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_residual_add_f32_delta_bf16", status)
    }
    ...
    pub unsafe fn cuda_residual_add_f32_delta_bf16_async(
        ...
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_f32_delta_bf16_async residual",
            residual,
            count,
        )?;
        validate_f32_buffer_values(
            "ds4rt_cuda_residual_add_f32_delta_bf16_async delta_f32",
            delta_f32,
            count,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_f32_delta_bf16_async out",
            out,
            count,
        )?;
        ...
        let kernel_fn: Symbol<CudaResidualAddF32DeltaBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_residual_add_f32_delta_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                residual.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_residual_add_f32_delta_bf16_async", status)
    }
    ...
    pub fn cuda_residual_add_shared_f32_delta_bf16(
        ...
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_shared_f32_delta_bf16 residual",
            residual,
            count,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_shared_f32_delta_bf16 shared_delta",
            shared_delta,
            count,
        )?;
        validate_f32_buffer_values(
            "ds4rt_cuda_residual_add_shared_f32_delta_bf16 routed_delta_f32",
            routed_delta_f32,
            count,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_shared_f32_delta_bf16 out",
            out,
            count,
        )?;
        ...
        let kernel_fn: Symbol<CudaResidualAddSharedF32DeltaBf16Fn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_residual_add_shared_f32_delta_bf16")?
        };
        let status = unsafe {
            kernel_fn(
                residual.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_residual_add_shared_f32_delta_bf16", status)
    }
    ...
    pub unsafe fn cuda_residual_add_shared_f32_delta_bf16_async(
        ...
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_shared_f32_delta_bf16_async residual",
            residual,
            count,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_shared_f32_delta_bf16_async shared_delta",
            shared_delta,
            count,
        )?;
        validate_f32_buffer_values(
            "ds4rt_cuda_residual_add_shared_f32_delta_bf16_async routed_delta_f32",
            routed_delta_f32,
            count,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_shared_f32_delta_bf16_async out",
            out,
            count,
        )?;
        ...
        let kernel_fn: Symbol<CudaResidualAddSharedF32DeltaBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_residual_add_shared_f32_delta_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                residual.ptr.cast::<u16>() as *const u16,
    ...
    pub unsafe fn cuda_residual_add_shared_fp8_e4m3_row_scaled_bf16_async(
        ...
        residual: Ds4rtDeviceBuffer,
        shared_delta: Ds4rtDeviceBuffer,
        routed_delta_fp8: Ds4rtDeviceBuffer,
        out: Ds4rtDeviceBuffer,
        count: usize,
        cuda_stream: *mut c_void,
    ) -> Result<()> {
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_shared_fp8_e4m3_row_scaled_bf16_async residual",
            residual,
            count,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_shared_fp8_e4m3_row_scaled_bf16_async shared_delta",
            shared_delta,
            count,
        )?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_residual_add_shared_fp8_e4m3_row_scaled_bf16_async routed_delta_fp8",
            routed_delta_fp8,
            count
                .checked_add(std::mem::size_of::<f32>())
                .context(
                    "ds4rt_cuda_residual_add_shared_fp8_e4m3_row_scaled_bf16_async routed row byte count overflows usize",
                )?,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_residual_add_shared_fp8_e4m3_row_scaled_bf16_async out",
            out,
            count,
        )?;
        ...
        let kernel_fn: Symbol<CudaResidualAddSharedFp8E4m3RowScaledBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_residual_add_shared_fp8_e4m3_row_scaled_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                residual.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result(
            "ds4rt_cuda_residual_add_shared_fp8_e4m3_row_scaled_bf16_async",
            status,
        )
    }
    ...
    pub unsafe fn cuda_fp8_decode_combine_residual_async(
        ...
        anyhow::ensure!(
            ...
            "ds4rt_cuda_fp8_decode_combine_residual_async partial rows {partial_rows} are outside 1..=4"
        );
        let minimum_row_stride = row_width
            .checked_add(std::mem::size_of::<f32>())
            .context("ds4rt_cuda_fp8_decode_combine_residual_async row stride overflows usize")?;
        anyhow::ensure!(
            partial_row_stride_bytes >= minimum_row_stride,
            "ds4rt_cuda_fp8_decode_combine_residual_async row stride {partial_row_stride_bytes} is smaller than {minimum_row_stride}"
        );
        validate_u16_buffer_values(
            "ds4rt_cuda_fp8_decode_combine_residual_async residual",
            residual,
            row_width,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_fp8_decode_combine_residual_async shared_delta",
            shared_delta,
            row_width,
        )?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_fp8_decode_combine_residual_async partials",
            partials,
            partial_rows.checked_mul(partial_row_stride_bytes).context(
                "ds4rt_cuda_fp8_decode_combine_residual_async partial bytes overflow usize",
            )?,
        )?;
        validate_u16_buffer_values(
            "ds4rt_cuda_fp8_decode_combine_residual_async output",
            output,
            row_width,
        )?;
        ...
        let kernel_fn: Symbol<CudaFp8DecodeCombineResidualAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_fp8_decode_combine_residual_async")?
        };
        let status = unsafe {
            kernel_fn(
                residual.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_fp8_decode_combine_residual_async", status)
    }
    ...
    pub fn cuda_scheduler_mlp_delta_bf16(
        ...
        validate_scheduler_mlp_delta_bf16_buffers(
            "ds4rt_cuda_scheduler_mlp_delta_bf16",
            hidden,
            gate_weight,
            up_weight,
            down_weight,
        ...
        let kernel_fn: Symbol<CudaSchedulerMlpDeltaBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_scheduler_mlp_delta_bf16")? };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
                gate_weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_scheduler_mlp_delta_bf16", status)
    }
    ...
    pub fn cuda_summarize_bf16(
        ...
        input: Ds4rtDeviceBuffer,
        count: usize,
    ) -> Result<Ds4rtBf16Summary> {
        validate_u16_buffer_values("ds4rt_cuda_summarize_bf16 input", input, count)?;

        let kernel_fn: Symbol<CudaSummarizeBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_summarize_bf16")? };
        let mut summary = Ds4rtBf16Summary::default();
        let status =
            unsafe { kernel_fn(input.ptr.cast::<u16>() as *const u16, count, &mut summary) };
        self.status_to_result("ds4rt_cuda_summarize_bf16", status)?;
        Ok(summary)
    }
    ...
    pub unsafe fn cuda_summarize_bf16_async(
        ...
        input: Ds4rtDeviceBuffer,
        count: usize,
        out_device: Ds4rtDeviceBuffer,
        cuda_stream: *mut c_void,
    ) -> Result<()> {
        validate_u16_buffer_values("ds4rt_cuda_summarize_bf16_async input", input, count)?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_summarize_bf16_async out_device",
            out_device,
            std::mem::size_of::<Ds4rtBf16Summary>(),
        )?;

        let kernel_fn: Symbol<CudaSummarizeBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_summarize_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
                count,
                out_device.ptr.cast::<Ds4rtBf16Summary>(),
                cuda_stream,
            )
        };
        self.status_to_result("ds4rt_cuda_summarize_bf16_async", status)
    }

    pub fn cuda_zero_f32(&self, dst: Ds4rtDeviceBuffer, count: usize) -> Result<()> {
        validate_f32_buffer_values("ds4rt_cuda_zero_f32 dst", dst, count)?;

        let kernel_fn: Symbol<CudaZeroF32Fn> = unsafe { self.lib.get(b"ds4rt_cuda_zero_f32")? };
        let status = unsafe { kernel_fn(dst.ptr.cast::<f32>(), count) };
        self.status_to_result("ds4rt_cuda_zero_f32", status)
    }
    ...
    pub unsafe fn cuda_zero_f32_async(
        ...
        validate_f32_buffer_values("ds4rt_cuda_zero_f32_async dst", dst, count)?;

        let kernel_fn: Symbol<CudaZeroF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_zero_f32_async")? };
        let status = unsafe { kernel_fn(dst.ptr.cast::<f32>(), count, cuda_stream) };
        self.status_to_result("ds4rt_cuda_zero_f32_async", status)
    }
    ...
    pub fn cuda_accumulate_bf16_to_f32(
        ...
        validate_bf16_to_f32_accumulation_buffers(
            "ds4rt_cuda_accumulate_bf16_to_f32",
            src,
            dst,
            count,
        )?;
        let kernel_fn: Symbol<CudaAccumulateBf16ToF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_accumulate_bf16_to_f32")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_accumulate_bf16_to_f32", status)
    }
    ...
    pub unsafe fn cuda_accumulate_bf16_to_f32_async(
        ...
        validate_bf16_to_f32_accumulation_buffers(
            "ds4rt_cuda_accumulate_bf16_to_f32_async",
            src,
            dst,
            count,
        )?;
        let kernel_fn: Symbol<CudaAccumulateBf16ToF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_accumulate_bf16_to_f32_async")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u16>() as *const u16,
                dst.ptr.cast::<f32>(),
        ...
        self.status_to_result("ds4rt_cuda_accumulate_bf16_to_f32_async", status)
    }

    pub fn cuda_zero_bytes(&self, dst: Ds4rtDeviceBuffer, bytes: usize) -> Result<()> {
        validate_device_buffer_bytes("ds4rt_cuda_zero_bytes dst", dst, bytes)?;

        let kernel_fn: Symbol<CudaZeroBytesFn> = unsafe { self.lib.get(b"ds4rt_cuda_zero_bytes")? };
        let status = unsafe { kernel_fn(dst.ptr, bytes) };
        self.status_to_result("ds4rt_cuda_zero_bytes", status)
    }
    ...
    pub unsafe fn cuda_zero_bytes_async(
        ...
        validate_device_buffer_bytes("ds4rt_cuda_zero_bytes_async dst", dst, bytes)?;

        let kernel_fn: Symbol<CudaZeroBytesAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_zero_bytes_async")? };
        let status = unsafe { kernel_fn(dst.ptr, bytes, cuda_stream) };
        self.status_to_result("ds4rt_cuda_zero_bytes_async", status)
    }
    ...
    pub fn cuda_f32_to_bf16(
        ...
        validate_f32_to_bf16_buffers("ds4rt_cuda_f32_to_bf16", src, dst, count)?;

        let kernel_fn: Symbol<CudaF32ToBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_f32_to_bf16")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_f32_to_bf16", status)
    }
    ...
    pub unsafe fn cuda_f32_to_bf16_async(
        ...
        validate_f32_to_bf16_buffers("ds4rt_cuda_f32_to_bf16_async", src, dst, count)?;

        let kernel_fn: Symbol<CudaF32ToBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_f32_to_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<f32>() as *const f32,
                dst.ptr.cast::<u16>(),
        ...
        self.status_to_result("ds4rt_cuda_f32_to_bf16_async", status)
    }
    ...
    pub fn cuda_gather_rows_f32(
        ...
        let kernel_fn: Symbol<CudaGatherRowsF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_gather_rows_f32")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<f32>() as *const f32,
                row_indices.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_gather_rows_f32", status)
    }
    ...
    pub unsafe fn cuda_gather_rows_f32_async(
        ...
        validate_row_gather_buffers(
            "ds4rt_cuda_gather_rows_f32_async",
            src,
            src_rows,
            row_indices,
            dst,
        ...
        let kernel_fn: Symbol<CudaGatherRowsF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_gather_rows_f32_async")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<f32>() as *const f32,
                row_indices.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_gather_rows_f32_async", status)
    }
    ...
    pub fn cuda_gather_rows_f32_to_fp8_e4m3_row_scaled(
        ...
        validate_row_gather_f32_to_fp8_e4m3_row_scaled_buffers(
            "ds4rt_cuda_gather_rows_f32_to_fp8_e4m3_row_scaled",
            src,
            src_rows,
            row_indices,
            dst,
        ...
        let kernel_fn: Symbol<CudaGatherRowsF32ToFp8E4m3RowScaledFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_gather_rows_f32_to_fp8_e4m3_row_scaled")?
        };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_gather_rows_f32_to_fp8_e4m3_row_scaled", status)
    }
    ...
    pub unsafe fn cuda_gather_rows_f32_to_fp8_e4m3_row_scaled_async(
        ...
        let kernel_fn: Symbol<CudaGatherRowsF32ToFp8E4m3RowScaledAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_gather_rows_f32_to_fp8_e4m3_row_scaled_async")?
        };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<f32>() as *const f32,
    ...
    pub unsafe fn cuda_bf16_rows_to_fp8_e4m3_row_scaled_async(
        ...
        validate_bf16_rows_to_fp8_e4m3_row_scaled_buffers(
            "ds4rt_cuda_bf16_rows_to_fp8_e4m3_row_scaled_async",
            src,
            dst,
            rows,
            row_width,
        ...
        let kernel_fn: Symbol<CudaBf16RowsToFp8E4m3RowScaledAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_bf16_rows_to_fp8_e4m3_row_scaled_async")?
        };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_bf16_rows_to_fp8_e4m3_row_scaled_async", status)
    }

    #[allow(clippy::too_many_arguments)]
    pub unsafe fn cuda_combine_fp8_e4m3_row_scaled_to_fp8_async(
        &self,
        local: Ds4rtDeviceBuffer,
        peers: Ds4rtDeviceBuffer,
        peer_payload_stride_bytes: usize,
        peer_count: usize,
        peer_row_stride_bytes: usize,
        dst: Ds4rtDeviceBuffer,
        ...
        validate_combine_fp8_e4m3_row_scaled_buffers(
            "ds4rt_cuda_combine_fp8_e4m3_row_scaled_to_fp8_async",
            local,
            peers,
        ...
        let kernel_fn: Symbol<CudaCombineFp8E4m3RowScaledToFp8AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_combine_fp8_e4m3_row_scaled_to_fp8_async")?
        };
        let status = unsafe {
            kernel_fn(
    ...
    pub unsafe fn cuda_combine_bf16_fp8_e4m3_row_scaled_to_fp8_async(
        ...
        validate_combine_bf16_fp8_e4m3_row_scaled_buffers(
            "ds4rt_cuda_combine_bf16_fp8_e4m3_row_scaled_to_fp8_async",
            local,
            peers,
            peer_payload_stride_bytes,
            peer_count,
        ...
        let kernel_fn: Symbol<CudaCombineBf16Fp8E4m3RowScaledToFp8AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_combine_bf16_fp8_e4m3_row_scaled_to_fp8_async")?
        };
        let status = unsafe {
            kernel_fn(
    ...
    pub fn cuda_gather_rows_f32_to_nvfp4_e2m1_fp8_e4m3(
        ...
        validate_row_gather_f32_to_nvfp4_e2m1_fp8_e4m3_buffers(
            "ds4rt_cuda_gather_rows_f32_to_nvfp4_e2m1_fp8_e4m3",
            src,
            src_rows,
            row_indices,
            dst,
        ...
        let kernel_fn: Symbol<CudaGatherRowsF32ToNvfp4E2m1Fp8E4m3Fn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_gather_rows_f32_to_nvfp4_e2m1_fp8_e4m3")?
        };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_gather_rows_f32_to_nvfp4_e2m1_fp8_e4m3", status)
    }
    ...
    pub unsafe fn cuda_gather_rows_f32_to_nvfp4_e2m1_fp8_e4m3_async(
        ...
        validate_row_gather_f32_to_nvfp4_e2m1_fp8_e4m3_buffers(
            "ds4rt_cuda_gather_rows_f32_to_nvfp4_e2m1_fp8_e4m3_async",
            src,
            src_rows,
            row_indices,
            dst,
        ...
        let kernel_fn: Symbol<CudaGatherRowsF32ToNvfp4E2m1Fp8E4m3AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_gather_rows_f32_to_nvfp4_e2m1_fp8_e4m3_async")?
        };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<f32>() as *const f32,
    ...
    pub fn cuda_gather_rows_bf16(
        ...
        let kernel_fn: Symbol<CudaGatherRowsBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_gather_rows_bf16")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u16>() as *const u16,
                row_indices.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_gather_rows_bf16", status)
    }
    ...
    pub unsafe fn cuda_gather_rows_bf16_async(
        ...
        validate_row_gather_bf16_buffers(
            "ds4rt_cuda_gather_rows_bf16_async",
            src,
            src_rows,
            row_indices,
            dst,
        ...
        let kernel_fn: Symbol<CudaGatherRowsBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_gather_rows_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u16>() as *const u16,
                row_indices.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_gather_rows_bf16_async", status)
    }
    ...
    pub fn cuda_copy_row_prefix_bf16(
        ...
        validate_row_prefix_copy_bf16_buffers(
            "ds4rt_cuda_copy_row_prefix_bf16",
            src,
            src_rows,
            dst,
            rows,
        ...
        let kernel_fn: Symbol<CudaCopyRowPrefixBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_copy_row_prefix_bf16")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u16>() as *const u16,
                dst.ptr.cast::<u16>(),
        ...
        self.status_to_result("ds4rt_cuda_copy_row_prefix_bf16", status)
    }
    ...
    pub unsafe fn cuda_copy_row_prefix_bf16_async(
        ...
        validate_row_prefix_copy_bf16_buffers(
            "ds4rt_cuda_copy_row_prefix_bf16_async",
            src,
            src_rows,
            dst,
            rows,
        ...
        let kernel_fn: Symbol<CudaCopyRowPrefixBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_copy_row_prefix_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u16>() as *const u16,
                dst.ptr.cast::<u16>(),
        ...
        self.status_to_result("ds4rt_cuda_copy_row_prefix_bf16_async", status)
    }
    ...
    pub fn cuda_scatter_add_rows_f32(
        ...
        let kernel_fn: Symbol<CudaScatterAddRowsF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_scatter_add_rows_f32")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<f32>() as *const f32,
                row_indices.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_scatter_add_rows_f32", status)
    }
    ...
    pub unsafe fn cuda_scatter_add_rows_f32_async(
        ...
        validate_row_scatter_buffers(
            "ds4rt_cuda_scatter_add_rows_f32_async",
            src,
            row_indices,
            dst,
            dst_rows,
        ...
        let kernel_fn: Symbol<CudaScatterAddRowsF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_scatter_add_rows_f32_async")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<f32>() as *const f32,
                row_indices.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_scatter_add_rows_f32_async", status)
    }
    ...
    pub fn cuda_scatter_add_rows_bf16_to_f32(
        ...
        let kernel_fn: Symbol<CudaScatterAddRowsBf16ToF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_scatter_add_rows_bf16_to_f32")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u16>() as *const u16,
                row_indices.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_scatter_add_rows_bf16_to_f32", status)
    }
    ...
    pub unsafe fn cuda_scatter_add_rows_bf16_to_f32_async(
        ...
        let kernel_fn: Symbol<CudaScatterAddRowsBf16ToF32AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_scatter_add_rows_bf16_to_f32_async")?
        };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_scatter_add_rows_bf16_to_f32_async", status)
    }
    ...
    pub fn cuda_scatter_add_rows_fp8_e4m3_row_scaled_to_f32(
        ...
        validate_row_scatter_fp8_e4m3_row_scaled_to_f32_buffers(
            "ds4rt_cuda_scatter_add_rows_fp8_e4m3_row_scaled_to_f32",
            src,
        ...
        let kernel_fn: Symbol<CudaScatterAddRowsFp8E4m3RowScaledToF32Fn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_scatter_add_rows_fp8_e4m3_row_scaled_to_f32")?
        };
        let status = unsafe {
            kernel_fn(
    ...
    pub unsafe fn cuda_scatter_add_rows_fp8_e4m3_row_scaled_to_f32_async(
        ...
        let kernel_fn: Symbol<CudaScatterAddRowsFp8E4m3RowScaledToF32AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_scatter_add_rows_fp8_e4m3_row_scaled_to_f32_async")?
        };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u8>() as *const u8,
    ...
    pub fn cuda_scatter_add_rows_nvfp4_e2m1_fp8_e4m3_to_f32(
        ...
        validate_row_scatter_nvfp4_e2m1_fp8_e4m3_to_f32_buffers(
            "ds4rt_cuda_scatter_add_rows_nvfp4_e2m1_fp8_e4m3_to_f32",
            src,
            src_row_stride_bytes,
            row_indices,
            dst,
        ...
        let kernel_fn: Symbol<CudaScatterAddRowsNvfp4E2m1Fp8E4m3ToF32Fn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_scatter_add_rows_nvfp4_e2m1_fp8_e4m3_to_f32")?
        };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u8>() as *const u8,
    ...
    pub unsafe fn cuda_scatter_add_rows_nvfp4_e2m1_fp8_e4m3_to_f32_async(
        ...
        let kernel_fn: Symbol<CudaScatterAddRowsNvfp4E2m1Fp8E4m3ToF32AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_scatter_add_rows_nvfp4_e2m1_fp8_e4m3_to_f32_async")?
        };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u8>() as *const u8,
    ...
    pub fn cuda_reduce_route_shards_to_f32(
        &self,
        buffers: &Ds4rtRouteShardReductionBuffers,
        rows: usize,
        row_width: usize,
        peer_row_stride_bytes: usize,
        local_dtype: u32,
        ...
        validate_route_shard_reduction_buffers(
            "ds4rt_cuda_reduce_route_shards_to_f32",
            buffers,
            rows,
            row_width,
            peer_row_stride_bytes,
        ...
        let kernel_fn: Symbol<CudaReduceRouteShardsToF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_reduce_route_shards_to_f32")? };
        let status = unsafe {
            kernel_fn(
                buffers,
                rows,
        ...
        self.status_to_result("ds4rt_cuda_reduce_route_shards_to_f32", status)
    }
    ...
    pub unsafe fn cuda_reduce_route_shards_to_f32_async(
        ...
        validate_route_shard_reduction_buffers(
            "ds4rt_cuda_reduce_route_shards_to_f32_async",
            buffers,
            rows,
            row_width,
            peer_row_stride_bytes,
        ...
        let kernel_fn: Symbol<CudaReduceRouteShardsToF32AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_reduce_route_shards_to_f32_async")?
        };
        let status = unsafe {
            kernel_fn(
                buffers,
        ...
        self.status_to_result("ds4rt_cuda_reduce_route_shards_to_f32_async", status)
    }
    ...
    pub fn cuda_scatter_add_rows_bf16_weighted_to_f32(
        ...
        validate_row_scatter_bf16_weighted_to_f32_buffers(
            "ds4rt_cuda_scatter_add_rows_bf16_weighted_to_f32",
            src,
            row_indices,
            row_weights,
            dst,
        ...
        let kernel_fn: Symbol<CudaScatterAddRowsBf16WeightedToF32Fn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_scatter_add_rows_bf16_weighted_to_f32")?
        };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_scatter_add_rows_bf16_weighted_to_f32", status)
    }
    ...
    pub unsafe fn cuda_scatter_add_rows_bf16_weighted_to_f32_async(
        ...
        let kernel_fn: Symbol<CudaScatterAddRowsBf16WeightedToF32AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_scatter_add_rows_bf16_weighted_to_f32_async")?
        };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u16>() as *const u16,
    ...
    pub fn cuda_kv_cache_write_bytes(
        ...
        validate_kv_cache_write_buffers(
            "ds4rt_cuda_kv_cache_write_bytes",
            src,
            cache,
            cache_offset_bytes,
            bytes,
        ...
        let kernel_fn: Symbol<CudaKvCacheWriteBytesFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_kv_cache_write_bytes")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u8>() as *const u8,
                cache.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_kv_cache_write_bytes", status)
    }
    ...
    pub unsafe fn cuda_kv_cache_write_bytes_async(
        ...
        validate_kv_cache_write_buffers(
            "ds4rt_cuda_kv_cache_write_bytes_async",
            src,
            cache,
            cache_offset_bytes,
            bytes,
        ...
        let kernel_fn: Symbol<CudaKvCacheWriteBytesAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_kv_cache_write_bytes_async")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u8>() as *const u8,
                cache.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_kv_cache_write_bytes_async", status)
    }
    ...
    pub fn cuda_kv_cache_read_bytes(
        ...
        validate_kv_cache_read_buffers(
            "ds4rt_cuda_kv_cache_read_bytes",
            cache,
            dst,
            cache_offset_bytes,
            bytes,
        ...
        let kernel_fn: Symbol<CudaKvCacheReadBytesFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_kv_cache_read_bytes")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_kv_cache_read_bytes", status)
    }
    ...
    pub unsafe fn cuda_kv_cache_read_bytes_async(
        ...
        validate_kv_cache_read_buffers(
            "ds4rt_cuda_kv_cache_read_bytes_async",
            cache,
            dst,
            cache_offset_bytes,
            bytes,
        ...
        let kernel_fn: Symbol<CudaKvCacheReadBytesAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_kv_cache_read_bytes_async")? };
        let status = unsafe {
            kernel_fn(
                cache.ptr.cast::<u8>() as *const u8,
                dst.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_kv_cache_read_bytes_async", status)
    }
    ...
    pub unsafe fn cuda_kv_cache_write_blocks(
        ...
        src: Ds4rtDeviceBuffer,
        cache: Ds4rtDeviceBuffer,
        src_offsets: Ds4rtDeviceBuffer,
        cache_offsets: Ds4rtDeviceBuffer,
        block_bytes: Ds4rtDeviceBuffer,
        block_count: usize,
    ) -> Result<()> {
        validate_kv_cache_write_block_buffers(
            "ds4rt_cuda_kv_cache_write_blocks",
            src,
            cache,
            src_offsets,
            cache_offsets,
        ...
        let kernel_fn: Symbol<CudaKvCacheWriteBlocksFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_kv_cache_write_blocks")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u8>() as *const u8,
                cache.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_kv_cache_write_blocks", status)
    }
    ...
    pub unsafe fn cuda_kv_cache_write_blocks_async(
        ...
        let kernel_fn: Symbol<CudaKvCacheWriteBlocksAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_kv_cache_write_blocks_async")? };
        let status = unsafe {
            kernel_fn(
                src.ptr.cast::<u8>() as *const u8,
                cache.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_kv_cache_write_blocks_async", status)
    }
    ...
    pub unsafe fn cuda_kv_cache_read_blocks(
        ...
        dst: Ds4rtDeviceBuffer,
        cache_offsets: Ds4rtDeviceBuffer,
        dst_offsets: Ds4rtDeviceBuffer,
        block_bytes: Ds4rtDeviceBuffer,
        block_count: usize,
    ) -> Result<()> {
        validate_kv_cache_read_block_buffers(
            "ds4rt_cuda_kv_cache_read_blocks",
            cache,
            dst,
            cache_offsets,
            dst_offsets,
        ...
        let kernel_fn: Symbol<CudaKvCacheReadBlocksFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_kv_cache_read_blocks")? };
        let status = unsafe {
            kernel_fn(
                cache.ptr.cast::<u8>() as *const u8,
                dst.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_kv_cache_read_blocks", status)
    }
    ...
    pub unsafe fn cuda_kv_cache_read_blocks_async(
        ...
        validate_kv_cache_read_block_buffers(
            "ds4rt_cuda_kv_cache_read_blocks_async",
            cache,
            dst,
            cache_offsets,
            dst_offsets,
        ...
        let kernel_fn: Symbol<CudaKvCacheReadBlocksAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_kv_cache_read_blocks_async")? };
        let status = unsafe {
            kernel_fn(
                cache.ptr.cast::<u8>() as *const u8,
                dst.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_kv_cache_read_blocks_async", status)
    }
    ...
    pub fn cuda_mla_kv_cache_unpack_bf16(
        ...
        validate_mla_kv_cache_unpack_bf16_buffers(
            "ds4rt_cuda_mla_kv_cache_unpack_bf16",
            payload,
            kv_latent,
            k_rope,
            dsa_key,
        ...
        let kernel_fn: Symbol<CudaMlaKvCacheUnpackBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_cache_unpack_bf16")? };
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_cache_unpack_bf16", status)
    }
    ...
    pub unsafe fn cuda_mla_kv_cache_unpack_bf16_async(
        ...
        validate_mla_kv_cache_unpack_bf16_buffers(
            "ds4rt_cuda_mla_kv_cache_unpack_bf16_async",
            payload,
            kv_latent,
            k_rope,
            dsa_key,
        ...
        let kernel_fn: Symbol<CudaMlaKvCacheUnpackBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_cache_unpack_bf16_async")? };
        let dsa_key_ptr = dsa_key
            .map(|buffer| buffer.ptr.cast::<u16>())
            .unwrap_or(std::ptr::null_mut());
        let status = unsafe {
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_cache_unpack_bf16_async", status)
    }
    ...
    pub fn cuda_mla_kv_projected_split_bf16(
        ...
        validate_mla_kv_projected_split_bf16_buffers(
            "ds4rt_cuda_mla_kv_projected_split_bf16",
            projected,
            k_nope,
            v,
            rows,
        ...
        let kernel_fn: Symbol<CudaMlaKvProjectedSplitBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_projected_split_bf16")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_projected_split_bf16", status)
    }
    ...
    pub unsafe fn cuda_mla_kv_projected_split_bf16_async(
        ...
        validate_mla_kv_projected_split_bf16_buffers(
            "ds4rt_cuda_mla_kv_projected_split_bf16_async",
            projected,
            k_nope,
            v,
            rows,
        ...
        let kernel_fn: Symbol<CudaMlaKvProjectedSplitBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_mla_kv_projected_split_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                projected.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_projected_split_bf16_async", status)
    }
    ...
    pub fn cuda_mla_kv_prepare_bf16(
        ...
        let kernel_fn: Symbol<CudaMlaKvPrepareBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_prepare_bf16")? };
        let status = unsafe {
            kernel_fn(
                projected.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_prepare_bf16", status)
    }
    ...
    pub unsafe fn cuda_mla_kv_prepare_bf16_async(
        ...
        validate_mla_kv_prepare_bf16_buffers(
            "ds4rt_cuda_mla_kv_prepare_bf16_async",
            projected,
            positions,
            norm_weight,
            prepared,
        ...
        let kernel_fn: Symbol<CudaMlaKvPrepareBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_prepare_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                projected.ptr.cast::<u16>() as *const u16,
                positions.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_prepare_bf16_async", status)
    }
    ...
    pub fn cuda_transpose_rows_heads_bf16(
        ...
        let kernel_fn: Symbol<CudaTransposeRowsHeadsBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_transpose_rows_heads_bf16")? };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
                output.ptr.cast::<u16>(),
        ...
        self.status_to_result("ds4rt_cuda_transpose_rows_heads_bf16", status)
    }
    ...
    pub unsafe fn cuda_transpose_rows_heads_bf16_async(
        ...
        let kernel_fn: Symbol<CudaTransposeRowsHeadsBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_transpose_rows_heads_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_transpose_rows_heads_bf16_async", status)
    }
    ...
    pub fn cuda_transpose_heads_rows_bf16(
        ...
        let kernel_fn: Symbol<CudaTransposeRowsHeadsBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_transpose_heads_rows_bf16")? };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
                output.ptr.cast::<u16>(),
        ...
        self.status_to_result("ds4rt_cuda_transpose_heads_rows_bf16", status)
    }
    ...
    pub unsafe fn cuda_transpose_heads_rows_bf16_async(
        ...
        let kernel_fn: Symbol<CudaTransposeRowsHeadsBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_transpose_heads_rows_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_transpose_heads_rows_bf16_async", status)
    }

    pub fn cuda_mla_compose_absorbed_query_bf16(
        &self,
        latent_heads_rows: Ds4rtDeviceBuffer,
        rope_rows_heads: Ds4rtDeviceBuffer,
        output_rows_heads: Ds4rtDeviceBuffer,
        rows: usize,
        heads: usize,
        latent_width: usize,
        rope_width: usize,
        ...
        let kernel_fn: Symbol<CudaMlaComposeAbsorbedQueryBf16Fn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_mla_compose_absorbed_query_bf16")?
        };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_mla_compose_absorbed_query_bf16", status)
    }
    ...
    pub unsafe fn cuda_mla_compose_absorbed_query_bf16_async(
        ...
        let kernel_fn: Symbol<CudaMlaComposeAbsorbedQueryBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_mla_compose_absorbed_query_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                latent_heads_rows.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_mla_compose_absorbed_query_bf16_async", status)
    }

    pub fn cuda_generic_kv_page_table_init(
        &self,
        page_table: Ds4rtDeviceBuffer,
        query_rows: usize,
        page_table_width: usize,
    ) -> Result<()> {
        ...
        let kernel_fn: Symbol<CudaGenericKvPageTableInitFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_generic_kv_page_table_init")? };
        let status =
            unsafe { kernel_fn(page_table.ptr.cast::<i32>(), query_rows, page_table_width) };
        self.status_to_result("ds4rt_cuda_generic_kv_page_table_init", status)
    }
    ...
    pub unsafe fn cuda_generic_kv_page_table_init_async(
        ...
        let kernel_fn: Symbol<CudaGenericKvPageTableInitAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_generic_kv_page_table_init_async")?
        };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_generic_kv_page_table_init_async", status)
    }
    ...
    pub fn cuda_generic_kv_page_table_init_base(
        ...
        let context = "ds4rt_cuda_generic_kv_page_table_init_base";
        ...
        let kernel_fn: Symbol<CudaGenericKvPageTableInitBaseFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_generic_kv_page_table_init_base")?
        };
        let status = unsafe {
            kernel_fn(
                page_table.ptr.cast::<i32>(),
    ...
    pub unsafe fn cuda_generic_kv_page_table_init_base_async(
        ...
        let context = "ds4rt_cuda_generic_kv_page_table_init_base_async";
        validate_generic_kv_page_table_buffer(context, page_table, query_rows, page_table_width)?;
        let kernel_fn: Symbol<CudaGenericKvPageTableInitBaseAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_generic_kv_page_table_init_base_async")?
        };
        let status = unsafe {
            kernel_fn(
                page_table.ptr.cast::<i32>(),
    ...
    pub unsafe fn cuda_generic_kv_page_table_init_offsets_async(
        &self,
        page_table: Ds4rtDeviceBuffer,
        row_offsets: Ds4rtDeviceBuffer,
        query_rows: usize,
        page_table_width: usize,
        cuda_stream: *mut c_void,
    ) -> Result<()> {
        let context = "ds4rt_cuda_generic_kv_page_table_init_offsets_async";
        validate_generic_kv_page_table_buffer(context, page_table, query_rows, page_table_width)?;
        validate_device_buffer_bytes(
        ...
        let kernel_fn: Symbol<CudaGenericKvPageTableInitOffsetsAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_generic_kv_page_table_init_offsets_async")?
        };
        let status = unsafe {
            kernel_fn(
                page_table.ptr.cast::<i32>(),
    ...
    pub fn cuda_generic_kv_page_table_expand_indices(
        &self,
        output_indices: Ds4rtDeviceBuffer,
        physical_pages: Ds4rtDeviceBuffer,
        query_rows: usize,
        output_width: usize,
        active_tokens: usize,
    ) -> Result<()> {
        let context = "ds4rt_cuda_generic_kv_page_table_expand_indices";
    ...
    pub unsafe fn cuda_generic_kv_page_table_expand_indices_async(
        ...
        let context = "ds4rt_cuda_generic_kv_page_table_expand_indices_async";
        validate_generic_kv_page_table_expand_indices_buffers(
            context,
            output_indices,
            physical_pages,
    ...
    pub fn cuda_mla_kv_pack_fp8_ds_mla(
        ...
        let kernel_fn: Symbol<CudaMlaKvPackFp8DsMlaFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_pack_fp8_ds_mla")? };
        let status = unsafe {
            kernel_fn(
                projected.ptr.cast::<u16>() as *const u16,
                packed.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_pack_fp8_ds_mla", status)
    }
    ...
    pub unsafe fn cuda_mla_kv_pack_fp8_ds_mla_async(
        ...
        let kernel_fn: Symbol<CudaMlaKvPackFp8DsMlaAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_pack_fp8_ds_mla_async")? };
        let status = unsafe {
            kernel_fn(
                projected.ptr.cast::<u16>() as *const u16,
                packed.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_pack_fp8_ds_mla_async", status)
    }
    ...
    pub fn cuda_mla_kv_unpack_fp8_ds_mla(
        ...
        let kernel_fn: Symbol<CudaMlaKvUnpackFp8DsMlaFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_unpack_fp8_ds_mla")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_unpack_fp8_ds_mla", status)
    }
    ...
    pub unsafe fn cuda_mla_kv_unpack_fp8_ds_mla_async(
        ...
        validate_mla_kv_fp8_ds_mla_unpack_buffers(
            "ds4rt_cuda_mla_kv_unpack_fp8_ds_mla_async",
            packed,
            projected,
            rows,
            packed_stride_bytes,
        ...
        let kernel_fn: Symbol<CudaMlaKvUnpackFp8DsMlaAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_unpack_fp8_ds_mla_async")? };
        let status = unsafe {
            kernel_fn(
                packed.ptr.cast::<u8>() as *const u8,
                projected.ptr.cast::<u16>(),
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_unpack_fp8_ds_mla_async", status)
    }
    ...
    pub fn cuda_mla_kv_pack_mxfp4_ds_mla(
        ...
        let kernel_fn: Symbol<CudaMlaKvPackMxfp4DsMlaFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_pack_mxfp4_ds_mla")? };
        let status = unsafe {
            kernel_fn(
                projected.ptr.cast::<u16>() as *const u16,
                packed.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_pack_mxfp4_ds_mla", status)
    }
    ...
    pub unsafe fn cuda_mla_kv_pack_mxfp4_ds_mla_async(
        ...
        let kernel_fn: Symbol<CudaMlaKvPackMxfp4DsMlaAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_pack_mxfp4_ds_mla_async")? };
        let status = unsafe {
            kernel_fn(
                projected.ptr.cast::<u16>() as *const u16,
                packed.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_pack_mxfp4_ds_mla_async", status)
    }
    ...
    pub fn cuda_mla_kv_unpack_mxfp4_ds_mla(
        ...
        let kernel_fn: Symbol<CudaMlaKvUnpackMxfp4DsMlaFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_kv_unpack_mxfp4_ds_mla")? };
        let status = unsafe {
            kernel_fn(
                packed.ptr.cast::<u8>() as *const u8,
                projected.ptr.cast::<u16>(),
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_unpack_mxfp4_ds_mla", status)
    }
    ...
    pub unsafe fn cuda_mla_kv_unpack_mxfp4_ds_mla_async(
        ...
        validate_mla_kv_mxfp4_ds_mla_unpack_buffers(
            "ds4rt_cuda_mla_kv_unpack_mxfp4_ds_mla_async",
            packed,
            projected,
            rows,
            packed_stride_bytes,
        ...
        let kernel_fn: Symbol<CudaMlaKvUnpackMxfp4DsMlaAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_mla_kv_unpack_mxfp4_ds_mla_async")?
        };
        let status = unsafe {
            kernel_fn(
                packed.ptr.cast::<u8>() as *const u8,
        ...
        self.status_to_result("ds4rt_cuda_mla_kv_unpack_mxfp4_ds_mla_async", status)
    }
    ...
    pub fn cuda_router_topk_f32(
        ...
        let kernel_fn: Symbol<CudaRouterTopKF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_router_topk_f32")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_router_topk_f32", status)
    }
    ...
    pub unsafe fn cuda_router_topk_f32_async(
        ...
        validate_router_topk_buffers(
            "ds4rt_cuda_router_topk_f32_async",
            hidden,
            router_weight,
            correction_bias,
            topk_indices,
        ...
        let kernel_fn: Symbol<CudaRouterTopKF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_router_topk_f32_async")? };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<f32>() as *const f32,
                router_weight.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_router_topk_f32_async", status)
    }
    ...
    pub fn cuda_router_topk_bf16(
        ...
        let kernel_fn: Symbol<CudaRouterTopKBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_router_topk_bf16")? };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_router_topk_bf16", status)
    }
    ...
    pub unsafe fn cuda_router_topk_bf16_async(
        ...
        validate_router_topk_bf16_buffers(
            "ds4rt_cuda_router_topk_bf16_async",
            hidden,
            router_weight,
            correction_bias,
            topk_indices,
        ...
        let kernel_fn: Symbol<CudaRouterTopKBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_router_topk_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
                router_weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_router_topk_bf16_async", status)
    }
    ...
    pub unsafe fn cuda_ds4_flash_router_topk_bf16_async(
        ...
        hidden: Ds4rtDeviceBuffer,
        router_weight: Ds4rtDeviceBuffer,
        correction_bias: Option<Ds4rtDeviceBuffer>,
        token_to_experts: Option<Ds4rtDeviceBuffer>,
        ...
        validate_ds4_flash_router_topk_bf16_buffers(
            "ds4rt_cuda_ds4_flash_router_topk_bf16_async",
            hidden,
            router_weight,
            correction_bias,
            token_to_experts,
        ...
        let kernel_fn: Symbol<CudaDs4FlashRouterTopKBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_router_topk_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_ds4_flash_router_topk_bf16_async", status)
    }
    ...
    pub unsafe fn cuda_ds4_pro_router_topk_bf16_async(
        ...
        validate_ds4_pro_router_topk_bf16_buffers(
            "ds4rt_cuda_ds4_pro_router_topk_bf16_async",
            hidden,
            router_weight,
            correction_bias,
            token_to_experts,
        ...
        let kernel_fn: Symbol<CudaDs4FlashRouterTopKBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_ds4_pro_router_topk_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
                router_weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_ds4_pro_router_topk_bf16_async", status)
    }
    ...
    pub unsafe fn cuda_ds4_flash_router_refine_topk_bf16_async(
        ...
        router_weight: Ds4rtDeviceBuffer,
        correction_bias: Ds4rtDeviceBuffer,
        approximate_logits: Ds4rtDeviceBuffer,
        topk_indices: Ds4rtDeviceBuffer,
        topk_scores: Ds4rtDeviceBuffer,
        topk_weights: Ds4rtDeviceBuffer,
        rows: usize,
        ...
        validate_ds4_flash_router_refine_topk_bf16_buffers(
            "ds4rt_cuda_ds4_flash_router_refine_topk_bf16_async",
            hidden,
            router_weight,
            correction_bias,
            approximate_logits,
        ...
        let kernel_fn: Symbol<CudaDs4FlashRouterRefineTopKBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_flash_router_refine_topk_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_ds4_flash_router_refine_topk_bf16_async", status)
    }
    ...
    pub unsafe fn cuda_router_topk_bf16_cub_async(
        ...
        router_weight: Ds4rtDeviceBuffer,
        correction_bias: Ds4rtDeviceBuffer,
        corrected_scores: Ds4rtDeviceBuffer,
        sorted_corrected_scores: Ds4rtDeviceBuffer,
        unsorted_indices: Ds4rtDeviceBuffer,
        sorted_indices: Ds4rtDeviceBuffer,
        segment_offsets: Ds4rtDeviceBuffer,
        topk_indices: Ds4rtDeviceBuffer,
        topk_scores: Ds4rtDeviceBuffer,
        topk_weights: Ds4rtDeviceBuffer,
        cub_temp_storage: Ds4rtDeviceBuffer,
        cub_temp_storage_bytes: usize,
        rows: usize,
        hidden_dim: usize,
        experts: usize,
        ...
        validate_router_topk_bf16_buffers(
            "ds4rt_cuda_router_topk_bf16_cub_async",
            hidden,
            router_weight,
            correction_bias,
            topk_indices,
        ...
        let score_values = checked_row_values(
            "ds4rt_cuda_router_topk_bf16_cub_async score workspace",
            rows,
            experts,
        )?;
        validate_f32_buffer_values(
            "ds4rt_cuda_router_topk_bf16_cub_async corrected_scores",
            corrected_scores,
            score_values,
        )?;
        validate_f32_buffer_values(
            "ds4rt_cuda_router_topk_bf16_cub_async sorted_corrected_scores",
            sorted_corrected_scores,
            score_values,
        )?;
        validate_u32_buffer_values(
            "ds4rt_cuda_router_topk_bf16_cub_async unsorted_indices",
            unsorted_indices,
            score_values,
        )?;
        validate_u32_buffer_values(
            "ds4rt_cuda_router_topk_bf16_cub_async sorted_indices",
            sorted_indices,
            score_values,
        )?;
        let offset_values = rows.checked_add(1).context(
            "ds4rt_cuda_router_topk_bf16_cub_async segment offset count overflows usize",
        )?;
        let offset_bytes = offset_values
            .checked_mul(std::mem::size_of::<i32>())
            .context("ds4rt_cuda_router_topk_bf16_cub_async segment offset bytes overflow usize")?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_router_topk_bf16_cub_async segment_offsets",
            segment_offsets,
            offset_bytes,
        )?;
        validate_device_buffer_bytes(
            "ds4rt_cuda_router_topk_bf16_cub_async cub_temp_storage",
            cub_temp_storage,
            cub_temp_storage_bytes,
        )?;

        let kernel_fn: Symbol<CudaRouterTopKBf16CubAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_router_topk_bf16_cub_async")? };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
                router_weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_router_topk_bf16_cub_async", status)
    }
    ...
    pub fn cuda_linear_f32(
        ...
        let kernel_fn: Symbol<CudaLinearF32Fn> = unsafe { self.lib.get(b"ds4rt_cuda_linear_f32")? };
        let bias_ptr = bias
            .map(|buffer| buffer.ptr.cast::<f32>() as *const f32)
            .unwrap_or(std::ptr::null());
        let status = unsafe {
        ...
        self.status_to_result("ds4rt_cuda_linear_f32", status)
    }
    ...
    pub unsafe fn cuda_linear_f32_async(
        ...
        let kernel_fn: Symbol<CudaLinearF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_linear_f32_async")? };
        let bias_ptr = bias
            .map(|buffer| buffer.ptr.cast::<f32>() as *const f32)
            .unwrap_or(std::ptr::null());
        let status = unsafe {
        ...
        self.status_to_result("ds4rt_cuda_linear_f32_async", status)
    }
    ...
    pub fn cuda_linear_bf16(
        ...
        let kernel_fn: Symbol<CudaLinearBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_linear_bf16")? };
        let bias_ptr = bias
        ...
        self.status_to_result("ds4rt_cuda_linear_bf16", status)
    }
    ...
    pub unsafe fn cuda_linear_bf16_async(
        ...
        let kernel_fn: Symbol<CudaLinearBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_linear_bf16_async")? };
        let bias_ptr = bias
            .map(|buffer| buffer.ptr.cast::<u16>() as *const u16)
            .unwrap_or(std::ptr::null());
        let status = unsafe {
        ...
        self.status_to_result("ds4rt_cuda_linear_bf16_async", status)
    }
    ...
    pub fn cuda_linear_bf16_cublas(
        ...
        let kernel_fn: Symbol<CudaLinearBf16CublasFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_linear_bf16_cublas")? };
        let bias_ptr = bias
            .map(|buffer| buffer.ptr.cast::<u16>() as *const u16)
            .unwrap_or(std::ptr::null());
        let status = unsafe {
        ...
        self.status_to_result("ds4rt_cuda_linear_bf16_cublas", status)
    }
    ...
    pub unsafe fn cuda_linear_bf16_cublas_async(
        ...
        let kernel_fn: Symbol<CudaLinearBf16CublasAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_linear_bf16_cublas_async")? };
        let bias_ptr = bias
            .map(|buffer| buffer.ptr.cast::<u16>() as *const u16)
            .unwrap_or(std::ptr::null());
        let status = unsafe {
        ...
        self.status_to_result("ds4rt_cuda_linear_bf16_cublas_async", status)
    }
    ...
    pub unsafe fn cuda_linear_bf16_f32_cublas_async(
        ...
        let kernel_fn: Symbol<CudaLinearBf16F32CublasAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_linear_bf16_f32_cublas_async")? };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
                weight.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_linear_bf16_f32_cublas_async", status)
    }
    ...
    pub unsafe fn cuda_linear_bf16_m1_parity_batched_cublaslt_async(
        ...
        let kernel_fn: Symbol<CudaLinearBf16M1ParityBatchedCublasLtAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_linear_bf16_m1_parity_batched_cublaslt_async")?
        };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
    ...
    pub unsafe fn cuda_quantize_bf16_w8a16_group256_async(
        ...
        let kernel_fn: Symbol<CudaQuantizeBf16W8a16Group256AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_quantize_bf16_w8a16_group256_async")?
        };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_quantize_bf16_w8a16_group256_async", status)
    }
    ...
    pub unsafe fn cuda_quantize_bf16_w8a16_group256_packed_async(
        ...
        let kernel_fn: Symbol<CudaQuantizeBf16W8a16Group256PackedAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_quantize_bf16_w8a16_group256_packed_async")?
        };
        let status = unsafe {
            kernel_fn(
                source.ptr.cast::<u16>() as *const u16,
    ...
    pub unsafe fn cuda_w8a16_packed_o_aot_init(&self) -> Result<()> {
        let init_fn: Symbol<CudaB12xCoordinatorAotInitFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_w8a16_packed_o_aot_init")? };
        let status = unsafe { init_fn() };
        self.status_to_result("ds4rt_cuda_w8a16_packed_o_aot_init", status)
    }
    ...
    pub unsafe fn cuda_w8a16_packed_o_initialize_launch_buffers_async(
        ...
        let kernel_fn: Symbol<CudaW8a16PackedOInitializeAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_w8a16_packed_o_initialize_launch_buffers_async")?
        };
        let status = unsafe { kernel_fn(buffers, rows, block_m, cuda_stream) };
        self.status_to_result(
            "ds4rt_cuda_w8a16_packed_o_initialize_launch_buffers_async",
            status,
        )
    }
    ...
    pub unsafe fn cuda_w8a16_packed_o_async(
        ...
        let kernel_fn: Symbol<CudaB12xCoordinatorW4a16BuffersRowsAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_w8a16_packed_o_async")? };
        let status = unsafe { kernel_fn(buffers, rows, cuda_stream) };
        self.status_to_result("ds4rt_cuda_w8a16_packed_o_async", status)
    }
    ...
    pub unsafe fn cuda_linear_w8a16_group256_m1_simt_async(
        ...
        let kernel_fn: Symbol<CudaLinearW8a16Group256M1SimtAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_linear_w8a16_group256_m1_simt_async")?
        };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_linear_w8a16_group256_m1_simt_async", status)
    }
    ...
    pub unsafe fn cuda_linear_w8a16_group256_m1_warp_packed_async(
        ...
        let kernel_fn: Symbol<CudaLinearW8a16Group256M1WarpPackedAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_linear_w8a16_group256_m1_warp_packed_async")?
        };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result(
            "ds4rt_cuda_linear_w8a16_group256_m1_warp_packed_async",
            status,
        )
    }
    ...
    pub unsafe fn cuda_linear_w8a16_group256_m1_warp_packed_parity_batched_async(
        ...
        let kernel_fn: Symbol<CudaLinearW8a16Group256M1WarpPackedParityBatchedAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_linear_w8a16_group256_m1_warp_packed_parity_batched_async")?
        };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
    ...
    pub unsafe fn cuda_linear_w8a16_group256_m1_parity_batched_async(
        ...
        let kernel_fn: Symbol<CudaLinearW8a16Group256M1ParityBatchedAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_linear_w8a16_group256_m1_parity_batched_async")?
        };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
    ...
    pub unsafe fn cuda_preload_w8a16_group256_aot(
        ...
        let preload_fn: Symbol<CudaPreloadW8a16Group256AotFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_preload_w8a16_group256_aot")? };
        let status = unsafe { preload_fn(input_dim, output_dim) };
        self.status_to_result("ds4rt_cuda_preload_w8a16_group256_aot", status)
    }
    ...
    pub unsafe fn cuda_linear_w8a16_group256_aot_async(
        ...
        let kernel_fn: Symbol<CudaLinearW8a16Group256AotAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_linear_w8a16_group256_aot_async")?
        };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_linear_w8a16_group256_aot_async", status)
    }
    ...
    pub fn cuda_linear_bf16_strided_batched_cublas(
        ...
        validate_linear_bf16_strided_batched_buffers(
            "ds4rt_cuda_linear_bf16_strided_batched_cublas",
            input,
            weight,
            output,
            batch_count,
        ...
        let kernel_fn: Symbol<CudaLinearBf16StridedBatchedCublasFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_linear_bf16_strided_batched_cublas")?
        };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_linear_bf16_strided_batched_cublas", status)
    }
    ...
    pub unsafe fn cuda_linear_bf16_strided_batched_cublas_async(
        ...
        let kernel_fn: Symbol<CudaLinearBf16StridedBatchedCublasAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_linear_bf16_strided_batched_cublas_async")?
        };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
    ...
    pub unsafe fn cuda_matmul_bf16_strided_batched_cublas_async(
        ...
        let kernel_fn: Symbol<CudaMatmulBf16StridedBatchedCublasAsyncFn> = self
            .lib
            .get(b"ds4rt_cuda_matmul_bf16_strided_batched_cublas_async")?;
    ...
    pub fn cuda_causal_attention_f32(
        ...
        let kernel_fn: Symbol<CudaCausalAttentionF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_causal_attention_f32")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_causal_attention_f32", status)
    }
    ...
    pub unsafe fn cuda_causal_attention_f32_async(
        ...
        validate_causal_attention_buffers(
            "ds4rt_cuda_causal_attention_f32_async",
            q,
            k,
            v,
            out,
        ...
        let kernel_fn: Symbol<CudaCausalAttentionF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_causal_attention_f32_async")? };
        let status = unsafe {
            kernel_fn(
                q.ptr.cast::<f32>() as *const f32,
                k.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_causal_attention_f32_async", status)
    }
    ...
    pub fn cuda_causal_attention_bf16(
        ...
        let kernel_fn: Symbol<CudaCausalAttentionBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_causal_attention_bf16")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_causal_attention_bf16", status)
    }
    ...
    pub unsafe fn cuda_causal_attention_bf16_async(
        ...
        validate_causal_attention_bf16_buffers(
            "ds4rt_cuda_causal_attention_bf16_async",
            q,
            k,
            v,
            out,
        ...
        let kernel_fn: Symbol<CudaCausalAttentionBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_causal_attention_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                q.ptr.cast::<u16>() as *const u16,
                k.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_causal_attention_bf16_async", status)
    }

    pub unsafe fn cuda_ds4_dspark_prompt_metadata_async(
        &self,
        positions: Ds4rtDeviceBuffer,
        main_slots: Ds4rtDeviceBuffer,
        cos_sin_cache: Ds4rtDeviceBuffer,
        absolute_position_start: usize,
        request_slot: usize,
        rows: usize,
        theta: f32,
        ...
        let context = "ds4rt_cuda_ds4_dspark_prompt_metadata_async";
        ...
        let kernel_fn: Symbol<CudaDs4DsparkPromptMetadataAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_dspark_prompt_metadata_async")?
        };
        let status = unsafe {
            kernel_fn(
    ...
    pub unsafe fn cuda_ds4_dspark_prepare_proposal_async(
        &self,
        embedding: Ds4rtDeviceBuffer,
        draft_token_ids: Ds4rtDeviceBuffer,
        proposal_residual: Ds4rtDeviceBuffer,
        positions: Ds4rtDeviceBuffer,
        main_slots: Ds4rtDeviceBuffer,
        cos_sin_cache: Ds4rtDeviceBuffer,
        selected_indices: Ds4rtDeviceBuffer,
        selected_lengths: Ds4rtDeviceBuffer,
        anchor_token_id: usize,
        noise_token_id: usize,
        request_slot: usize,
        cache_window_start: usize,
        ...
        let context = "ds4rt_cuda_ds4_dspark_prepare_proposal_async";
        ...
        let kernel_fn: Symbol<CudaDs4DsparkPrepareProposalAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_ds4_dspark_prepare_proposal_async")?
        };
        let status = unsafe {
            kernel_fn(
    ...
    pub fn cuda_rope_f32(
        ...
        let kernel_fn: Symbol<CudaRopeF32Fn> = unsafe { self.lib.get(b"ds4rt_cuda_rope_f32")? };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<f32>() as *const f32,
                positions.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_rope_f32", status)
    }
    ...
    pub unsafe fn cuda_rope_f32_async(
        ...
        let kernel_fn: Symbol<CudaRopeF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_rope_f32_async")? };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<f32>() as *const f32,
                positions.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_rope_f32_async", status)
    }
    ...
    pub fn cuda_rope_bf16(
        ...
        let kernel_fn: Symbol<CudaRopeBf16Fn> = unsafe { self.lib.get(b"ds4rt_cuda_rope_bf16")? };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
                positions.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_rope_bf16", status)
    }
    ...
    pub unsafe fn cuda_rope_bf16_async(
        ...
        let kernel_fn: Symbol<CudaRopeBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_rope_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                input.ptr.cast::<u16>() as *const u16,
                positions.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_rope_bf16_async", status)
    }
    ...
    pub fn cuda_mla_rope_attention_bf16(
        ...
        let kernel_fn: Symbol<CudaMlaRopeAttentionBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_rope_attention_bf16")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_mla_rope_attention_bf16", status)
    }
    ...
    pub unsafe fn cuda_mla_rope_attention_bf16_async(
        ...
        validate_mla_rope_attention_bf16_buffers(
            "ds4rt_cuda_mla_rope_attention_bf16_async",
            q_nope,
            q_rope,
            k_nope,
            k_rope,
        ...
        let kernel_fn: Symbol<CudaMlaRopeAttentionBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_rope_attention_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                q_nope.ptr.cast::<u16>() as *const u16,
                q_rope.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_mla_rope_attention_bf16_async", status)
    }
    ...
    pub fn cuda_mla_rope_attention_bf16_suffix(
        ...
        validate_mla_rope_attention_bf16_suffix_buffers(
            "ds4rt_cuda_mla_rope_attention_bf16_suffix",
            q_nope,
            q_rope,
            k_nope,
            k_rope,
        ...
        let kernel_fn: Symbol<CudaMlaRopeAttentionBf16SuffixFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_rope_attention_bf16_suffix")? };
        let status = unsafe {
            kernel_fn(
                q_nope.ptr.cast::<u16>() as *const u16,
                q_rope.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_mla_rope_attention_bf16_suffix", status)
    }
    ...
    pub unsafe fn cuda_mla_rope_attention_bf16_suffix_async(
        ...
        validate_mla_rope_attention_bf16_suffix_buffers(
            "ds4rt_cuda_mla_rope_attention_bf16_suffix_async",
            q_nope,
            q_rope,
            k_nope,
            k_rope,
        ...
        let kernel_fn: Symbol<CudaMlaRopeAttentionBf16SuffixAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_mla_rope_attention_bf16_suffix_async")?
        };
        let status = unsafe {
            kernel_fn(
                q_nope.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_mla_rope_attention_bf16_suffix_async", status)
    }
    ...
    pub unsafe fn cuda_mla_merge_state_bf16_async(
        ...
        let context = "ds4rt_cuda_mla_merge_state_bf16_async";
        ...
        let kernel_fn: Symbol<CudaMlaMergeStateBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_mla_merge_state_bf16_async")? };
        let status = unsafe {
            kernel_fn(
    ...
    pub unsafe fn cuda_sparse_mla_nvfp4_async(
        &self,
        query: Ds4rtDeviceBuffer,
        kv_payload: Ds4rtDeviceBuffer,
        selected_indices: Ds4rtDeviceBuffer,
        topk_lengths: Ds4rtDeviceBuffer,
        partial: Ds4rtDeviceBuffer,
        partial_lse: Ds4rtDeviceBuffer,
        output: Ds4rtDeviceBuffer,
        output_lse: Ds4rtDeviceBuffer,
        query_rows: usize,
        heads: usize,
        topk: usize,
        kv_row_stride_bytes: usize,
        ...
        const NVFP4_ROW_BYTES: usize = DS4RT_CUDA_MLA_MXFP4_DS_PACKED_BYTES;
        let context = "ds4rt_cuda_sparse_mla_nvfp4_async";
        if query_rows == 0
            || heads != 64
            || topk != 2048
        ...
        let kernel_fn: Symbol<CudaSparseMlaNvfp4AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_sparse_mla_nvfp4_async")? };
        let status = unsafe {
            kernel_fn(
    ...
    pub unsafe fn cuda_sparse_mla_bf16_async(
        ...
        let context = "ds4rt_cuda_sparse_mla_bf16_async";
        if query_rows == 0
            || heads != 64
            || topk != 2048
        ...
        let kernel_fn: Symbol<CudaSparseMlaBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_sparse_mla_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                query.ptr.cast::<u16>() as *const u16,
                kv_payload.ptr.cast::<u8>() as *const u8,
    ...
    pub unsafe fn cuda_sparse_mla_bf16_gather_kv_async(
        ...
        selected_indices: Ds4rtDeviceBuffer,
        topk_lengths: Ds4rtDeviceBuffer,
        gathered_k: Ds4rtDeviceBuffer,
        gathered_v: Ds4rtDeviceBuffer,
        query_rows: usize,
        topk: usize,
        kv_row_stride_bytes: usize,
        cuda_stream: *mut c_void,
        ...
        let context = "ds4rt_cuda_sparse_mla_bf16_gather_kv_async";
        ...
        let kernel_fn: Symbol<CudaSparseMlaBf16GatherKvAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_sparse_mla_bf16_gather_kv_async")?
        };
        let status = unsafe {
            kernel_fn(
                kv_payload.ptr.cast::<u8>() as *const u8,
    ...
    pub unsafe fn cuda_sparse_mla_bf16_softmax_async(
        ...
        let context = "ds4rt_cuda_sparse_mla_bf16_softmax_async";
        ...
        let kernel_fn: Symbol<CudaSparseMlaBf16SoftmaxAsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_sparse_mla_bf16_softmax_async")? };
        let status = unsafe {
            kernel_fn(
                scores.ptr.cast::<u16>(),
                topk_lengths.ptr.cast::<i32>() as *const i32,
    ...
    pub unsafe fn cuda_sparse_mla_nvfp4_gather_fp8_async(
        &self,
        nvfp4_kv: Ds4rtDeviceBuffer,
        selected_indices: Ds4rtDeviceBuffer,
        topk_lengths: Ds4rtDeviceBuffer,
        fp8_kv: Ds4rtDeviceBuffer,
        fp8_indices: Ds4rtDeviceBuffer,
        query_rows: usize,
        selected_index_stride: usize,
        staged_topk: usize,
        nvfp4_row_stride_bytes: usize,
        ...
        let context = "ds4rt_cuda_sparse_mla_nvfp4_gather_fp8_async";
        if query_rows == 0
        ...
        let kernel_fn: Symbol<CudaSparseMlaNvfp4GatherFp8AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_sparse_mla_nvfp4_gather_fp8_async")?
        };
        let status = unsafe {
            kernel_fn(
    ...
    pub unsafe fn cuda_mla_nvfp4_expand_fp8_paged_async(
        ...
        const NVFP4_ROW_BYTES: usize = DS4RT_CUDA_MLA_MXFP4_DS_PACKED_BYTES;
        const FP8_ROW_BYTES: usize = 656;
        let context = "ds4rt_cuda_mla_nvfp4_expand_fp8_paged_async";
        if max_tokens == 0
            || page_size == 0
        ...
        let kernel_fn: Symbol<CudaMlaNvfp4ExpandFp8PagedAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_mla_nvfp4_expand_fp8_paged_async")?
        };
        let status = unsafe {
            kernel_fn(
                nvfp4_kv.ptr.cast::<u8>() as *const u8,
    ...
    pub fn cuda_embedding_lookup_f32(
        ...
        let kernel_fn: Symbol<CudaEmbeddingLookupF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_embedding_lookup_f32")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_embedding_lookup_f32", status)
    }
    ...
    pub unsafe fn cuda_embedding_lookup_f32_async(
        ...
        validate_embedding_lookup_buffers(
            "ds4rt_cuda_embedding_lookup_f32_async",
            embedding,
            token_ids,
            out,
            rows,
        ...
        let kernel_fn: Symbol<CudaEmbeddingLookupF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_embedding_lookup_f32_async")? };
        let status = unsafe {
            kernel_fn(
                embedding.ptr.cast::<f32>() as *const f32,
                token_ids.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_embedding_lookup_f32_async", status)
    }
    ...
    pub fn cuda_embedding_lookup_bf16(
        ...
        let kernel_fn: Symbol<CudaEmbeddingLookupBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_embedding_lookup_bf16")? };
        let status = unsafe {
            kernel_fn(
                embedding.ptr.cast::<u16>() as *const u16,
                token_ids.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_embedding_lookup_bf16", status)
    }
    ...
    pub unsafe fn cuda_embedding_lookup_bf16_async(
        ...
        validate_embedding_lookup_bf16_buffers(
            "ds4rt_cuda_embedding_lookup_bf16_async",
            embedding,
            token_ids,
            out,
            rows,
        ...
        let kernel_fn: Symbol<CudaEmbeddingLookupBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_embedding_lookup_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                embedding.ptr.cast::<u16>() as *const u16,
                token_ids.ptr.cast::<u32>() as *const u32,
        ...
        self.status_to_result("ds4rt_cuda_embedding_lookup_bf16_async", status)
    }
    ...
    pub fn cuda_lm_head_argmax_bf16(
        ...
        let kernel_fn: Symbol<CudaLmHeadArgmaxBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_lm_head_argmax_bf16")? };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_lm_head_argmax_bf16", status)
    }
    ...
    pub unsafe fn cuda_lm_head_argmax_bf16_async(
        ...
        validate_lm_head_argmax_bf16_buffers(
            "ds4rt_cuda_lm_head_argmax_bf16_async",
            hidden,
            lm_head,
            out_indices,
            out_scores,
        ...
        let kernel_fn: Symbol<CudaLmHeadArgmaxBf16AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_lm_head_argmax_bf16_async")? };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
                lm_head.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_lm_head_argmax_bf16_async", status)
    }
    ...
    pub unsafe fn cuda_dspark_terminal_greedy_bf16_async(
        &self,
        normalized_hidden_by_slot: Ds4rtDeviceBuffer,
        collapsed_hidden_by_slot: Ds4rtDeviceBuffer,
        shared_head: Ds4rtDeviceBuffer,
        markov_w1: Ds4rtDeviceBuffer,
        markov_w2: Ds4rtDeviceBuffer,
        confidence_weight: Ds4rtDeviceBuffer,
        active_slot_ids: Ds4rtDeviceBuffer,
        anchor_token_ids: Ds4rtDeviceBuffer,
        compact_normalized_hidden: Ds4rtDeviceBuffer,
        shared_logits: Ds4rtDeviceBuffer,
        markov_embeddings: Ds4rtDeviceBuffer,
        markov_logits: Ds4rtDeviceBuffer,
        output_token_ids: Ds4rtDeviceBuffer,
        conditional_confidence: Ds4rtDeviceBuffer,
        active_requests: usize,
        max_slots: usize,
        hidden_dim: usize,
        vocab: usize,
        ...
        validate_dspark_terminal_greedy_bf16_buffers(
            "ds4rt_cuda_dspark_terminal_greedy_bf16_async",
        ...
        let kernel_fn: Symbol<CudaDsparkTerminalGreedyBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_dspark_terminal_greedy_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_dspark_terminal_greedy_bf16_async", status)
    }
    ...
    pub fn cuda_lm_head_sample_topk_topp_bf16(
        ...
        let kernel_fn: Symbol<CudaLmHeadSampleTopKToppBf16Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_lm_head_sample_topk_topp_bf16")? };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
                lm_head.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_lm_head_sample_topk_topp_bf16", status)
    }
    ...
    pub unsafe fn cuda_lm_head_sample_topk_topp_bf16_async(
        ...
        validate_lm_head_sample_topk_topp_bf16_buffers(
            "ds4rt_cuda_lm_head_sample_topk_topp_bf16_async",
            hidden,
            lm_head,
            random_uniforms,
            out_indices,
        ...
        let kernel_fn: Symbol<CudaLmHeadSampleTopKToppBf16AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_lm_head_sample_topk_topp_bf16_async")?
        };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_lm_head_sample_topk_topp_bf16_async", status)
    }
    ...
    pub fn cuda_lm_head_argmax_sample_topk_topp_bf16_staged(
        ...
        lm_head: Ds4rtDeviceBuffer,
        random_uniforms: Ds4rtDeviceBuffer,
        out_argmax_indices: Ds4rtDeviceBuffer,
        out_argmax_scores: Ds4rtDeviceBuffer,
        out_sample_indices: Ds4rtDeviceBuffer,
        out_sample_scores: Ds4rtDeviceBuffer,
        logits_workspace: Ds4rtDeviceBuffer,
        rows: usize,
        hidden_dim: usize,
        vocab: usize,
        temperature: f32,
        ...
        validate_lm_head_argmax_sample_topk_topp_bf16_staged_buffers(
            "ds4rt_cuda_lm_head_argmax_sample_topk_topp_bf16_staged",
            hidden,
            lm_head,
            random_uniforms,
            out_argmax_indices,
        ...
        let kernel_fn: Symbol<CudaLmHeadArgmaxSampleTopKToppBf16StagedFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_lm_head_argmax_sample_topk_topp_bf16_staged")?
        };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
    ...
    pub unsafe fn cuda_lm_head_argmax_sample_topk_topp_bf16_staged_async(
        ...
        validate_lm_head_argmax_sample_topk_topp_bf16_staged_buffers(
            "ds4rt_cuda_lm_head_argmax_sample_topk_topp_bf16_staged_async",
            hidden,
            lm_head,
            random_uniforms,
            out_argmax_indices,
        ...
        let kernel_fn: Symbol<CudaLmHeadArgmaxSampleTopKToppBf16StagedAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_lm_head_argmax_sample_topk_topp_bf16_staged_async")?
        };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
    ...
    pub fn cuda_lm_head_sample_topk_topp_bf16_cub(
        ...
        random_uniforms: Ds4rtDeviceBuffer,
        logits_workspace: Ds4rtDeviceBuffer,
        sorted_logits: Ds4rtDeviceBuffer,
        unsorted_indices: Ds4rtDeviceBuffer,
        sorted_indices: Ds4rtDeviceBuffer,
        segment_offsets: Ds4rtDeviceBuffer,
        out_indices: Ds4rtDeviceBuffer,
        ...
        validate_lm_head_sample_topk_topp_bf16_cub_buffers(
            "ds4rt_cuda_lm_head_sample_topk_topp_bf16_cub",
            hidden,
            lm_head,
            random_uniforms,
            logits_workspace,
        ...
        let kernel_fn: Symbol<CudaLmHeadSampleTopKToppBf16CubFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_lm_head_sample_topk_topp_bf16_cub")?
        };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_lm_head_sample_topk_topp_bf16_cub", status)
    }
    ...
    pub unsafe fn cuda_lm_head_sample_topk_topp_bf16_cub_async(
        ...
        validate_lm_head_sample_topk_topp_bf16_cub_buffers(
            "ds4rt_cuda_lm_head_sample_topk_topp_bf16_cub_async",
            hidden,
            lm_head,
            random_uniforms,
            logits_workspace,
        ...
        let kernel_fn: Symbol<CudaLmHeadSampleTopKToppBf16CubAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_lm_head_sample_topk_topp_bf16_cub_async")?
        };
        let status = unsafe {
            kernel_fn(
                hidden.ptr.cast::<u16>() as *const u16,
        ...
        self.status_to_result("ds4rt_cuda_lm_head_sample_topk_topp_bf16_cub_async", status)
    }

    pub fn cuda_logits_argmax_f32(
        &self,
        logits: Ds4rtDeviceBuffer,
        out_indices: Ds4rtDeviceBuffer,
        out_scores: Ds4rtDeviceBuffer,
        rows: usize,
        vocab: usize,
        ...
        let kernel_fn: Symbol<CudaLogitsArgmaxF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_logits_argmax_f32")? };
        let status = unsafe {
            kernel_fn(
        ...
        self.status_to_result("ds4rt_cuda_logits_argmax_f32", status)
    }
    ...
    pub unsafe fn cuda_logits_argmax_f32_async(
        ...
        validate_logits_argmax_buffers(
            "ds4rt_cuda_logits_argmax_f32_async",
            logits,
            out_indices,
            out_scores,
            rows,
        ...
        let kernel_fn: Symbol<CudaLogitsArgmaxF32AsyncFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_logits_argmax_f32_async")? };
        let status = unsafe {
            kernel_fn(
                logits.ptr.cast::<f32>() as *const f32,
                out_indices.ptr.cast::<u32>(),
        ...
        self.status_to_result("ds4rt_cuda_logits_argmax_f32_async", status)
    }
    ...
    pub fn cuda_logits_sample_topk_topp_f32(
        ...
        let kernel_fn: Symbol<CudaLogitsSampleTopKToppF32Fn> =
            unsafe { self.lib.get(b"ds4rt_cuda_logits_sample_topk_topp_f32")? };
        let status = unsafe {
            kernel_fn(
                logits.ptr.cast::<f32>() as *const f32,
                random_uniforms.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_logits_sample_topk_topp_f32", status)
    }
    ...
    pub fn cuda_logits_sample_topk_topp_f32_cub(
        ...
        validate_logits_sample_topk_topp_cub_buffers(
            "ds4rt_cuda_logits_sample_topk_topp_f32_cub",
            logits,
            random_uniforms,
            sorted_logits,
            unsorted_indices,
        ...
        let kernel_fn: Symbol<CudaLogitsSampleTopKToppF32CubFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_logits_sample_topk_topp_f32_cub")?
        };
        let status = unsafe {
            kernel_fn(
                logits.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_logits_sample_topk_topp_f32_cub", status)
    }
    ...
    pub unsafe fn cuda_logits_sample_topk_topp_f32_cub_async(
        ...
        validate_logits_sample_topk_topp_cub_buffers(
            "ds4rt_cuda_logits_sample_topk_topp_f32_cub_async",
            logits,
            random_uniforms,
            sorted_logits,
            unsorted_indices,
        ...
        let kernel_fn: Symbol<CudaLogitsSampleTopKToppF32CubAsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_logits_sample_topk_topp_f32_cub_async")?
        };
        let status = unsafe {
            kernel_fn(
                logits.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_logits_sample_topk_topp_f32_cub_async", status)
    }
    ...
    pub unsafe fn cuda_logits_sample_topk_topp_f32_async(
        ...
        let kernel_fn: Symbol<CudaLogitsSampleTopKToppF32AsyncFn> = unsafe {
            self.lib
                .get(b"ds4rt_cuda_logits_sample_topk_topp_f32_async")?
        };
        let status = unsafe {
            kernel_fn(
                logits.ptr.cast::<f32>() as *const f32,
        ...
        self.status_to_result("ds4rt_cuda_logits_sample_topk_topp_f32_async", status)
    }

    pub fn cuda_pack_nibbles(
        &self,
        codes: Ds4rtDeviceBuffer,
        packed: Ds4rtDeviceBuffer,
        count: usize,
    ) -> Result<()> {
        let packed_count = count.div_ceil(2);
        if count > 0 {
            validate_device_buffer_bytes("ds4rt_cuda_pack_nibbles codes", codes, count)?;
            validate_device_buffer_bytes("ds4rt_cuda_pack_nibbles packed", packed, packed_count)?;
        }
        let pack_fn: Symbol<CudaPackNibblesFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_pack_nibbles")? };
        let status = unsafe {
            pack_fn(
        ...
        self.status_to_result("ds4rt_cuda_pack_nibbles", status)
    }
    ...
    pub fn cuda_unpack_nibbles(
        ...
        let packed_count = count.div_ceil(2);
        if count > 0 {
            validate_device_buffer_bytes("ds4rt_cuda_unpack_nibbles packed", packed, packed_count)?;
            validate_device_buffer_bytes("ds4rt_cuda_unpack_nibbles codes", codes, count)?;
        }
        let unpack_fn: Symbol<CudaUnpackNibblesFn> =
            unsafe { self.lib.get(b"ds4rt_cuda_unpack_nibbles")? };
        let status = unsafe {
            unpack_fn(
                packed.ptr.cast::<u8>() as *const u8,
                codes.ptr.cast::<u8>(),
        ...
        self.status_to_result("ds4rt_cuda_unpack_nibbles", status)
    }

    pub fn rdma_device_info(&self) -> Result<Ds4rtRdmaDeviceInfo> {
        let info_fn: Symbol<RdmaDeviceInfoFn> = unsafe { self.lib.get(b"ds4rt_rdma_device_info")? };
        let mut info = Ds4rtRdmaDeviceInfo::default();
        let status = unsafe { info_fn(&mut info) };
        self.status_to_result("ds4rt_rdma_device_info", status)?;
        Ok(info)
    }
    ...
    pub fn rdma_plan_host_buffer_registration(
        ...
        bytes: usize,
        alignment: usize,
    ) -> Result<Ds4rtRdmaHostBufferPlan> {
        let plan_fn: Symbol<RdmaPlanHostBufferRegistrationFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_plan_host_buffer_registration")? };
        let mut plan = Ds4rtRdmaHostBufferPlan::default();
        let status = unsafe { plan_fn(ptr, bytes, alignment, &mut plan) };
        self.status_to_result("ds4rt_rdma_plan_host_buffer_registration", status)?;
        Ok(plan)
    }
    ...
    pub fn rdma_register_host_buffer_probe(
        &self,
        buffer: &mut [u8],
    ) -> Result<Ds4rtRdmaRegisterProbe> {
        let register_fn: Symbol<RdmaRegisterHostBufferProbeFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_register_host_buffer_probe")? };
        let mut probe = Ds4rtRdmaRegisterProbe::default();
        let status = unsafe { register_fn(buffer.as_mut_ptr().cast(), buffer.len(), &mut probe) };
        self.status_to_result("ds4rt_rdma_register_host_buffer_probe", status)?;
        Ok(probe)
    }
    ...
    pub fn rdma_create_rc_qp_probe(
        ...
        recv_wr: u32,
        max_sge: u32,
    ) -> Result<Ds4rtRdmaRcQpProbe> {
        let qp_fn: Symbol<RdmaCreateRcQpProbeFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_create_rc_qp_probe")? };
        let mut probe = Ds4rtRdmaRcQpProbe::default();
        let status = unsafe { qp_fn(port_num, send_wr, recv_wr, max_sge, &mut probe) };
        self.status_to_result("ds4rt_rdma_create_rc_qp_probe", status)?;
        Ok(probe)
    }
    ...
    pub fn rdma_rc_send_recv_loopback_probe(
        ...
        port_num: u32,
        bytes: usize,
    ) -> Result<Ds4rtRdmaRcSendRecvProbe> {
        let probe_fn: Symbol<RdmaRcSendRecvLoopbackProbeFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_send_recv_loopback_probe")? };
        let mut probe = Ds4rtRdmaRcSendRecvProbe::default();
        let status = unsafe { probe_fn(port_num, bytes, &mut probe) };
        self.status_to_result("ds4rt_rdma_rc_send_recv_loopback_probe", status)?;
        Ok(probe)
    }
    ...
    pub fn rdma_rc_protocol_v2_loopback_probe(
        ...
        request_frame: &[u8],
        response_frame: &[u8],
    ) -> Result<Ds4rtRdmaRcProtocolV2LoopbackProbe> {
        let probe_fn: Symbol<RdmaRcProtocolV2LoopbackProbeFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_protocol_v2_loopback_probe")? };
        let mut probe = Ds4rtRdmaRcProtocolV2LoopbackProbe::default();
        let status = unsafe {
            probe_fn(
                port_num,
        ...
        self.status_to_result("ds4rt_rdma_rc_protocol_v2_loopback_probe", status)?;
        Ok(probe)
    }
    ...
    pub fn rdma_rc_endpoint_create(
        ...
        max_recv_wr: u32,
        max_sge: u32,
    ) -> Result<Ds4rtRdmaRcEndpointInfo> {
        let create_fn: Symbol<RdmaRcEndpointCreateFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_create")? };
        let mut info = Ds4rtRdmaRcEndpointInfo::default();
        let status = unsafe {
            create_fn(
                port_num,
                local_psn,
        ...
        self.status_to_result("ds4rt_rdma_rc_endpoint_create", status)?;
        Ok(info)
    }
    ...
    pub fn rdma_rc_endpoint_create_with_buffer_flags(
        ...
        let create_fn: Symbol<RdmaRcEndpointCreateWithBufferFlagsFn> = unsafe {
            self.lib
                .get(b"ds4rt_rdma_rc_endpoint_create_with_buffer_flags")?
        };
        let mut info = Ds4rtRdmaRcEndpointInfo::default();
        let status = unsafe {
            create_fn(
        ...
        self.status_to_result("ds4rt_rdma_rc_endpoint_create_with_buffer_flags", status)?;
        Ok(info)
    }
    ...
    pub fn rdma_rc_endpoint_create_on_device_with_buffer_flags(
        ...
        let create_fn: Symbol<RdmaRcEndpointCreateOnDeviceWithBufferFlagsFn> = unsafe {
            self.lib
                .get(b"ds4rt_rdma_rc_endpoint_create_on_device_with_buffer_flags")?
        };
        ...
        self.status_to_result(
            "ds4rt_rdma_rc_endpoint_create_on_device_with_buffer_flags",
            status,
        )?;
        Ok(info)
    }
    ...
    pub fn rdma_rc_endpoint_buffer_view(
        ...
        handle: *mut c_void,
        receive_buffer: bool,
    ) -> Result<Ds4rtRdmaRcEndpointBufferView> {
        let view_fn: Symbol<RdmaRcEndpointBufferViewFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_buffer_view")? };
        let mut view = Ds4rtRdmaRcEndpointBufferView::default();
        let status = unsafe { view_fn(handle, c_int::from(receive_buffer), &mut view) };
        self.status_to_result("ds4rt_rdma_rc_endpoint_buffer_view", status)?;
        Ok(view)
    }
    ...
    pub fn rdma_rc_endpoint_connect(
        ...
        let connect_fn: Symbol<RdmaRcEndpointConnectFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_connect")? };
        let remote_gid_hex =
        ...
        self.status_to_result("ds4rt_rdma_rc_endpoint_connect", status)
    }
    ...
    pub fn rdma_rc_endpoint_post_recv(
        ...
        let recv_fn: Symbol<RdmaRcEndpointPostRecvFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_post_recv")? };
        let status = unsafe { recv_fn(handle, bytes, wr_id) };
        self.status_to_result("ds4rt_rdma_rc_endpoint_post_recv", status)
    }
    ...
    pub fn rdma_rc_endpoint_post_recv_at(
        ...
        let recv_fn: Symbol<RdmaRcEndpointPostRecvAtFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_post_recv_at")? };
        let status = unsafe { recv_fn(handle, offset_bytes, bytes, wr_id) };
        self.status_to_result("ds4rt_rdma_rc_endpoint_post_recv_at", status)
    }
    ...
    pub fn rdma_rc_endpoint_post_send_at(
        ...
        let send_fn: Symbol<RdmaRcEndpointPostSendAtFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_post_send_at")? };
        let status = unsafe { send_fn(handle, offset_bytes, bytes, wr_id) };
        self.status_to_result("ds4rt_rdma_rc_endpoint_post_send_at", status)
    }
    ...
    pub fn rdma_rc_endpoint_send(
        ...
        let send_fn: Symbol<RdmaRcEndpointSendFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_send")? };
        let status = unsafe { send_fn(handle, frame.as_ptr().cast(), frame.len(), wr_id) };
        self.status_to_result("ds4rt_rdma_rc_endpoint_send", status)
    }
    ...
    pub fn rdma_rc_endpoint_send_at(
        ...
        let send_fn: Symbol<RdmaRcEndpointSendAtFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_send_at")? };
        let status = unsafe {
            send_fn(
                handle,
                frame.as_ptr().cast(),
        ...
        self.status_to_result("ds4rt_rdma_rc_endpoint_send_at", status)
    }
    ...
    pub fn rdma_rc_endpoint_send_parts_at(
        ...
        let send_fn: Symbol<RdmaRcEndpointSendPartsAtFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_send_parts_at")? };
        let status = unsafe {
            send_fn(
                handle,
                prefix.as_ptr().cast(),
        ...
        self.status_to_result("ds4rt_rdma_rc_endpoint_send_parts_at", status)
    }
    ...
    pub fn rdma_rc_endpoint_poll(
        ...
        max_poll_iterations: u32,
        active_event_poll_timeout_ms: u32,
    ) -> Result<Ds4rtRdmaRcCompletionStats> {
        let mut stats = Ds4rtRdmaRcCompletionStats::default();
        if let Ok(poll_fn) = unsafe {
            self.lib
                .get::<RdmaRcEndpointPollWithTimeoutFn>(b"ds4rt_rdma_rc_endpoint_poll_with_timeout")
        } {
            let status = unsafe {
                poll_fn(
                    handle,
            ...
            self.status_to_result("ds4rt_rdma_rc_endpoint_poll_with_timeout", status)?;
        } else {
            let poll_fn: Symbol<RdmaRcEndpointPollFn> =
                unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_poll")? };
            let status = unsafe {
                poll_fn(
                    handle,
                    expected_send_completions,
            ...
            self.status_to_result("ds4rt_rdma_rc_endpoint_poll", status)?;
        }
        Ok(stats)
    }
    ...
    pub fn rdma_rc_endpoint_try_poll(
        ...
        self.status_to_result("ds4rt_rdma_rc_endpoint_try_poll", status)?;
        Ok(stats)
    }
    ...
    pub fn rdma_rc_endpoint_copy_recv(
        ...
        let copy_fn: Symbol<RdmaRcEndpointCopyRecvFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_copy_recv")? };
        let status = unsafe { copy_fn(handle, out.as_mut_ptr().cast(), out.len(), bytes) };
        self.status_to_result("ds4rt_rdma_rc_endpoint_copy_recv", status)
    }
    ...
    pub fn rdma_rc_endpoint_copy_recv_at(
        ...
        let copy_fn: Symbol<RdmaRcEndpointCopyRecvAtFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_copy_recv_at")? };
        let status = unsafe {
            copy_fn(
                handle,
                out.as_mut_ptr().cast(),
        ...
        self.status_to_result("ds4rt_rdma_rc_endpoint_copy_recv_at", status)
    }

    pub fn rdma_rc_endpoint_destroy(&self, handle: *mut c_void) -> Result<()> {
        let destroy_fn: Symbol<RdmaRcEndpointDestroyFn> =
            unsafe { self.lib.get(b"ds4rt_rdma_rc_endpoint_destroy")? };
        let status = unsafe { destroy_fn(handle) };
        self.status_to_result("ds4rt_rdma_rc_endpoint_destroy", status)
    }

    pub fn last_error(&self) -> Result<String> {
        let last_error_fn: Symbol<LastErrorFn> = unsafe { self.lib.get(b"ds4rt_last_error")? };
        let mut buf = vec![0 as c_char; 512];
        let status = unsafe { last_error_fn(buf.as_mut_ptr(), buf.len()) };
        if status != DS4RT_STATUS_OK {
            anyhow::bail!("ds4rt_last_error returned status {status}");
        }
        let cstr = unsafe { CStr::from_ptr(buf.as_ptr()) };
        Ok(cstr.to_string_lossy().into_owned())
    }

    fn status_to_result(&self, context: &str, status: Ds4rtStatus) -> Result<()> {
        if status == DS4RT_STATUS_OK {
            return Ok(());
        }
        let last_error = self
...
fn validate_route_shard_reduction_buffers(
    ...
    let minimum_peer_stride = match peer_dtype {
        DS4RT_ROUTE_SHARD_WIRE_BF16 => row_width
            .checked_mul(std::mem::size_of::<u16>())
            .with_context(|| format!("{context} BF16 row byte count overflows usize"))?,
        DS4RT_ROUTE_SHARD_WIRE_FP8_E4M3_ROW_SCALED => {
...
fn validate_generic_kv_page_table_expand_indices_buffers(
    ...
    let physical_page_count = active_tokens
        ...
        / DS4RT_CUDA_GENERIC_KV_PAGE_SIZE;
    validate_device_buffer_bytes(
...
fn validate_mla_kv_mxfp4_ds_mla_strides(
    ...
    if packed_stride_bytes < DS4RT_CUDA_MLA_MXFP4_DS_PACKED_BYTES {
        anyhow::bail!(
            "{context} packed_stride_bytes must be at least {}, got {packed_stride_bytes}",
            DS4RT_CUDA_MLA_MXFP4_DS_PACKED_BYTES
        );
    }
    let projected_stride_values = projected_stride_bytes / std::mem::size_of::<u16>();
    if projected_stride_values < DS4RT_CUDA_MLA_MXFP4_DS_PROJECTED_VALUES {
        anyhow::bail!(
            "{context} projected_stride_bytes must hold at least {} BF16 values, got {projected_stride_values}",
            DS4RT_CUDA_MLA_MXFP4_DS_PROJECTED_VALUES
        );
    }
    Ok(())
}
...
fn validate_router_topk_buffers(
    ...
    if top_k == 0 || top_k > experts || top_k > DS4RT_CUDA_ROUTER_TOPK_MAX_K {
        anyhow::bail!(
            "{context} top_k must be in 1..=min(experts, {DS4RT_CUDA_ROUTER_TOPK_MAX_K}), got top_k={top_k} experts={experts}"
        );
    }
...
fn validate_nvfp4_route_bf16_batched_staged_accumulate_f32_buffers(
    ...
    let route_metadata_bytes = routes
        .checked_mul(std::mem::size_of::<Ds4rtNvfp4RouteBatchedMetadata>())
...
fn validate_logits_sample_topk_topp_buffers(
    ...
    if top_k == 0 || top_k > vocab || top_k > DS4RT_CUDA_SAMPLE_TOPK_MAX_K {
        anyhow::bail!(
            "{context} top_k must be in 1..=min(vocab, {DS4RT_CUDA_SAMPLE_TOPK_MAX_K}), got top_k={top_k} vocab={vocab}"
        );
    }
    if !temperature.is_finite() || temperature <= 0.0 {
        anyhow::bail!("{context} temperature must be finite and positive");
...
fn validate_device_buffer_present(context: &str, buffer: Ds4rtDeviceBuffer) -> Result<()> {
    if buffer.ptr.is_null() {
        anyhow::bail!("{context} buffer pointer is null");
    }
    if buffer.bytes == 0 {
...
mod tests {
    ...
    fn native_library_path() -> Option<PathBuf> {
        if let Ok(path) = env::var("DS4RT_NATIVE_LIB") {
            return Some(PathBuf::from(path));
        }
        if env::var_os("DS4RT_DISABLE_NATIVE_AUTO_DISCOVERY").is_some() {
            return None;
        }
        let path = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
            .join("../../..")
            .join("native/build/libds4rt_native.so");
        path.exists().then_some(path)
    }

    fn load_test_library() -> Result<Option<NativeLibrary>> {
        let Some(path) = native_library_path() else {
            eprintln!("skipping native FFI test because native/build/libds4rt_native.so is absent");
            return Ok(None);
        };
    ...
    fn synthetic_device_buffer(address: usize, bytes: usize) -> Ds4rtDeviceBuffer {
        Ds4rtDeviceBuffer {
    ...
    fn protocol_v2_frame(kind: u16, payload_bytes: usize) -> Vec<u8> {
        ...
        frame[..8].copy_from_slice(b"DS4RTE2\0");
    ...
    fn nvfp4_route_metadata_bytes(values: &[Ds4rtNvfp4RouteBatchedMetadata]) -> &[u8] {
        unsafe { slice::from_raw_parts(values.as_ptr().cast(), std::mem::size_of_val(values)) }
    }
    ...
    fn bytes_to_bf16_summary(bytes: &[u8]) -> Ds4rtBf16Summary {
        assert_eq!(bytes.len(), std::mem::size_of::<Ds4rtBf16Summary>());
        Ds4rtBf16Summary {
    ...
    fn assert_cuda_unavailable(err: anyhow::Error) {
        ...
        assert!(
            err.contains(&format!("status {DS4RT_STATUS_CUDA_UNAVAILABLE}")),
            "{err}"
        );
    ...
    fn native_version_call() -> Result<()> {
        ...
        assert!(version.contains("ds4rt_native"));
        Ok(())
    }
    ...
    fn allocate_copy_free_roundtrip() -> Result<()> {
        ...
        let input = b"ds4rt native ffi roundtrip".to_vec();
    ...
    fn managed_device_buffer_copy_free_roundtrip() -> Result<()> {
        ...
        let input = b"ds4rt managed native ffi roundtrip".to_vec();
        let mut output = vec![0_u8; input.len()];
        let mut buffer = library.alloc_managed_device_buffer(input.len())?;

        assert!(!buffer.ptr.is_null());
        assert!(buffer.bytes >= input.len());
        assert_ne!(buffer.flags & DS4RT_DEVICE_BUFFER_FLAG_MANAGED, 0);
        library.copy_h2d(buffer, &input)?;
        library.copy_d2h(&mut output, buffer)?;
        assert_eq!(output, input);
    ...
    fn copy_h2d_reuses_synchronous_pinned_staging() -> Result<()> {
        ...
        let first = b"ds4rt native ffi reusable sync h2d staging".to_vec();
    ...
    fn device_to_device_copy_roundtrip() -> Result<()> {
        ...
        let input = b"ds4rt native ffi d2d roundtrip".to_vec();
        let mut output = vec![0_u8; input.len()];
    ...
    fn pinned_host_buffer_copy_roundtrip() -> Result<()> {
        ...
        let input = b"ds4rt pinned staging ffi roundtrip".to_vec();
        let mut output = vec![0_u8; input.len()];
        let mut host = library.alloc_host_buffer(input.len())?;
        assert!(!host.ptr.is_null());
        assert_eq!(host.bytes, input.len());
        assert_ne!(host.flags, DS4RT_HOST_BUFFER_FLAG_NONE);
        assert_ne!(host.flags & DS4RT_HOST_BUFFER_FLAG_PINNED, 0);
        assert_ne!(host.flags & DS4RT_HOST_BUFFER_FLAG_MAPPED, 0);
        unsafe {
        ...
        assert_ne!(alias.flags & DS4RT_DEVICE_BUFFER_FLAG_MAPPED_HOST, 0);
        unsafe {
        ...
        assert_eq!(host.flags, DS4RT_HOST_BUFFER_FLAG_NONE);
        Ok(())
    }
    ...
    fn async_device_to_device_copy_roundtrip() -> Result<()> {
        ...
        let input = b"ds4rt native ffi async d2d roundtrip".to_vec();
        let mut output = vec![0_u8; input.len()];
        let mut src = library.alloc_device_buffer(input.len())?;
        let mut dst = library.alloc_device_buffer(input.len())?;
    ...
    fn stream_and_async_copy_ffi_binding_reports_or_executes() -> Result<()> {
        ...
        let info = library.cuda_device_info(0)?;
        let input = b"ds4rt native ffi async copy roundtrip".to_vec();
        let mut output = vec![0_u8; input.len()];
        let mut buffer = library.alloc_device_buffer(input.len())?;
        let stream_result = library.cuda_stream_create();
        let cuda_stream = match stream_result {
    ...
    fn cuda_nvfp4_route_bf16_staged_ffi_binding_reports_or_executes() -> Result<()> {
        ...
        let mut route_metadata = [Ds4rtNvfp4RouteBatchedMetadata::default()];
        ...
        route_metadata[0] = Ds4rtNvfp4RouteBatchedMetadata {
    ...
    fn cuda_summarize_bf16_kernel_ffi_binding_reports_or_executes() -> Result<()> {
        ...
        let mut summary_buffer =
            library.alloc_device_buffer(std::mem::size_of::<Ds4rtBf16Summary>())?;
        ...
        match library.cuda_summarize_bf16(input_buffer, values.len()) {
            Ok(summary) => {
                ...
                let mut summary_bytes = vec![0_u8; std::mem::size_of::<Ds4rtBf16Summary>()];
    ...
    fn cuda_route_shard_reduction_supports_all_wire_codecs_in_place() -> Result<()> {
        ...
        for (dtype, stride, tolerance) in [
            (DS4RT_ROUTE_SHARD_WIRE_BF16, bf16_stride, 1.0e-6_f32),
            (
                DS4RT_ROUTE_SHARD_WIRE_FP8_E4M3_ROW_SCALED,
                fp8_stride,
                5.0e-2_f32,
            ...
            for local_dtype in [DS4RT_ROUTE_SHARD_LOCAL_F32, DS4RT_ROUTE_SHARD_LOCAL_BF16] {
                library.copy_h2d(local_f32, f32_bytes(&local_values))?;
                let (local, output) = if local_dtype == DS4RT_ROUTE_SHARD_LOCAL_F32 {
                    (local_f32, local_f32)
                } else {
                ...
                library.cuda_reduce_route_shards_to_f32(
                    &Ds4rtRouteShardReductionBuffers {
                        local,
                        peers: [peer; 3],
                        output_f32: output,
                    },
        ...
        let expected_expanded_row = (0..expanded_width)
            .map(|logical_token| {
                if logical_token >= expanded_active_tokens {
                    ...
                    let page = physical_pages[logical_token / DS4RT_CUDA_GENERIC_KV_PAGE_SIZE];
                    (page as usize * DS4RT_CUDA_GENERIC_KV_PAGE_SIZE
                        + logical_token % DS4RT_CUDA_GENERIC_KV_PAGE_SIZE)
                        as i32
                }
            })
            .collect::<Vec<_>>();
    ...
    fn cuda_sparse_mla_nvfp4_reads_selected_compressed_rows_directly() -> Result<()> {
        ...
        const ROW_BYTES: usize = DS4RT_CUDA_MLA_MXFP4_DS_PACKED_BYTES;
    ...
    fn cuda_sparse_mla_nvfp4_gather_fp8_compacts_selected_rows() -> Result<()> {
        ...
        const FP8_ROW_BYTES: usize = 656;
        const RANK: usize = 512;
        const ROPE_OFFSET: usize = RANK / 2 + RANK / 16 + DS4RT_CUDA_MLA_MXFP4_DS_PADDING_BYTES;
    ...
    fn cuda_mla_kv_fp8_ds_pack_roundtrip_ffi_binding_reports_or_executes() -> Result<()> {
        ...
        let assert_roundtrip = |packed_bytes: &[u8], unpacked_bytes: &[u8]| {
            ...
            let scale_offset = DS4RT_CUDA_MLA_FP8_DS_NOPE_VALUES;
            let rope_offset = scale_offset + DS4RT_CUDA_MLA_FP8_DS_SCALE_BYTES;
            for row in 0..rows {
                ...
                assert!(packed_bytes[packed_row + scale_offset
                    ..packed_row + scale_offset + DS4RT_CUDA_MLA_FP8_DS_SCALE_BYTES]
                    .iter()
                    .any(|byte| *byte != 0));
                assert_eq!(
                    &packed_bytes[packed_row + rope_offset
                        ..packed_row + rope_offset + DS4RT_CUDA_MLA_FP8_DS_ROPE_VALUES * 2],
                    u16_bytes(
                        &projected[projected_row + DS4RT_CUDA_MLA_FP8_DS_NOPE_VALUES
                            ..projected_row + projected_stride_values]
                    )
                );
                assert_eq!(
                    &unpacked[projected_row + DS4RT_CUDA_MLA_FP8_DS_NOPE_VALUES
                        ..projected_row + projected_stride_values],
                    &projected[projected_row + DS4RT_CUDA_MLA_FP8_DS_NOPE_VALUES
                        ..projected_row + projected_stride_values]
                );
                for col in 0..DS4RT_CUDA_MLA_FP8_DS_NOPE_VALUES {
    ...
    fn cuda_mla_kv_mxfp4_ds_pack_roundtrip_ffi_binding_reports_or_executes() -> Result<()> {
        ...
        let info = library.cuda_device_info(0)?;
        let rows = 2;
        let projected_stride_values = DS4RT_CUDA_MLA_MXFP4_DS_PROJECTED_VALUES;
        let projected_stride_bytes = projected_stride_values * std::mem::size_of::<u16>();
        let packed_stride_bytes = DS4RT_CUDA_MLA_MXFP4_DS_PACKED_BYTES;
        let codebook = [
        ...
        for row in 0..rows {
            projected_f32.extend(
                (0..DS4RT_CUDA_MLA_MXFP4_DS_NOPE_VALUES)
                    .map(|index| codebook[(row + index) % codebook.len()]),
            );
            projected_f32.extend(
                (0..DS4RT_CUDA_MLA_MXFP4_DS_ROPE_VALUES)
                    .map(|index| ((row * 13 + index % 29) as f32 - 14.0) / 64.0),
            );
        }
        let projected = bf16_values(&projected_f32);
        ...
        let assert_roundtrip = |packed_bytes: &[u8], unpacked_bytes: &[u8]| {
            let unpacked = bytes_to_u16_vec(unpacked_bytes);
            let scale_offset = DS4RT_CUDA_MLA_MXFP4_DS_CODE_BYTES;
            let padding_offset = scale_offset + DS4RT_CUDA_MLA_MXFP4_DS_SCALE_BYTES;
            let rope_offset = padding_offset + DS4RT_CUDA_MLA_MXFP4_DS_PADDING_BYTES;
            for row in 0..rows {
                let projected_row = row * projected_stride_values;
                let packed_row = row * packed_stride_bytes;
                assert!(
                    packed_bytes[packed_row..packed_row + DS4RT_CUDA_MLA_MXFP4_DS_CODE_BYTES]
                        .iter()
                        .any(|byte| *byte != 0)
                );
                assert!(
                ...
                assert_eq!(
                    &packed_bytes[packed_row + rope_offset
                        ..packed_row + rope_offset + DS4RT_CUDA_MLA_MXFP4_DS_ROPE_VALUES * 2],
                    u16_bytes(
                        &projected[projected_row + DS4RT_CUDA_MLA_MXFP4_DS_NOPE_VALUES
                            ..projected_row + projected_stride_values]
                    )
                );
                assert_eq!(
    ...
    fn rdma_register_host_buffer_probe_reports_capability() -> Result<()> {
        ...
        match library.rdma_register_host_buffer_probe(&mut input) {
            ...
            Err(err) => {
                let err = err.to_string();
                assert!(
                    err.contains(&format!("status {DS4RT_STATUS_RDMA_UNAVAILABLE}")),
                    "{err}"
                );
