...
use ds41rt_ffi::{
    Ds41rtDeviceBuffer, Ds41rtRouteShardReductionBuffers, NativeLibrary,
    DS41RT_ROUTE_SHARD_LOCAL_BF16, DS41RT_ROUTE_SHARD_WIRE_BF16,
    DS41RT_ROUTE_SHARD_WIRE_FP8_E4M3_ROW_SCALED, DS41RT_ROUTE_SHARD_WIRE_NVFP4_E2M1_FP8_E4M3,
};
...
fn reduction_buffers(
    ...
    Ok(Ds41rtRouteShardReductionBuffers {
        local: local_bf16,
        peers,
        output_f32,
    })
...
fn pack_reduction_payload(
    ...
    unsafe {
        ...
        match codec.wire_dtype {
            ...
            DS41RT_ROUTE_SHARD_WIRE_FP8_E4M3_ROW_SCALED => native
            ...
            DS41RT_ROUTE_SHARD_WIRE_NVFP4_E2M1_FP8_E4M3 => native
...
fn reduction_codec(codec: &str, row_width: usize) -> Result<ReductionCodec> {
    match codec {
        "bf16" => Ok(ReductionCodec {
            wire_dtype: DS41RT_ROUTE_SHARD_WIRE_BF16,
        ...
        "fp8" => {
            ...
            Ok(ReductionCodec {
                wire_dtype: DS41RT_ROUTE_SHARD_WIRE_FP8_E4M3_ROW_SCALED,
                row_stride_bytes: row_width
        ...
        "nvfp4" => {
            ...
            Ok(ReductionCodec {
                wire_dtype: DS41RT_ROUTE_SHARD_WIRE_NVFP4_E2M1_FP8_E4M3,
...
fn load_native_library(path: Option<&Path>) -> Result<NativeLibrary> {
    let path = path
        ...
        .context("RDMA reduction requires --native-lib or DS41RT_NATIVE_LIB")?;
