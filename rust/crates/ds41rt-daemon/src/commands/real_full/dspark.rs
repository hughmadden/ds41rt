...
use ds41rt_loader::validate_native_deepseek_v4_dspark_catalog;
...
/// changes. Run with `DS41RT_REAL_FULL_DSPARK_PROFILE_AT_STARTUP=1` for a raw
...
mod tests {
    ...
    fn pro_execution_plan_uses_model_taps_and_strict_tp4() {
        ...
        facts.variant = ds41rt_core::ModelVariant::Pro;
        facts.hidden_size = ds41rt_core::DS4_PRO_HIDDEN_SIZE;
        facts.num_hidden_layers = ds41rt_core::DS4_PRO_NUM_HIDDEN_LAYERS;
        facts.routed_experts = ds41rt_core::DS4_PRO_ROUTED_EXPERTS;
        facts.moe_intermediate_size = ds41rt_core::DS4_PRO_MOE_INTERMEDIATE_SIZE;
        ...
        assert_eq!(plan.hidden_size, ds41rt_core::DS4_PRO_HIDDEN_SIZE);
        assert_eq!(
            plan.expert_topology,
            NativeDsparkExpertTopology::StrictTensorParallel4
        );
