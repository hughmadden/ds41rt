...
use ds41rt_core::{
    ...
    LayerId, LayerWaveMode, COORDINATOR_GRAPH_INSTANCE_COUNT, DS4_FLASH_HIDDEN_SIZE,
    DS4_PRO_HIDDEN_SIZE, GLM52_DSA_INDEX_HEAD_DIM, GLM52_FIRST_K_DENSE_REPLACE,
    ...
    GLM52_NUM_HIDDEN_LAYERS, GLM52_ROUTED_SCALING_FACTOR, GLM52_TOP_K,
};
use ds41rt_ffi::{
...
pub(in crate::commands::real_full) struct MlaDecodeKvDsaProjectionWeights {
    pub(in crate::commands::real_full) wk: Ds41rtDeviceBuffer,
    pub(in crate::commands::real_full) norm_weight: Ds41rtDeviceBuffer,
    pub(in crate::commands::real_full) norm_bias: Ds41rtDeviceBuffer,
}
...
struct MlaDecodeKvCommitBuffers {
    ...
    normalized_hidden: Ds41rtDeviceBuffer,
    kv_a_weight: Ds41rtDeviceBuffer,
    kv_projected: Ds41rtDeviceBuffer,
    positions: Ds41rtDeviceBuffer,
    kv_norm_weight: Ds41rtDeviceBuffer,
    prepared: Ds41rtDeviceBuffer,
    packed: Option<Ds41rtDeviceBuffer>,
    dsa_weights: Option<MlaDecodeKvDsaProjectionWeights>,
    dsa_projected: Option<Ds41rtDeviceBuffer>,
    dsa_normalized: Option<Ds41rtDeviceBuffer>,
}
...
pub(in crate::commands::real_full) fn mla_decode_kv_commit_bf16_device_output(
    ...
    kv_norm_weight: Ds41rtDeviceBuffer,
    dsa_weights: Option<MlaDecodeKvDsaProjectionWeights>,
    cache_row: Ds41rtDeviceBuffer,
    dsa_cache_row: Option<Ds41rtDeviceBuffer>,
    attention_ready_row: Option<Ds41rtDeviceBuffer>,
    ...
    with_coordinator_cuda_graph_slot(&graph_key, |library, slot| {
        ...
        slot.workspace
            ...
            .context("staging decode KV RoPE position")?;
...
struct MlaDecodeQueryProjectionBuffers {
    normalized_hidden: Ds41rtDeviceBuffer,
    q_a_weight: Option<Ds41rtDeviceBuffer>,
    q_a_w8a16: Option<CoordinatorW8a16ProjectionBuffers>,
    q_a_projected: Ds41rtDeviceBuffer,
    q_a_norm_weight: Ds41rtDeviceBuffer,
    q_a_normalized: Ds41rtDeviceBuffer,
    q_b_weight: Option<Ds41rtDeviceBuffer>,
    q_b_w4a16: Option<Ds41rtB12xCoordinatorW4a16Buffers>,
...
struct MlaDecodeQueryDsaProjectionBuffers {
    ...
    weights_proj_weight: Ds41rtDeviceBuffer,
    query_projected: Ds41rtDeviceBuffer,
    weights_projected: Ds41rtDeviceBuffer,
    query_dim: usize,
    heads: usize,
}
...
pub(in crate::commands::real_full) fn mla_decode_query_dsa_projection_bf16_device_outputs(
    ...
    q_b_weight_name: &str,
    q_b_weight: Option<Ds41rtDeviceBuffer>,
    dsa_wq_b_weight: Ds41rtDeviceBuffer,
    dsa_weights_proj_weight: Ds41rtDeviceBuffer,
    rows: usize,
    hidden_dim: usize,
    q_lora_rank: usize,
    q_output_dim: usize,
...
pub(in crate::commands::real_full) fn mla_decode_scalar_q_a_batched_q_b_projection_bf16_device_outputs(
    ...
    q_a_norm_weight: Ds41rtDeviceBuffer,
    q_b_weight_name: &str,
    dsa: Option<(Ds41rtDeviceBuffer, Ds41rtDeviceBuffer, usize, usize)>,
    rows: usize,
    hidden_dim: usize,
    q_lora_rank: usize,
    q_output_dim: usize,
...
pub(in crate::commands::real_full) fn capture_or_update_layer_dense_mlp_bf16_graph(
    ...
    gate_buffer: Ds41rtDeviceBuffer,
    up_buffer: Ds41rtDeviceBuffer,
    down_buffer: Ds41rtDeviceBuffer,
...
pub(in crate::commands::real_full) fn capture_or_update_layer_triton_dense_mlp_bf16_graph(
    ...
    up_buffer: Ds41rtDeviceBuffer,
    down_buffer: Ds41rtDeviceBuffer,
    gate_output_buffer: Ds41rtDeviceBuffer,
    up_output_buffer: Ds41rtDeviceBuffer,
    activation_buffer: Ds41rtDeviceBuffer,
    output_buffer: Ds41rtDeviceBuffer,
    rows: usize,
    hidden: usize,
    intermediate: usize,
...
pub(in crate::commands::real_full) fn capture_or_update_sparse_a_triton_router_topk_bf16_graph(
    ...
    slot: &mut CoordinatorCudaGraphWorkspaceSlot,
    signature: CoordinatorCudaGraphSignature,
    hidden_buffer: Ds41rtDeviceBuffer,
    weight_buffer: Ds41rtDeviceBuffer,
    bias_buffer: Ds41rtDeviceBuffer,
    score_scratch_buffer: Ds41rtDeviceBuffer,
    index_buffer: Ds41rtDeviceBuffer,
    score_buffer: Ds41rtDeviceBuffer,
    weight_buffer_out: Ds41rtDeviceBuffer,
    rows: usize,
    hidden_dim: usize,
    experts: usize,
    top_k: usize,
...
pub(in crate::commands::real_full) fn coord_sparse_b_graph_key_for_full_hidden_rows(
    rows: usize,
    hidden_dim: usize,
) -> Result<Option<CoordinatorGraphKey>> {
    if rows == 0 || !coordinator_full_hidden_dim_supported(hidden_dim) {
        return Ok(None);
    }
    let mode = if rows == 1 {
        LayerWaveMode::Decode
    ...
    CoordinatorGraphKey::glm52_bf16(CoordinatorGraphShape::CoordSparseB, mode, rows)
        .map(Some)
        .context("selecting Coord-Sparse-B graph slot for full-width BF16 residual add")
}
...
fn coordinator_full_hidden_dim_supported(hidden_dim: usize) -> bool {
    matches!(
        hidden_dim,
        GLM52_HIDDEN_SIZE | DS4_FLASH_HIDDEN_SIZE | DS4_PRO_HIDDEN_SIZE
    )
}
