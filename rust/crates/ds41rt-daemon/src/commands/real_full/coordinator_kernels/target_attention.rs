...
const TARGET_ATTENTION_TIMING_ENV: &str = "DS41RT_REAL_FULL_ATTENTION_CUDA_TIMING";
...
const TARGET_LAYER0_HC_ATTN_FN_LANE_SUM: &str =
    "ds41rt#deepseek-v4-target-layer0-hc-attn-fn-lane-sum";
...
impl DeepseekV4TargetDeviceStorage {
    ...
    #[allow(dead_code)]
    fn physical_main_layer(&self, layer_id: usize) -> Result<Ds41rtDeviceBuffer> {
        use ds41rt_core::DeepseekV4KvRegionKind;
    ...
    fn physical_layer_region(
        &self,
        layer_id: usize,
        kind: ds41rt_core::DeepseekV4KvRegionKind,
    ) -> Result<Ds41rtDeviceBuffer> {
        let layer =
...
struct DeepseekV4TargetC4Weights {
    ...
    main_wkv: Ds41rtDeviceBuffer,
    main_wgate: Ds41rtDeviceBuffer,
    main_ape: Ds41rtDeviceBuffer,
    main_norm: Ds41rtDeviceBuffer,
    index_wkv: Ds41rtDeviceBuffer,
    index_wgate: Ds41rtDeviceBuffer,
    index_ape: Ds41rtDeviceBuffer,
    index_norm: Ds41rtDeviceBuffer,
    indexer_wq_weight: Ds41rtDeviceBuffer,
    indexer_wq_scale: Ds41rtDeviceBuffer,
    indexer_weights_projection: Ds41rtDeviceBuffer,
}
...
struct DeepseekV4TargetC4StateBuffers {
    main_kv: Ds41rtDeviceBuffer,
    main_score: Ds41rtDeviceBuffer,
    index_kv: Ds41rtDeviceBuffer,
    index_score: Ds41rtDeviceBuffer,
}
...
struct DeepseekV4TargetTerminalWeights {
    hc_head_fn: Ds41rtDeviceBuffer,
    hc_head_scale: Ds41rtDeviceBuffer,
    hc_head_base: Ds41rtDeviceBuffer,
    norm_weight: Ds41rtDeviceBuffer,
}
...
mod tests {
    ...
    fn flash_native_nvfp4_target_storage_uses_exact_compact_physical_pages() -> Result<()> {
        ...
        assert_eq!(
            plan.physical_plan
                .layer(0)
                .and_then(|layer| layer.region(ds41rt_core::DeepseekV4KvRegionKind::Main))
    ...
    fn pro_connected_graph_layers_cover_model_target_and_terminal_boundary() -> Result<()> {
        ...
        facts.hidden_size = ds41rt_core::DS4_PRO_HIDDEN_SIZE;
