...
const DS4_FLASH_SHARED_ALPHA_NAME: &str = "ds41rt#deepseek-v4-flash-shared-expert-alpha";
const DS4_PRO_SHARED_ALPHA_NAME: &str = "ds41rt#deepseek-v4-pro-shared-expert-alpha";
...
pub(in crate::commands::real_full) struct Ds4FlashSharedExpertDeviceBuffers {
    pub(in crate::commands::real_full) gate: Ds41rtDeviceBuffer,
    pub(in crate::commands::real_full) up: Ds41rtDeviceBuffer,
...
struct Ds4FlashSharedExpertResidentWeights {
    w1_weight: Ds41rtDeviceBuffer,
    w1_scale_mma: Ds41rtDeviceBuffer,
    w3_weight: Ds41rtDeviceBuffer,
    w3_scale_mma: Ds41rtDeviceBuffer,
    w2_weight: Ds41rtDeviceBuffer,
    w2_scale_mma: Ds41rtDeviceBuffer,
...
fn ds4_pro_shared_expert_fp8_batched_prefill_device_output(
    ...
    let buffers = Ds41rtDs4ProSharedExpertFp8PrefillBuffers {
        base: Ds41rtDs4FlashSharedExpertFp8Buffers {
            input: input.buffer(),
...
fn launch_ds4_shared_expert_fp8_bf16_preloaded_device_input_into(
    ...
    while row_offset < rows {
        ...
        let buffers = Ds41rtDs4FlashSharedExpertFp8Buffers {
...
mod ds4_flash_shared_expert_handoff_tests {
    use super::{
        ...
        Ds4SharedExpertProfile, Ds41rtDs4FlashSharedExpertFp8Buffers, DS4_FLASH_HIDDEN,
    ...
    fn pro_shared_expert_resident_rust_path_executes_production_geometry_on_gpu0() {
        const W1_WEIGHT: &str = "ds41rt#test-pro-shared-w1-weight";
        const W1_SCALE: &str = "ds41rt#test-pro-shared-w1-scale";
        const W3_WEIGHT: &str = "ds41rt#test-pro-shared-w3-weight";
        const W3_SCALE: &str = "ds41rt#test-pro-shared-w3-scale";
        const W2_WEIGHT: &str = "ds41rt#test-pro-shared-w2-weight";
        const W2_SCALE: &str = "ds41rt#test-pro-shared-w2-scale";
