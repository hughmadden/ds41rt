...
use ds41rt_transport::{TcpTransportConfig, VerbsHostMappedRdmaRing, VerbsHostMappedRdmaRingConfig};
use std::{
    ffi::c_void,
    net::TcpListener,
...
const SPARK_RDMA_TIMING_ENV: &str = "DS41RT_REAL_FULL_NVFP4_ROUTE_TIMING";
...
pub(crate) struct SparkExpertRdmaExchangeSegment {
    ...
    pub(crate) row_count: usize,
    pub(crate) peer_payloads: [Ds41rtDeviceBuffer; 3],
}
...
impl SparkExpertRdmaReduction {
    ...
    pub(crate) fn exchange_row_partitions(
        ...
        request_id: u64,
        packed_rows: Ds41rtDeviceBuffer,
        full_rows: usize,
        row_width: usize,
        row_stride_bytes: usize,
...
impl SparkExpertRdmaExchange {
    pub(crate) fn segments(&self) -> Result<Vec<SparkExpertRdmaExchangeSegment>> {
        ...
        for rail_index in 0..rail_count {
            ...
            let mut peer_payloads = [Ds41rtDeviceBuffer::default(); 3];
            ...
            .map(|rank| SparkRdmaReceivedPeer {
                ...
                rails: vec![
                    SparkRdmaReceivedRail {
                        ...
                        row_count: 3,
                        sequence: 10,
                        payload: Ds41rtDeviceBuffer::default(),
                    },
                    SparkRdmaReceivedRail {
                        row_offset: 3,
                        row_count: 2,
