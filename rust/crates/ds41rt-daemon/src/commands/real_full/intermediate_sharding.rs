...
use ds41rt_ffi::{Ds41rtNcclComm, NativeLibrary};
use std::{
...
pub(crate) const EXPERT_INTERMEDIATE_SHARDS_ENV: &str = "DS41RT_EXPERT_INTERMEDIATE_SHARDS";
pub(crate) const EXPERT_INTERMEDIATE_SHARD_RANK_ENV: &str = "DS41RT_EXPERT_INTERMEDIATE_SHARD_RANK";
pub(crate) const EXPERT_INTERMEDIATE_REDUCTION_ENV: &str = "DS41RT_EXPERT_INTERMEDIATE_REDUCTION";
...
pub(crate) const EXPERT_INTERMEDIATE_REDUCTION_ROOT_ENV: &str =
    "DS41RT_EXPERT_INTERMEDIATE_REDUCTION_ROOT";
pub(crate) const EXPERT_INTERMEDIATE_REDUCTION_PORT_ENV: &str =
    "DS41RT_EXPERT_INTERMEDIATE_REDUCTION_PORT";
...
pub(crate) const EXPERT_INTERMEDIATE_OWNER_PEERS_ENV: &str =
    "DS41RT_EXPERT_INTERMEDIATE_OWNER_PEERS";
pub(crate) const EXPERT_INTERMEDIATE_OWNER_PORT_ENV: &str = "DS41RT_EXPERT_INTERMEDIATE_OWNER_PORT";
pub(crate) const EXPERT_INTERMEDIATE_RDMA_PEERS_ENV: &str = "DS41RT_EXPERT_INTERMEDIATE_RDMA_PEERS";
...
pub(crate) const EXPERT_INTERMEDIATE_RDMA_PORT_ENV: &str = "DS41RT_EXPERT_INTERMEDIATE_RDMA_PORT";
pub(crate) const EXPERT_INTERMEDIATE_RDMA_SLOT_BYTES_ENV: &str =
    "DS41RT_EXPERT_INTERMEDIATE_RDMA_SLOT_BYTES";
pub(crate) const EXPERT_INTERMEDIATE_RDMA_RING_DEPTH_ENV: &str =
    "DS41RT_EXPERT_INTERMEDIATE_RDMA_RING_DEPTH";
pub(crate) const EXPERT_INTERMEDIATE_RDMA_STRIPE_MIN_BYTES_ENV: &str =
    "DS41RT_EXPERT_INTERMEDIATE_RDMA_STRIPE_MIN_BYTES";
pub(crate) const EXPERT_WEIGHT_PRELOAD_NCCL_ENV: &str = "DS41RT_EXPERT_WEIGHT_PRELOAD_NCCL";
pub(crate) const EXPERT_WEIGHT_PRELOAD_NCCL_PORT_ENV: &str =
    "DS41RT_EXPERT_WEIGHT_PRELOAD_NCCL_PORT";
...
impl SparkExpertReduction {
    pub(crate) fn communicator(&self) -> &Ds41rtNcclComm {
        &self.communicator
    }
