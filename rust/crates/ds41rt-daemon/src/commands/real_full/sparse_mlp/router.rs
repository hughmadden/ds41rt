...
use ds41rt_core::{DType, ModelVariant, TensorCatalog, TensorInfo};
use ds41rt_loader::{load_tensor_bytes, read_tensor_bytes_into};
...
mod tests {
    ...
    use ds41rt_loader::{build_catalog_for_snapshot, load_tensor_bytes};
