...
use ds41rt_ffi::{
    Ds41rtDeviceBuffer, Ds41rtHostBuffer, NativeLibrary, DS41RT_CUDA_GENERIC_KV_PAGE_SIZE,
};
use std::{
...
const ADMISSION_STAGE_TIMING_ENV: &str = "DS41RT_REAL_FULL_ADMISSION_STAGE_TIMING";
const PACKED_FP8_MLA_BATCHED_SUFFIX_ENV: &str = "DS41RT_REAL_FULL_PACKED_FP8_MLA_BATCHED_SUFFIX";
const DSPARK_TRACE_ENV: &str = "DS41RT_REAL_FULL_DSPARK_TRACE";
const PACKED_MLA_TRACE_DIR_ENV: &str = "DS41RT_REAL_FULL_PACKED_MLA_TRACE_DIR";
const PACKED_MLA_TRACE_LAYERS_ENV: &str = "DS41RT_REAL_FULL_PACKED_MLA_TRACE_LAYERS";
const PACKED_MLA_TRACE_ROWS_ENV: &str = "DS41RT_REAL_FULL_PACKED_MLA_TRACE_ROWS";
const PACKED_MLA_TRACE_QUERY_ROWS_ENV: &str = "DS41RT_REAL_FULL_PACKED_MLA_TRACE_QUERY_ROWS";
const PACKED_MLA_TRACE_LIMIT_ENV: &str = "DS41RT_REAL_FULL_PACKED_MLA_TRACE_LIMIT";
...
fn maybe_dump_packed_mla_trace(
    ...
    q_projected: Ds41rtDeviceBuffer,
    q_nope: Ds41rtDeviceBuffer,
    q_rope_rotated: Ds41rtDeviceBuffer,
    kv_b_weight: Ds41rtDeviceBuffer,
        ...
        if !weight_manifest.is_file() {
            ...
            fs::write(
                ...
                serde_json::to_vec_pretty(&serde_json::json!({
                    "format": "ds41rt-packed-mla-trace-weights-v1",
                    "layer": layer,
                    "heads": heads,
    ...
    let metadata = serde_json::json!({
        "format": "ds41rt-packed-mla-trace-v1",
        "layer": layer,
        "rows": span.rows,
...
struct RealFullDeviceMlaKvRopeDeviceBuffers {
    ...
    k_rope_rotated: Ds41rtDeviceBuffer,
}
...
impl RealFullDeviceMlaKvDeviceParts {
    ...
    pub(in crate::commands::real_full) fn from_projected_kv_a_device_bf16(
        ...
        projected_kv_a_buffer: Ds41rtDeviceBuffer,
        layer_id: LayerId,
        rows: usize,
        kv_lora_rank: usize,
        rope_dim: usize,
    ...
    pub(in crate::commands::real_full) fn kv_latent_buffer(&self) -> Ds41rtDeviceBuffer {
        self.kv_latent.buffer
    }

    pub(in crate::commands::real_full) fn k_rope_buffer(&self) -> Ds41rtDeviceBuffer {
        self.k_rope.buffer
    }

    pub(in crate::commands::real_full) fn dsa_key_buffer(&self) -> Option<Ds41rtDeviceBuffer> {
    ...
    pub(in crate::commands::real_full) fn rotate_k_rope_bf16_with_position_buffer(
        &self,
        positions: &[u32],
        positions_device: Ds41rtDeviceBuffer,
        theta: f32,
    ) -> Result<RealFullDeviceMlaKvRopeParts> {
        if positions.len() != self.rows {
            anyhow::bail!(
...
impl RealFullDeviceMlaKvProjectedParts {
    ...
    pub(in crate::commands::real_full) fn normalized_buffer(&self) -> Ds41rtDeviceBuffer {
        self.normalized.buffer
    }

    pub(in crate::commands::real_full) fn projected_buffer(&self) -> Ds41rtDeviceBuffer {
        self.projected.buffer
    }

    pub(in crate::commands::real_full) fn k_nope_buffer(&self) -> Ds41rtDeviceBuffer {
        self.k_nope.buffer
    }

    pub(in crate::commands::real_full) fn values_buffer(&self) -> Ds41rtDeviceBuffer {
        self.values.buffer
    }
...
impl RealFullDeviceMlaKvRopeParts {
    ...
    pub(in crate::commands::real_full) fn k_rope_rotated_buffer(&self) -> Ds41rtDeviceBuffer {
...
impl RealFullDeviceMlaQueryParts {
    ...
    pub(in crate::commands::real_full) fn from_projected_suffix_device_bf16(
        library: &'static NativeLibrary,
        projected_query_buffer: Ds41rtDeviceBuffer,
        prefix_rows: usize,
        suffix_positions: &[u32],
        heads: usize,
        nope_dim: usize,
...
impl RealFullDeviceMlaKvProjectedDeviceBuffers {
    fn run_mla_rope_attention_bf16(
        ...
        q_nope: Ds41rtDeviceBuffer,
        q_rope: Ds41rtDeviceBuffer,
        output_buffer: Ds41rtDeviceBuffer,
        scale: f32,
    ) -> Result<RealFullDeviceMlaAttentionParts> {
        if rotated_k_rope.rows != self.rows {
            anyhow::bail!(
    ...
    fn run_mla_rope_attention_with_uploaded_suffix_bf16(
        ...
        q_nope: Ds41rtDeviceBuffer,
        q_rope: Ds41rtDeviceBuffer,
        suffix_k_nope: Ds41rtDeviceBuffer,
        suffix_k_nope_bytes: usize,
        suffix_k_rope: Ds41rtDeviceBuffer,
        suffix_k_rope_bytes: usize,
        suffix_values: Ds41rtDeviceBuffer,
...
impl RealFullDeviceMlaQueryDeviceBuffers {
    fn q_nope_buffer(&self) -> Ds41rtDeviceBuffer {
        self.q_nope
    }

    fn q_rope_rotated_buffer(&self) -> Ds41rtDeviceBuffer {
        self.q_rope_rotated
    }
}
...
impl RealFullDeviceMlaAttentionParts {
    ...
    pub(in crate::commands::real_full) fn output_buffer(&self) -> Ds41rtDeviceBuffer {
        self.output.buffer
    }
...
impl RealFullDeviceKvExecutionMirror {
    ...
    pub(in crate::commands::real_full) fn write_projected_mla_kv_a_device_blocks_bf16(
        ...
        descriptors: &[KvBlockDescriptor],
        projected_kv_a_buffer: Ds41rtDeviceBuffer,
        kv_norm_weight: Option<Ds41rtDeviceBuffer>,
    ...
    pub(in crate::commands::real_full) fn write_mla_decode_kv_device_block_bf16(
        ...
        input_norm_weight: Ds41rtDeviceBuffer,
        kv_a_weight: Ds41rtDeviceBuffer,
        kv_norm_weight: Ds41rtDeviceBuffer,
    ...
    pub(in crate::commands::real_full) fn write_projected_mla_kv_a_and_dsa_key_device_blocks_bf16(
        ...
        descriptors: &[KvBlockDescriptor],
        projected_kv_a_buffer: Ds41rtDeviceBuffer,
        dsa_key_buffer: Ds41rtDeviceBuffer,
        kv_norm_weight: Option<Ds41rtDeviceBuffer>,
    ) -> Result<Option<Vec<RealFullDeviceKvBlockIo>>> {
        if descriptors.is_empty() {
            return Ok(Some(Vec::new()));
    ...
    pub(in crate::commands::real_full) fn run_mla_rope_attention_parts_from_device_prefix_with_device_weights_and_projected_query_device_suffix_bf16(
        ...
        kv_norm_weight: Ds41rtDeviceBuffer,
        kv_b_weight: Ds41rtDeviceBuffer,
        q_projected_buffer: Ds41rtDeviceBuffer,
        q_suffix_positions: &[u32],
        suffix_k_nope_bf16: &[u8],
        suffix_k_rope_rotated_bf16: &[u8],
        suffix_values_bf16: &[u8],
    ...
    pub(in crate::commands::real_full) fn run_mla_rope_attention_parts_from_device_prefix_with_device_weights_and_projected_query_device_kv_suffix_bf16(
        ...
        kv_b_weight: Ds41rtDeviceBuffer,
        q_projected_buffer: Ds41rtDeviceBuffer,
        kv_a_projected_buffer: Ds41rtDeviceBuffer,
        suffix_positions: &[u32],
        heads: usize,
        nope_dim: usize,
        v_dim: usize,
    ...
    pub(in crate::commands::real_full) fn run_mla_rope_attention_parts_from_device_kv_with_device_weights_and_projected_query_device_bf16(
        ...
        kv_b_weight: Ds41rtDeviceBuffer,
        q_projected_buffer: Ds41rtDeviceBuffer,
        dsa_query: Option<(Ds41rtDeviceBuffer, Ds41rtDeviceBuffer)>,
    ...
    fn run_scheduler_mla_attention_from_device_kv_bf16(
        ...
        descriptors: &[KvBlockDescriptor],
        q_suffix_positions: &[u32],
        query_hidden: Option<Ds41rtDeviceBuffer>,
...
struct SchedulerAttentionResidentBuffers {
    kv_norm_weight: Ds41rtDeviceBuffer,
    kv_b_weight: Ds41rtDeviceBuffer,
    query_projection_weight: Option<Ds41rtDeviceBuffer>,
    output_projection_weight: Option<Ds41rtDeviceBuffer>,
}
...
impl DeviceKvLayerRoundTripPlan {
    ...
    fn descriptor(&self) -> Result<KvBlockDescriptor> {
        ...
        Ok(KvBlockDescriptor {
            ...
            token_start: ds41rt_core::PositionId(self.token_start),
...
impl<'a> DeviceKvReusableHostBuffer<'a> {
    ...
    fn buffer(&mut self, bytes: usize, label: &'static str) -> Result<Ds41rtHostBuffer> {
        if bytes == 0 {
...
impl<'a> DeviceKvReusableDeviceBuffer<'a> {
    fn new(library: &'a NativeLibrary) -> Self {
        Self {
            library,
            buffer: Ds41rtDeviceBuffer::default(),
            capacity: 0,
            label: "",
        }
    }

    fn buffer(&mut self, bytes: usize, label: &'static str) -> Result<Ds41rtDeviceBuffer> {
        if bytes == 0 {
...
fn target_kv_physical_spans(
    ...
    while logical_token < logical_token_end {
        let logical_page = logical_token / DS41RT_CUDA_GENERIC_KV_PAGE_SIZE;
        let page_token = logical_token % DS41RT_CUDA_GENERIC_KV_PAGE_SIZE;
        ...
        let tokens_here =
            (DS41RT_CUDA_GENERIC_KV_PAGE_SIZE - page_token).min(logical_token_end - logical_token);
        let physical_token_start = physical_page
            .checked_mul(DS41RT_CUDA_GENERIC_KV_PAGE_SIZE)
...
impl<'a> RealFullDeviceKvStorage<'a> {
    ...
    fn native_target_mapping_only(library: &'a NativeLibrary, config: KvCacheConfig) -> Self {
        Self {
            library,
            config,
            cache: Ds41rtDeviceBuffer::default(),
...
impl<'a> RealFullDeviceKvCache<'a> {
    ...
    fn physical_token_position(&self, logical_token: usize) -> Result<usize> {
        ...
        if let Some(physical_pages) = self.physical_pages.as_ref() {
            ...
            return (*physical_page as usize)
                .checked_mul(DS41RT_CUDA_GENERIC_KV_PAGE_SIZE)
                .and_then(|base| base.checked_add(logical_token % DS41RT_CUDA_GENERIC_KV_PAGE_SIZE))
    ...
    fn physical_page_table(&self) -> Option<(Ds41rtDeviceBuffer, u64)> {
    ...
    fn copy_target_kv_boundary_page(
        ...
        anyhow::ensure!(
            source_page != destination_page
                && (1..DS41RT_CUDA_GENERIC_KV_PAGE_SIZE).contains(&valid_tokens),
        ...
        let page_token = |page: u32| -> Result<PositionId> {
            (page as u64)
                .checked_mul(DS41RT_CUDA_GENERIC_KV_PAGE_SIZE as u64)
                .map(PositionId)
        ...
        for layer in 0..self.config.layers {
            let source_descriptor = KvBlockDescriptor {
                ...
                token_count: DS41RT_CUDA_GENERIC_KV_PAGE_SIZE,
            };
    ...
    fn main_mla_cache_for_layer(&self, layer_id: LayerId) -> Result<Ds41rtDeviceBuffer> {
        let layer_base = self
            .config
    ...
    fn attention_ready_mla_frontier_append_target(
        ...
        descriptors: &[KvBlockDescriptor],
        row_stride_bytes: usize,
    ) -> Result<Option<(Ds41rtDeviceBuffer, DeviceKvAttentionReadyFrontier)>> {
    ...
    fn attention_ready_mla_frontier_payload_for_descriptors(
        &mut self,
        descriptors: &[KvBlockDescriptor],
    ) -> Result<Option<(Ds41rtDeviceBuffer, usize, usize)>> {
        let Some(first) = descriptors.first() else {
            return Ok(None);
        };
        let layer_index = usize::try_from(first.layer_id.0)
    ...
    fn write_mla_dsa_planes_from_contiguous_device(
        &self,
        descriptors: &[KvBlockDescriptor],
        main_src: Ds41rtDeviceBuffer,
        main_row_bytes: usize,
        dsa_src: Ds41rtDeviceBuffer,
    ) -> Result<Vec<RealFullDeviceKvBlockIo>> {
        anyhow::ensure!(
    ...
    fn split_projected_query_suffix_to_reusable_buffers(
        ...
        prefix_rows: usize,
        suffix_positions: &[u32],
        positions_device: Option<Ds41rtDeviceBuffer>,
        heads: usize,
        nope_dim: usize,
        rope_dim: usize,
        theta: f32,
    ...
    fn attention_combined_buffers(
        ...
        values_bytes: usize,
        label: &'static str,
    ) -> Result<(Ds41rtDeviceBuffer, Ds41rtDeviceBuffer, Ds41rtDeviceBuffer)> {
        let k_nope = self
...
impl<'a> DeviceBufferGuard<'a> {
    ...
    fn borrowed(library: &'a NativeLibrary, buffer: Ds41rtDeviceBuffer) -> Self {
        Self {
            library,
            buffer,
            owned: false,
    ...
    fn into_buffer(mut self) -> Result<Ds41rtDeviceBuffer> {
        if !self.owned {
...
fn scheduler_attention_project_query_from_hidden_bf16_into(
    layer_id: LayerId,
    query_hidden: Ds41rtDeviceBuffer,
    query_rows: usize,
    query_projection_weight: Ds41rtDeviceBuffer,
    projected_query: Ds41rtDeviceBuffer,
) -> Result<()> {
    if query_rows == 0 {
...
fn scheduler_attention_project_output_to_hidden_bf16(
    layer_id: LayerId,
    library: &'static NativeLibrary,
    attention_output: Ds41rtDeviceBuffer,
    rows: usize,
    input_width: usize,
    output_projection_weight: Ds41rtDeviceBuffer,
) -> Result<DeviceBufferGuard<'static>> {
    if rows == 0 {
...
mod tests {
    ...
    fn device_kv_roundtrip_status_labels_cuda_unavailable_errors() {
        let error = anyhow::anyhow!(
            "allocating real-full device KV roundtrip cache: ds41rt_alloc_device_buffer returned status 3: CUDA unavailable"
        );
    ...
    fn device_kv_roundtrip_cuda_errors_are_soft_only_when_cuda_is_not_required() {
        let soft = device_kv_roundtrip_failed(
            anyhow::anyhow!("ds41rt_cuda_kv_cache_write_blocks returned status 3: CUDA unavailable"),
            false,
        )
        ...
        let hard = device_kv_roundtrip_failed(
            anyhow::anyhow!("ds41rt_cuda_kv_cache_write_blocks returned status 7"),
            true,
        )
        .unwrap_err()
        .to_string();
