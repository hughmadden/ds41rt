...
use ds41rt_ffi::{Ds41rtDeviceBuffer, Ds41rtHostBuffer};
use ds41rt_loader::{is_deepseek_v4_exl3_recipe, DEEPSEEK_V4_EXL3_RECIPE};
...
const REAL_FULL_PROTOCOL_V2_TIMEOUT_MS_ENV: &str = "DS41RT_REAL_FULL_PROTOCOL_V2_TIMEOUT_MS";
const REAL_FULL_MOE_RESPONSE_DTYPE_ENV: &str = "DS41RT_REAL_FULL_MOE_RESPONSE_DTYPE";
const REAL_FULL_MOE_OWNER_RESPONSE_DTYPE_ENV: &str = "DS41RT_REAL_FULL_MOE_OWNER_RESPONSE_DTYPE";
...
struct Ds4Tp4SegmentChunk<'a> {
    rank: usize,
    payload_bf16: &'a [u8],
    pinned_payload: Option<Ds41rtHostBuffer>,
...
fn ds4_tp4_verbs_chunk_segments<'a>(
    ...
    for (chunk_index, chunk) in chunks.iter().enumerate() {
        ...
        while local_start < chunk.global_row_indices.len() {
            ...
            let pinned_payload = full_pinned.map(|pinned| Ds41rtHostBuffer {
...
mod tests {
    ...
    use ds41rt_loader::DEEPSEEK_V4_EXL3_RECIPE_V2;
    use ds41rt_transport::{
