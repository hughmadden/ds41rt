...
use ds41rt_api::{RealFullConstraint, RealFullConstraintGrammar, DS4_CHAT_STOP_TOKEN_IDS};
use ds41rt_ffi::{
    Ds41rtXGrammarCompiler, Ds41rtXGrammarGrammar, Ds41rtXGrammarMatcher, DS41RT_XGRAMMAR_JSON_OBJECT,
    DS41RT_XGRAMMAR_JSON_SCHEMA, DS41RT_XGRAMMAR_STRUCTURAL_TAG,
};
...
struct ConstraintCompilerInner {
    compiler: Option<Ds41rtXGrammarCompiler<'static>>,
    grammars: HashMap<RealFullConstraint, Arc<Ds41rtXGrammarGrammar<'static>>>,
...
pub(super) struct RealFullConstraintState {
    ...
    matcher: Ds41rtXGrammarMatcher<'static>,
    vocab_size: usize,
    bitmask_words: usize,
}
...
mod tests {
    ...
    use ds41rt_api::DS4_CHAT_STOP_TOKEN_IDS;
