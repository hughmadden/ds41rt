...
use ds41rt_core::{
    ...
    DS4_FLASH_HIDDEN_BF16_BYTES, DS4_FLASH_HIDDEN_SIZE,
};
...
pub(super) fn request_with_rows(
    ...
    ExpertRequest {
        ...
        wave: Some(ExpertWaveMetadata {
            ...
            logical_bf16_payload_bytes: row_count * DS4_FLASH_HIDDEN_BF16_BYTES,
        }),
        rows: (0..row_count)
...
pub(super) fn protocol_v2_request(
    ...
    let mut hidden_payload = Vec::with_capacity(row_count * DS4_FLASH_HIDDEN_BF16_BYTES);
    for row in 0..row_count {
        for col in 0..DS4_FLASH_HIDDEN_SIZE {
