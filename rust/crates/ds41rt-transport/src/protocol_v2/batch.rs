...
use bytes::Bytes;
use ds41rt_core::{DType, ExpertBatch, ExpertHostBatch, RowSourceKind};
...
impl ExpertProtocolV2Request {
    ...
    pub fn from_expert_host_batch(
        ...
        Self::from_expert_host_batch_bytes(request_id, batch, hidden_payload.into())
    }

    pub(crate) fn from_expert_host_batch_bytes(
        request_id: u64,
        batch: &ExpertHostBatch,
