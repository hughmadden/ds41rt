...
use ds41rt_core::{ExpertRequest, ExpertResponse, LayerWaveMode};
...
pub struct ProtocolV2RequestDevicePayload {
    pub hidden_payload: Ds41rtDeviceBuffer,
    pub response_slot: Option<Ds41rtDeviceBuffer>,
