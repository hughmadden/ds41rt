...
pub struct RealFullDiagnosticMetrics {
    ...
    // Backward-compatible name from before the real executor also served EXL3 trellis weights.
    ...
    pub dspark_joint_cycles: usize,
    pub dspark_max_joint_batch_width: usize,
    pub dspark_max_joint_cohort_width: usize,
    pub dspark_max_joint_cohort_count: usize,
    pub dspark_2x2_wavefront_cycles: usize,
