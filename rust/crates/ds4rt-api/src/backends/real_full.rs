...
const REAL_FULL_MAX_CONTEXT_TOKENS_ENV: &str = "DS4RT_REAL_FULL_SERVE_MAX_CONTEXT_TOKENS";
const REAL_FULL_MAX_OUTPUT_TOKENS_ENV: &str = "DS4RT_REAL_FULL_SERVE_MAX_OUTPUT_TOKENS";
...
fn terminal_cycle_samples(
    ...
    allow_tool_calls: bool,
    mut token_decoder: Option<&mut ds4rt_loader::StreamingTokenDecoder>,
                ...
                let fallback_content = generated
                    ...
                    .unwrap_or_else(|| {
                        if stop_by_token {
                            ...
                            format!("ds4rt-token:{}", generated.token_id)
                        }
                    });
...
fn real_full_streaming_token_decoder(
    state: &ApiState,
) -> Option<ds4rt_loader::StreamingTokenDecoder> {
    let snapshot_path = state.config.real_full.as_ref()?.snapshot_path.as_deref()?;
    match ds4rt_loader::streaming_token_decoder(Path::new(snapshot_path), false) {
...
fn decode_terminal_sample_streaming(
    ...
    token_decoder: Option<&mut ds4rt_loader::StreamingTokenDecoder>,
) {
...
fn terminal_output_token_text(full: &crate::RealFullInfo, token_id: usize) -> Option<String> {
    ...
    ds4rt_loader::decode_tokenizer_ids(Path::new(snapshot_path), &[token_id], false)
        .ok()
